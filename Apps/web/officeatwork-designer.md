...
>| User.Read.All | delegated | Non vengono archiviati dati. | Office 365 Utenti - Tutte le proprietà: per abilitare la lettura di tutte le proprietà di tutti gli utenti. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
>| offline_access | delegated | Non vengono archiviati dati. | Sing-In: per abilitare l'accesso automatico tramite i token di aggiornamento, come senza, gli utenti dovrebbero eseguire manualmente l'accesso ogni volta che avviano l'app officeatwork. Questo ambito è necessario solo per le applicazioni host non abilitate per SSO. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
>| profile | delegated | Non vengono archiviati dati. | Sing-In: per mostrare l'utente connesso nell'app officeatwork. Ciò consente di assicurare/confermare all'utente quale account è stato usato per accedere all'app officeatwork. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
<iframe height='1020' title='Microsoft Cloud App Security informazioni' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749' frameborder='no'></iframe>
