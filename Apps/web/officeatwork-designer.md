---
title: Informazioni sull'applicazione per La finestra di progettazione
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Designer, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65225300"
---
# <a name="application-information-for-designer-by-officeatwork"></a>Informazioni sull'applicazione per Designer by officeatwork
...
* [Visualizzazione in AppSource](https://appsource.microsoft.com/product/web-apps/officeatwork-ag.designer)
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Contacts.Read | Delegato | Nessun dato archiviato. | Contatti: per abilitare la lettura di tutti i contatti dell'utente connesso. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Files.Read | Delegato | Nessun dato archiviato. | OneDrive - File (contenuto): per abilitare la lettura dei file dell'utente connesso. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Files.Read.All | Delegato | Nessun dato archiviato. | Teams - File (contenuto): per abilitare la lettura di tutti i file dell'utente connesso. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Group.Read.All | Delegato | Nessun dato archiviato. | Office 365 Utenti - Limite al gruppo: per abilitare la lettura di tutti i gruppi dell'utente connesso. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Sites.Read.All | Delegato | Nessun dato archiviato. | SharePoint Online: per abilitare la lettura dei dati da SharePoint Online. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.Read | Delegato | Nessun dato archiviato. | Sing-In: per abilitare l'app officeatwork per leggere le proprietà di base dell'utente. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.Read.All | Delegato | Nessun dato archiviato. | Office 365 Utenti - Tutte le proprietà: per abilitare la lettura di tutte le proprietà di tutti gli utenti. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.ReadBasic.All | Delegato | Nessun dato archiviato. | Office 365 Users - Proprietà di base: per abilitare la lettura delle proprietà di base di tutti gli utenti | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| offline_access | Delegato | Nessun dato archiviato. | Sing-In: per abilitare l'accesso automatico tramite i token di aggiornamento, come senza, gli utenti dovrebbero accedere manualmente ogni volta che avviano l'app officeatwork. Questo ambito è necessario solo per le applicazioni host non abilitate per l'accesso SSO. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| openid | Delegato | Nessun dato archiviato. | Sing-In: per consentire agli utenti di accedere all'app officeatwork con il proprio account aziendale e/o Microsoft | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| profile | Delegato | Nessun dato archiviato. | Sing-In: per visualizzare l'utente connesso nell'app officeatwork. Ciò consente di assicurare/confermare all'utente l'account usato per accedere all'app officeatwork. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
<iframe height='1020' title='informazioni Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749' frameborder='0'></iframe>

[Visualizzazione in una scheda](https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749){:target="_blank"}
