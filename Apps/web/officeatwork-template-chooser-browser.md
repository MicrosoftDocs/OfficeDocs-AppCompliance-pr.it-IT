---
title: Informazioni sull'applicazione per template Chooser Browser
ms.author: elmalova
author: elenamalova
ms.date: 06/22/2021
ms.topic: article
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Template Chooser Browser, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="application-information-for-template-chooser-browser-by-officeatwork"></a>Informazioni sull'applicazione per Template Chooser Browser by officeatwork
...
|:----------------|:-------------|
| Nome dell'app | Browser del selezionatore di modelli |
