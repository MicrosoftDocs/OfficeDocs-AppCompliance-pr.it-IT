...
description: Tutte le informazioni di sicurezza e conformità disponibili per Content Chooser Browser, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Funzionalità di base dell'app | Accedi al contenuto condiviso centralmente in Word, Excel, PowerPoint, Outlook, browser e altre app. |
