---
title: Application Information for storm Cloud Contact Center Teams Integration by Content Guru
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per cloud contact center Teams Integration, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
|:----------------|:-------------|
| Nome app | Storm Cloud Contact Center Teams Integration |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Nome società partner | Content Guru |
| Sito Web aziendale | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
| Condizioni per l'uso dell'app | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| Funzionalità di base dell'app | Integrare cloud contact center con Microsoft Teams per una soluzione CCaaS unificata. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (la) |
| Pagina delle informazioni dell'app | [https://www.contentguru.com/microsoft-teams-integration/](https://www.contentguru.com/microsoft-teams-integration/) |
...
Queste informazioni sono state fornite da Content Guru su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
