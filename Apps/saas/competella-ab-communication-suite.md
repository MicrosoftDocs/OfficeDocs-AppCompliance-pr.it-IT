...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Competella Communication Suite, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 1 dicembre 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/competellaab.sol-52202-iyi" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Competella AB a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Competella Communication Suite |
| ID | competellaab.sol-52202-iyi |
| Nome della società partner | Competella AB |
| Sito Web dell'azienda | [https://www.competella.com](https://www.competella.com) |
| Condizioni per l'utilizzo dell'app | [https://www.competella.com](https://www.competella.com) |
| Funzionalità di base dell'app | Una soluzione contact center e console operatore per un eccellente servizio clienti con Microsoft Teams. |
| Sede centrale dell'azienda | Svezia |
| Pagina delle informazioni sull'app | [https://competella.com/Solutions%20for%20Teams/overview](https://competella.com/Solutions%20for%20Teams/overview) |
...
Queste informazioni sono state fornite da Competella AB su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Profili utente e informazioni sulla chiamata |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Informazioni sul profilo utente e log delle conversazioni |
...
| URL dell'informativa sulla privacy | www.competella.com |
