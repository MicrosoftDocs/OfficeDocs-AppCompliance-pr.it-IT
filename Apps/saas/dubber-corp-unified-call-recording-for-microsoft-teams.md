---
title: Informazioni sull'applicazione per la registrazione unificata delle chiamate di Dubber per Microsoft Teams di Dubber Corp
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per la registrazione delle chiamate unificate di Dubber per Microsoft Teams, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="dubber-unified-call-recording-for-microsoft-teams"></a>Registrazione delle chiamate unificate di Dubber per Microsoft Teams

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Ultimo aggiornamento da parte dello sviluppatore: 13 aprile 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/dubbercorp1603082091027.dubber01" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Dubber Corp a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Registrazione delle chiamate unificate di Dubber per Microsoft Teams |
| ID | dubbercorp1603082091027.dubber01 |
| Nome della società partner | Dubber Corp |
| Sito Web dell'azienda | [https://www.dubber.net](https://www.dubber.net) |
| Condizioni per l'utilizzo dell'app | [https://www.dubber.net/terms](https://www.dubber.net/terms) |
| Funzionalità di base dell'app | The World&#8217;s #1 Unified Cloud Call Recording &amp; Voice AI for compliance, sales &amp; service performance |
...
Queste informazioni sono state fornite da Dubber Corp su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati delle chiamate utente |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome cliente e ID Microsoft, dati di registrazione/riunione delle chiamate |
...
| URL dell'informativa sulla privacy | https://www.dubber.net/privacy-policy |
