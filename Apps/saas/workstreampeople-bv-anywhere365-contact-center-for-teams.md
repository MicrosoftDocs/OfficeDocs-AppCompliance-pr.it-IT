---
title: Informazioni sull'applicazione per Anywhere365 Contact Center for Teams di WORKSTREAMPEOPLE BV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per il Contact Center Anywhere365 per Teams, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66703604"
---
# <a name="anywhere365-contact-center-for-teams"></a>Centro contatti Anywhere365 per Teams
...
* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.anywhere365contactcenterforteams" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Centro contatti Anywhere365 per Teams |
| ID | workstreampeople.anywhere365contactcenterforteams |
| Nome della società partner | WORKSTREAMPEOPLE BV |
| Sito Web dell'azienda | [https://anywhere365.io](https://anywhere365.io) |
| Condizioni per l'utilizzo dell'app | [https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialo...](https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialogue-Cloud-Agreement_202112_V3.6.pdf) |
| Funzionalità di base dell'app | Anywhere365&#174; Dialogue Cloud platform for Omnichannel Communications, il primo centro di contatto microsoft certificato al mondo per Teams, completamente integrato con l'eocystem Microsoft: da Azure, Sharepoint e Teams a Dynamics 365, PowerApps e PowerBI. Con l'aggiunta della piattaforma dialogue studio per l'automazione delle comunicazioni a basso codice, è possibile integrarsi con qualsiasi framework bot basato su API, livelli di comunicazione e sistemi di intelligence. |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://anywhere365.io/category/anywhere365-dialogue-cloud/](https://anywhere365.io/category/anywhere365-dialogue-cloud/) |
...
Queste informazioni sono state fornite da WORKSTREAMPEOPLE BV sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati di presenza delle comunicazioni &amp; |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati di presenza delle comunicazioni &amp; |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Paesi Bassi (il), Stati Uniti d'America, Singapore |
...
| URL dell'informativa sulla privacy | https://anywhere365.io/wp-content/uploads/2021/07/Anywhere365-Privacy-Policy-2021.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegato | Raccogliere i domini dei clienti | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| Presence.Read.All | Delegato | Raccogliere i dettagli della presenza del cliente. | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| User.ReadBasic.All | Delegato | Raccogliere i nomi visualizzati dei clienti | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
