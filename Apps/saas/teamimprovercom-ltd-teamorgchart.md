---
title: Informazioni sull'applicazione per TeamOrgChart di TeamImprover.Com Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per TeamOrgChart, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da TeamImprover.Com Ltd a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | TeamOrgChart |
| ID | teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13 |
| Nome della società partner | TeamImprover.Com Ltd |
| Sito Web dell'azienda | [https://teamimprover.com](https://teamimprover.com) |
| Condizioni per l'utilizzo dell'app | [https://teamorgchart.com/termsofservice](https://teamorgchart.com/termsofservice) |
| Funzionalità di base dell'app | Creare, condividere, cercare e stampare organigrammi |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://teamorgchart.com/website/features.cshtml](https://teamorgchart.com/website/features.cshtml) |
...
Queste informazioni sono state fornite da TeamImprover.Com Ltd su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Le informazioni sulla gerarchia dell'organizzazione vengono elaborate dall'applicazione.   |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | TeamOrgChart archivia i metadati che descrivono il grafico, ad esempio il nome del grafico, le regole, i segnalibri, il numero di livelli di visualizzazione e così via. |
...
| URL dell'informativa sulla privacy | https://teamorgchart.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegato | L'applicazione compila e visualizza un organigramma da Azure AD.  Deve essere in grado di leggere le informazioni utente da Azure AD  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
>| User.Read.All | Delegato | L'applicazione compila e visualizza un organigramma da Azure AD.  Deve essere in grado di leggere le informazioni utente da Azure AD  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
