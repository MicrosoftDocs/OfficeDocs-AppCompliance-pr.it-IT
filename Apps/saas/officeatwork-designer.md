...
description: Tutte le informazioni di sicurezza e conformità disponibili per Designer, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Funzionalità di base dell'app | Progettare modelli e contenuti personalizzati e automatizzati all'interno dell'organizzazione. |
