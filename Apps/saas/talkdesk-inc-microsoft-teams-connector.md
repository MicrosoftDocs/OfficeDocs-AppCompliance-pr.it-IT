---
title: Informazioni sull'applicazione per Talkdesk Microsoft Teams Connector di Talkdesk, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Talkdesk Microsoft Teams Connector, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="talkdesk-microsoft-teams-connector"></a>Connettore Microsoft Teams talkdesk
...
* <a href="https://appsource.microsoft.com/product/web-apps/talkdeskinc1579824950513.talkdesk_for_teams" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Talkdesk, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Connettore Microsoft Teams talkdesk |
| ID | talkdeskinc1579824950513.talkdesk_for_teams |
| Nome della società partner | Talkdesk, Inc. |
| Sito Web dell'azienda | [https://www.talkdesk.com](https://www.talkdesk.com) |
| Condizioni per l'utilizzo dell'app | [https://www.talkdesk.com/terms-of-service](https://www.talkdesk.com/terms-of-service) |
| Funzionalità di base dell'app | Integrazione di Microsoft Teams in Talkdesk che consente il routing diretto e directory |
...
Queste informazioni sono state fornite da Talkdesk, Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati profilo utente - Nome, Cognome, Nome completo, indirizzo di posta elettronica, numero di telefono |
...
| Data di certificazione SOC2 più recente | 2021-02-22 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2021-02-22 |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | https://rubygems.org/gems/oauth2, v1.4.4 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | Delegato | Necessario per raccogliere i dati del profilo degli utenti di MS Teams | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
>| offline_access | Delegato | Consente all'app di visualizzare i dati anche quando l'utente che ha concesso l'accesso non è connesso. | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
...
| [**PRIVACY DI SICUREZZA PER LA GESTIONE &amp; DEI DATI**](../docs/certification-submission-guide.md#data-handling-security-and-privacy) | **FAIL** |
