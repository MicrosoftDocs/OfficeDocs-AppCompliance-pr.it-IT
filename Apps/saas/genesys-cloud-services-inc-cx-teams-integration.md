---
title: Informazioni sull'applicazione per Genesys Cloud CX Teams Integration by Genesys Servizi cloud, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Genesys Cloud CX Teams Integration, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 17 febbraio 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/genesyslabs.genesys-cloud_teams_integration" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Genesys Servizi cloud, Inc a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Integrazione di Genesys Cloud CX Teams |
| ID | genesyslabs.genesys-cloud_teams_integration |
| Nome della società partner | Genesys Servizi cloud, Inc |
| Sito Web dell'azienda | [https://www.genesys.com](https://www.genesys.com) |
| Condizioni per l'utilizzo dell'app | [https://help.mypurecloud.com/articles/global-genesys-cloud-...](https://help.mypurecloud.com/articles/global-genesys-cloud-service-terms-and-conditions/) |
| Funzionalità di base dell'app | Integrazione&#8482; CX di Genesys Cloud per Microsoft Teams |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://appsource.microsoft.com/en-us/product/web-apps/gene...](https://appsource.microsoft.com/en-us/product/web-apps/genesyslabs.genesys-cloud_teams_integration) |
...
Queste informazioni sono state fornite da Genesys Servizi cloud, Inc su come questa app raccoglie e archivia i dati aziendali e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://help.mypurecloud.com/wp-content/uploads/2021/11/Genesys-Cloud-Privacy-Policy-Nov-2021.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Presence.Read.All | entrambi | L'agente del Contact Center deve essere in grado di visualizzare la presenza del collega prima di trasferire una telefonata | [728ece5a-0f26-4c43-9705-cea9debe3fb5](../azure/728ece5a-0f26-4c43-9705-cea9debe3fb5.md) |
