...
>| Mail.Send | delegated | Microsoft&#8217;i metadati di questa azione, ad esempio la data della notifica, il destinatario (solo ID), l'ID richiesta. | Consente all'app di inviare messaggi di posta elettronica di notifica, ad esempio durante un flusso di lavoro di approvazione. | [2a651f59-97ce-42bb-97d7-cf7a2af4b635](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a651f59-97ce-42bb-97d7-cf7a2af4b635) |
