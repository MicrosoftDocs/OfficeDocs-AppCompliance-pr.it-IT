---
title: Informazioni sull'applicazione per ice Contact Center di ComputerTalk
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
|:----------------|:-------------|
| Nome dell'app | Ice Contact Center |
| ID | computertalk.ice-contact-center |
| Nome della società partner | ComputerTalk |
| Sito Web dell'azienda | [https://www.computer-talk.com](https://www.computer-talk.com) |
| Condizioni per l'utilizzo dell'app | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
...
| Pagina delle informazioni sull'app | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
...
Queste informazioni sono state fornite da ComputerTalk su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | AzureADGuid (collegamento dell'account).  Email indirizzo e il numero di telefono possono essere importati da AAD. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | AzureADGuid (collegamento dell'account).  Email indirizzo e il numero di telefono possono essere importati da AAD. |
