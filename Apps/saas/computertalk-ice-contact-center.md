...
| Quali dati vengono elaborati dall'app? | AzureADGuid (collegamento dell'account).  L'indirizzo e-mail e il numero di telefono possono essere importati da AAD. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | AzureADGuid (collegamento dell'account).  L'indirizzo e-mail e il numero di telefono possono essere importati da AAD. |
