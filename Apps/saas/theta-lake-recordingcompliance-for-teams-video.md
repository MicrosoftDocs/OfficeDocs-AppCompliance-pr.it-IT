---
title: Video sulle informazioni sull'applicazione per la conformità alla registrazione &amp; di Theta Lake per Teams di Theta Lake
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Tutte le informazioni disponibili sulla sicurezza e sulla conformità per Theta Lake Recording &amp; Compliance for Teams Video, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66705848"
---
# <a name="theta-lake-recording-amp-compliance-for-teams-video"></a>Video sulla conformità alla registrazione &amp; di Theta Lake per Teams

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Ultimo aggiornamento da parte dello sviluppatore: 29 marzo 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/thetalake.thetalake_recording_and_compliance_for_teams" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Theta Lake a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Video sulla conformità alla registrazione &amp; di Theta Lake per Teams |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| Nome della società partner | Lago Theta |
| Sito Web dell'azienda | [https://thetalake.com](https://thetalake.com) |
| Condizioni per l'utilizzo dell'app | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| Funzionalità di base dell'app | Registrazione, archiviazione, conformità e mitigazione dei rischi per le riunioni audio e video di Microsoft Teams |
...
Queste informazioni sono state fornite da Theta Lake sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Video Microsoft, Chat di Microsoft Teams |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Video Microsoft, Chat di Microsoft Teams |
...
| URL dell'informativa sulla privacy | https://thetalake.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | Delegato | API Graph deve essere l'accesso per ricevere il record di chiamata | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
