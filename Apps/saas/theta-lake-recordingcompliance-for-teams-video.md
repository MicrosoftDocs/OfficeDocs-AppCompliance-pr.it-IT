---
title: Informazioni sull'applicazione per theta Lake Recording &amp; Compliance for Teams Video by Theta Lake
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
|:----------------|:-------------|
| Nome dell'app | Theta Lake Recording &amp; Compliance for Teams Video |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| Nome società partner | Theta Lake |
| Sito Web aziendale | [https://thetalake.com](https://thetalake.com) |
| Condizioni per l'uso dell'app | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| Funzionalità di base dell'app | Registrazione, archiviazione, conformità e mitigazione dei rischi per Microsoft Teams riunioni audio e video |
...
Queste informazioni sono state fornite da Theta Lake su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Microsoft Video, Microsoft Teams Chat |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | delegated | Graph'API deve essere l'accesso per ricevere il record di chiamata | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
