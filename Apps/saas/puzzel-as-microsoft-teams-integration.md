...
Informazioni fornite da Puzzel AS a Microsoft:
...
Queste informazioni sono state fornite da Puzzel AS su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati di presenza, dati utente, dati del calendario |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati utente, dati del calendario |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Norvegia, Regno Unito di Gran Bretagna e Irlanda del Nord (il) |
...
| URL dell'informativa sulla privacy | https://www.puzzel.com/neighbourhood/trust-centre |
