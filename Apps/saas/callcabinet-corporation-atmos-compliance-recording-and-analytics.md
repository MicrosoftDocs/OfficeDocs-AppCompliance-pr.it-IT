---
title: Informazioni sull'applicazione per CallCabinet Atmos Compliance Recording and Analytics di CallCabinet Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: Tutte le informazioni disponibili sulla sicurezza e sulla conformità per CallCabinet Atmos Compliance Recording and Analytics, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="callcabinet-atmos-compliance-recording-and-analytics"></a>Registrazione e analisi della conformità di CallCabinet Atmos

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 26 gennaio 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/callcabinetcorporation1584393576335.atmos" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da CallCabinet Corporation a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Registrazione e analisi della conformità di CallCabinet Atmos |
| ID | callcabinetcorporation1584393576335.atmos |
| Nome della società partner | CallCabinet Corporation |
| Sito Web dell'azienda | [https://www.callcabinet.com](https://www.callcabinet.com) |
| Condizioni per l'utilizzo dell'app | [https://www.callcabinet.com/terms-and-conditions/](https://www.callcabinet.com/terms-and-conditions/) |
| Funzionalità di base dell'app | Atmos by CallCabinet è una soluzione SaaS per la conformità nativa di Azure, analisi di intelligenza artificiale e qa per Microsoft Teams e altri sistemi di collaborazione o contact center. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.callcabinet.com/compliance-microsoft-teams-call...](https://www.callcabinet.com/compliance-microsoft-teams-call-recording/) |
...
Queste informazioni sono state fornite da CallCabinet Corporation su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Conversazioni, video e condivisione dello schermo registrati di Teams |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Conversazioni, video e condivisione dello schermo registrati di Teams |
