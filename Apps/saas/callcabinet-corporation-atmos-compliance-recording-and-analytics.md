...
description: Tutte le informazioni di sicurezza e conformità disponibili per CallCabinet Atmos Compliance Recording and Analytics, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
|:----------------|:-------------|
| Nome app | CallCabinet Atmos Compliance Recording and Analytics |
| ID | callcabinetcorporation1584393576335.atmos |
| Nome società partner | CallCabinet Corporation |
| Sito Web aziendale | [https://www.callcabinet.com](https://www.callcabinet.com) |
| Condizioni per l'uso dell'app | [https://www.callcabinet.com/terms-and-conditions/](https://www.callcabinet.com/terms-and-conditions/) |
| Funzionalità di base dell'app | Atmos by CallCabinet è una soluzione di registrazione delle chiamate di conformità nativa di Azure, analisi AI e SAAS qa per Microsoft Teams e altri sistemi di collaborazione o contact center. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://www.callcabinet.com/compliance-microsoft-teams-call...](https://www.callcabinet.com/compliance-microsoft-teams-call-recording/) |
...
Queste informazioni sono state fornite da CallCabinet Corporation su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Conversazioni Teams, video e condivisione dello schermo |
