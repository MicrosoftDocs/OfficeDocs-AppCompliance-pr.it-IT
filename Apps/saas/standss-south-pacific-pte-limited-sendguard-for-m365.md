---
title: Informazioni sull'applicazione per SendGuard per M365 by Standss (South Pacific) PTE Limited
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SendGuard per M365, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
---
# <a name="sendguard-for-m365"></a>SendGuard per M365
