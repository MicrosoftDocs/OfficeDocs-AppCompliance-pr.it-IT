...
description: Tutte le informazioni di sicurezza e conformità disponibili per MURAL, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da MURAL a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | MURAL |
| ID | tactivosincdbamural1608253315049.sol-43803-aek |
| Nome della società partner | MURAL |
| Sito Web dell'azienda | [https://www.mural.co](https://www.mural.co) |
| Condizioni per l'utilizzo dell'app | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| Funzionalità di base dell'app | Pensare e collaborare visivamente |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://support.mural.co](https://support.mural.co) |
...
Queste informazioni sono state fornite da MURAL su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | MURAL richiede solo nome, cognome e indirizzo di posta elettronica per l'accesso. Il tipo di dati da elaborare/archiviare dipende dal cliente. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | MURAL archivia solo il nome, il cognome e l'indirizzo di posta elettronica dell'utente a scopo di accesso. Qualsiasi altra informazione archiviata dipende dalle informazioni che i clienti archiviano nei loro murales. |
...
| Data di certificazione SOC2 più recente | 2021-04-01 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2021-04-01 |
...
| URL dell'informativa sulla privacy | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | Delegato | Files.read necessario per caricare i documenti in MURAL. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | Delegato | User.read perché il murale richiede nome, cognome e posta elettronica per la creazione dell'account. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
