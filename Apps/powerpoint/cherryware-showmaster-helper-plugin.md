---
title: Informazioni sull'applicazione per Showmaster (plug-in helper) di cherryware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Showmaster (helper plugin), i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da cherryware a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Showmaster (plug-in helper) |
| ID | WA200003676 |
| client Office 365 supportati | PowerPoint 2016 o versioni successive in Mac, PowerPoint sul web, PowerPoint 2013 o versioni successive Windows |
...
Queste informazioni sono state fornite da cherryware su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
