---
title: Informazioni sull'applicazione per diagrammi lucidi per PowerPoint di Lucid Software Inc
ms.author: elmalova
author: elenamalova
ms.date: 12/16/2019
ms.topic: article
...
description: Tutte le informazioni disponibili sulla sicurezza e la conformità per Lucidchart Diagrams for PowerPoint, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel Registro di sistema CSA STAR.
...
---
# <a name="lucidchart-diagrams-for-powerpoint"></a>Diagrammi lucidi per PowerPoint
...
* <a href="https://appsource.microsoft.com/product/office/WA104380117" target="_blank">Visualizza in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Diagrammi lucidi per PowerPoint |
| ID | WA104380117 |
