...
description: Tutte le informazioni di sicurezza e conformità disponibili per Showmaster, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
Informazioni fornite dal software di configurazione a Microsoft:
...
Queste informazioni sono state fornite dal software di gestione dei dati sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
