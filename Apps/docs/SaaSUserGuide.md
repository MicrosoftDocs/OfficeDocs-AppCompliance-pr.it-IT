---
title: Guida utente per le app SaaS
author: LGerrard
ms.author: legerrar
manager: tonybal
description: Guida utente ISV per Microsoft 365 App Compliance Program SaaS
...
## <a name="3-publisher-attestation-workflow"></a>3. Flusso di lavoro di attestazione Publisher
...
![Conformità delle app nel Marketplace commerciale](../media/PCappcompliance3.png)
  
**Passaggio 4**: Compilare il questionario di autovalutazione per Publisher Attestazione.

![Attestazione completa Publisher](../media/UserGuidePhotos/5.5.png)
...
![Clona funzionalità](../media/UserGuidePhotos/05.png)
...
![Importa funzionalità di esportazione](../media/UserGuidePhotos/06.png)
 
**Passaggio 5**: al termine, fare clic su "Invia", la valutazione sarà ora "Sotto revisione".
 
 ![Inviare Publisher Conferma attesa](../media/UserGuidePhotos/07.png) ![dell'invio](../media/UserGuidePhotos/08.png)
...
![attestazione Publisher rifiutata](../media/UserGuidePhotos/09.png)
...
- Al momento dell'approvazione, il partner può:
 ...
 ![attestazione Publisher completata](../media/UserGuidePhotos/10.png)       
...
![Avviare la certificazione Microsoft 365](../media/UserGuidePhotos/13.png) 
  
**Passaggio 1**: Invio iniziale del documento

Compilare tutti i dettagli, caricare i documenti pertinenti e fare clic su "Invia"
  
![Invio iniziale del](../media/UserGuidePhotos/14.png) 
![ documentoSubmit Initial Document Submission](../media/UserGuidePhotos/15.png)
  
Facendo clic su Invia, l'invio del documento iniziale verrà esaminato.

![Invio iniziale del documento in fase di revisione](../media/UserGuidePhotos/16.png)
...
![Requisiti di controllo completi](../media/UserGuidePhotos/18.png)
...
![Invio sottoposto a revisione](../media/UserGuidePhotos/21.png)
...
![Le evidenze devono essere aggiornate](../media/UserGuidePhotos/22.png)
...
## <a name="5---microsoft-365-renewal-workflow"></a>5. Microsoft 365 flusso di lavoro di rinnovo:
...
![Eseguire il rinnovo nell'attestazione](../media/UserGuidePhotos/29.png)
...
![Renewel di attestazione](../media/UserGuidePhotos/32.png) 
...
![Rifiuto della certificazione](../media/UserGuidePhotos/34.png)

Scenario 1B: 

Il rinnovo della certificazione è approvato

![Approvazione del rinnovo della certificazione](../media/UserGuidePhotos/35.png)
...
![Approvazione del rinnovo della certificazione](../media/UserGuidePhotos/36.png)
