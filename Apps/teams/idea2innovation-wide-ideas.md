...
| Nome società partner | Idea2Innovation |
| Sito Web aziendale | [https://getwideideas.com](https://getwideideas.com) |
| Condizioni per l'uso dell'app | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474849364/Product_42949683744/Asset_0831a14b-e5df-4f0b-8385-3c06edaeceeb/GENERALTERMSANDCONDITIONSWideI.pdf) |
| Funzionalità di base dell'app | Wide Ideas è una soluzione di gestione delle idee flessibile basata Microsoft 365 servizi cloud. Completamente integrato con Microsoft Teams, con funzionalità di innovazione aperta, consente alle aziende di collaborare alla ricerca delle idee migliori per le sfide quotidiane. Wide Ideas è l'unico software di gestione delle idee sul mercato sufficientemente flessibile da consentire a ogni reparto o unità aziendale all'interno di un gruppo aziendale di eseguire i propri processi personalizzati e di condividere ancora idee e procedure consigliate tra l'intera organizzazione |
...
Queste informazioni sono state fornite da Idea2Innovation su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
