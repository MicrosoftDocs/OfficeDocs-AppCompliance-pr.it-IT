---
title: Informazioni sull'applicazione per CSOD Learn di Cornerstone OnDemand
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per CSOD Learn, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/81726ee9-4d27-47ad-8b22-08147c6f8613" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | CSOD Learn |
| ID | WA200003020 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Cornerstone OnDemand |
| Sito Web dell'azienda | [https://www.cornerstoneondemand.com](https://www.cornerstoneondemand.com) |
| Condizioni per l'utilizzo dell'app | [https://www.microsoft.com/en-us/microsoft-teams/group-chat-...](https://www.microsoft.com/en-us/microsoft-teams/group-chat-software) |
| Funzionalità di base dell'app | Gli elementi essenziali di un sistema di gestione Learning direttamente all'interno di Teams |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | AWS, SelfHosted |
...
Queste informazioni sono state fornite da Cornerstone OnDemand sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC1 più recente | 2020-01-01 |
| L'app è conforme ai controlli dell'organizzazione del servizio (SOC 2)? | Sì |
| Data di certificazione SOC2 più recente | 2020-01-01 |
