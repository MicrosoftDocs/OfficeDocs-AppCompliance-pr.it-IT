...
description: Tutte le informazioni di sicurezza e conformità disponibili per LifeWorks, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64878223"
---
# <a name="lifeworks"></a>LifeWorks

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 16 giugno 2021</p>

* <a href="https://teams.microsoft.com/l/app/fc1190ba-8dd9-4481-832d-2c2974341173" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | LifeWorks |
| ID | WA200003287 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | LifeWorks |
| Sito Web dell'azienda | [https://lifeworks.com](https://lifeworks.com) |
| Condizioni per l'utilizzo dell'app | [https://help.lifeworks.com/hc/en-gb/articles/209973913-End-...](https://help.lifeworks.com/hc/en-gb/articles/209973913-End-User-Licence-Agreement) |
| Funzionalità di base dell'app | Aiuta il tuo team ad accedere al supporto per il benessere e ai contenuti di cui ha bisogno da qualsiasi luogo, in qualsiasi momento. |
...
Queste informazioni sono state fornite da LifeWorks sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
