---
title: Informazioni sull'applicazione per Workday Peakon Employee Voice by Workday
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Workday Peakon Employee Voice, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65125361"
---
# <a name="workday-peakon-employee-voice"></a>Voce dei dipendenti di Workday Peakon

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 20 luglio 2021</p>

* <a href="https://teams.microsoft.com/l/app/1c37bec0-d522-4cba-9643-ddc79d841729" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003453" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Voce dei dipendenti di Workday Peakon |
| ID | WA200003453 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Workday |
| Sito Web dell'azienda | [https://www.workday.com/en-us/homepage.html](https://www.workday.com/en-us/homepage.html) |
| Condizioni per l'utilizzo dell'app | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams...](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams/post-license/) |
| Funzionalità di base dell'app | Ottieni notifiche sui nuovi sondaggi Invia risposte ai sondaggi direttamente tramite Microsoft Teams Ricorda i sondaggi che non hai ancora completato. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams) |
...
Queste informazioni sono state fornite da Workday sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Posta elettronica e ID di Azure Active Director: l'app Peakon per MS Teams non elabora direttamente i dati.  |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID società, log applicazioni |
...
| Data di certificazione SOC2 più recente | 2021-03-03 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | Applicazione | Installazione dell'app e ricerca dell'utente all'interno del database di Azure   | [075a01db-a69f-4975-a713-aa85d004f3b5](../azure/075a01db-a69f-4975-a713-aa85d004f3b5.md) |
