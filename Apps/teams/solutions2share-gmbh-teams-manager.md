---
title: Informazioni sull'applicazione per Teams Manager di Solutions2Share GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Teams Manager, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 24 settembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/87000000-3db9-bb44-5015-0b4a327a6597" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://teams-manager.com](https://teams-manager.com) |
| Condizioni per l'utilizzo dell'app | [https://www.teams-manager.com/terms-of-use/](https://www.teams-manager.com/terms-of-use/) |
| Funzionalità di base dell'app | Creare nuove Teams basate su modelli complessi e personalizzabili con il flusso di lavoro di approvazione. Teams Manager aiuta le aziende a mantenere il controllo sui Microsoft Teams e a fermare la crescita incontrollata con funzionalità di governance, consentendo al contempo agli utenti di creare nuovi Teams. |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni sull'app | [https://teams-manager.com](https://teams-manager.com) |
...
Queste informazioni sono state fornite da Solutions2Share GmbH sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | Entrambi | Si archiviano tenantID e TeamId per eseguire il mapping dei modelli.  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| Notes.ReadWrite.All | Applicazione | Nessuno | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read | Delegato | Nessuno | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read.All | Entrambi | Viene salvato l'ID dell'utente immesso nella sezione responsabile approvazione/amministratore. | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.ReadBasic.All | Delegato | Nessuno | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
