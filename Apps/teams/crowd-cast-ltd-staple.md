...
description: Tutte le informazioni di sicurezza e conformità disponibili per Staple, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64878313"
---
# <a name="staple"></a>Graffetta

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 27 settembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/ac9ca94a-e666-4f61-959a-12c063e13e69" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Graffetta |
| ID | WA200003281 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Crowd Cast, Ltd. |
| Sito Web dell'azienda | [https://crowdcast.jp/ja/](https://crowdcast.jp/ja/) |
| Condizioni per l'utilizzo dell'app | [https://go.microsoft.com](https://go.microsoft.com) |
| Funzionalità di base dell'app | Modificare lo stile di lavoro con la gestione delle spese in tempo reale. La graffetta consente di inviare, approvare e tenere traccia facilmente delle spese per l'azienda. Collegarsi con servizi Microsoft per interagire facilmente con il nostro prodotto. |
| Sede centrale dell'azienda | Giappone |
| Pagina delle informazioni sull'app | [https://intercom.help/staple/ja](https://intercom.help/staple/ja) |
...
Queste informazioni sono state fornite da Crowd Cast, Ltd. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | Applicazione | Usato per la raccolta dell'ID tenant. Usato per garantire che gli utenti che eseguono l'autenticazione con la piattaforma siano membri di un tenant specifico. | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | Applicazione | Teams'app si installa automaticamente nel team dell'utente | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| AppCatalog.Read.All | Delegato | Legge il catalogo app di un utente per verificare se l'app teams è installata. | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| User.Read | Delegato | Usato per leggere l'ID di un utente per assicurarsi che i messaggi vengano inviati all'utente corretto. | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| openid | Delegato | Accedere a un utente per leggere le informazioni di base sul profilo | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
