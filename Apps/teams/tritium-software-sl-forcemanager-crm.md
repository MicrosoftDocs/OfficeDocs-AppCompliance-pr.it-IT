...
description: Tutte le informazioni di sicurezza e conformità disponibili per ForceManager CRM, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f429eb71-607a-4e12-9467-209276404047" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | ForceManager CRM |
| ID | WA200002655 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Tritium Software SL |
| Sito Web dell'azienda | [https://www.forcemanager.com](https://www.forcemanager.com) |
| Condizioni per l'utilizzo dell'app | [https://www.forcemanager.com/info/terms-and-conditions/](https://www.forcemanager.com/info/terms-and-conditions/) |
| Funzionalità di base dell'app | ForceManager è il CRM leader con un'app web e per dispositivi mobili completa creata per una gamma di stili di lavoro, tra cui home, office o il campo. L'app è destinata ai rappresentanti di vendita che devono gestire l'agenda quotidiana e le attività con un'interfaccia intuitiva e un'app facile da usare. |
...
Queste informazioni sono state fornite da Tritium Software SL sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
