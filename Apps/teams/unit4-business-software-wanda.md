---
title: Informazioni sull'applicazione per Wanda di Unit4 Business Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Wanda, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Unit4 Business Software a Microsoft:
...
| Nome della società partner | Unit4 Business Software |
| Sito Web dell'azienda | [https://www.unit4.com](https://www.unit4.com) |
| Condizioni per l'utilizzo dell'app | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| Funzionalità di base dell'app | Wanda ti aiuta a prenderti cura delle tue attività ERP più di routine. |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
Queste informazioni sono state fornite da Unit4 Business Software su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | ID utente Microsoft Teams specifico del bot |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID utente Microsoft Teams specifico del bot |
...
| URL dell'informativa sulla privacy | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |
