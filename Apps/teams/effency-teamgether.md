...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per TeamGether, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5a0547cc-ea63-4425-acc8-08b89a8fc1a1" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://www.effency.fr](https://www.effency.fr) |
| Condizioni per l'utilizzo dell'app | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| Funzionalità di base dell'app | TeamGether è la principale applicazione di coaching digitale nell'efficienza collettiva sviluppata da EFFENCY |
| Sede centrale dell'azienda | Francia |
| Pagina delle informazioni sull'app | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
...
Queste informazioni sono state fornite da EFFENCY sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
