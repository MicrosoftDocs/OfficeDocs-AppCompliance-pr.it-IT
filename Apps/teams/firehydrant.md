---
title: Informazioni sull'applicazione per FireHydrant by FireHydrant
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per FireHydrant, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Visualizzazione in Teams store</a>
...
|:----------------|:-------------|
| Nome app | FireHydrant |
| ID | WA200003794 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | FireHydrant |
| Sito Web aziendale | [https://firehydrant.io](https://firehydrant.io) |
| Condizioni per l'uso dell'app | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
...
Queste informazioni sono state fornite da FireHydrant sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | delegated | FireHydrant crea canali per conto dei nostri utenti per gestire gli eventi imprevisti | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
