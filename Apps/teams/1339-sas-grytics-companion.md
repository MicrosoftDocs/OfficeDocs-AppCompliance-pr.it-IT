---
title: Informazioni sull'applicazione per Grytics Companion by 1339 SAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Grytics Companion, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66547450"
---
# <a name="grytics-companion"></a>Grytics Companion
...
* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite dalla firma di accesso condiviso 1339 a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Grytics Companion |
| ID | WA200004217 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | 1339 FIRMA DI ACCESSO CONDIVISO |
| Sito Web dell'azienda | [https://grytics.com](https://grytics.com) |
| Condizioni per l'utilizzo dell'app | [https://grytics.com/terms](https://grytics.com/terms) |
| Funzionalità di base dell'app | Gli utenti possono confrontare &amp; analizzare l'attività delle tendenze &amp; dei social network aziendali che sono stati aggiunti ai loro account Grytics |
...
Queste informazioni sono state fornite da 1339 sas su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Indirizzo di posta elettronica, nome |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome, Posta elettronica per gli utenti dell'app.  |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Irlanda, Francia |
...
| URL dell'informativa sulla privacy | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Applicazione | Necessario per consentire agli amministratori di Grytics di autorizzare gli utenti Grytics a usare l'app in Teams e a corrispondere all'ID utente in AAD | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | Delegato | Necessario per il flusso di autenticazione SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | Applicazione | Necessario per consentire agli amministratori di Grytics di autorizzare gli utenti Grytics a usare l'app in Teams e a corrispondere all'ID utente in AAD | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| email | Delegato | Necessario per il flusso di autenticazione SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | Delegato | Necessario per il flusso di autenticazione SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| profile | Delegato | Necessario per il flusso di autenticazione SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
