...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Klaxoon, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
|:----------------|:-------------|
| Nome dell'app | Klaxoon |
| ID | WA104382058 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Klaxoon |
| Sito Web dell'azienda | [https://klaxoon.com](https://klaxoon.com) |
| Condizioni per l'utilizzo dell'app | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| Funzionalità di base dell'app | Klaxoon offre l'accesso a una suite completa di strumenti collaborativi (lavagna, sondaggio, quizz, polling live e così via) progettati per migliorare l'efficienza del lavoro in team. La suite Klaxoon è accessibile come app Web, app per dispositivi mobili (Apple/Android) o direttamente da Microsoft Teams (tramite un'integrazione tab) |
| Sede centrale dell'azienda | Francia |
| Pagina delle informazioni sull'app | [https://klaxoon.com](https://klaxoon.com) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? | Ibrido |
| Quali provider di servizi cloud di hosting usano l'app? | Azure, Aws, Altro |
...
Queste informazioni sono state fornite da Klaxoon su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | email, firstname, lastname, avatar |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | email, firstname, lastname, avatar |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Stati Uniti d'America, Francia, Germania |
...
| URL dell'informativa sulla privacy | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
| Elencare i tipi di criteri supportati | si prega di chiedere i dettagli |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | identificazione utente e creazione dell'account | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| email | Delegato | identificazione utente e creazione dell'account | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | Delegato | identificazione utente e creazione dell'account | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | Delegato | identificazione utente e creazione dell'account | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| profile | Delegato | identificazione utente e creazione dell'account | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
