...
description: Tutte le informazioni sulla sicurezza e la conformità disponibili per Standup Alice, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
|:----------------|:-------------|
| Nome app | Standup Alice |
| ID | WA200000758 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Bao Le Duc |
| Sito Web aziendale | [https://www.standupalice.com](https://www.standupalice.com) |
| Condizioni per l'uso dell'app | [https://www.standupalice.com/terms](https://www.standupalice.com/terms) |
| Funzionalità di base dell'app | Consente di eseguire in modo efficace riunioni di stand-up giornaliere per i team di Scrum |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni dell'app | [https://www.standupalice.com](https://www.standupalice.com) |
...
Queste informazioni sono state fornite da Bao Le Duc su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
