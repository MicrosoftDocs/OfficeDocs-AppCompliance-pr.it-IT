---
title: Informazioni sull'applicazione per Teamflect di Teamflect
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Teamflect, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
Informazioni fornite da Teamflect a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Teamflect |
| ID | WA200001860 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Teamflect |
| Sito Web dell'azienda | [https://teamflect.com](https://teamflect.com) |
| Condizioni per l'utilizzo dell'app | [https://teamflect.com/terms](https://teamflect.com/terms) |
| Funzionalità di base dell'app | Teamflect è una soluzione all-in-one per la gestione delle prestazioni e l'engagement dei dipendenti creata per Microsoft Teams. Rende le persone più produttive e più coinvolte con i moduli Meeting, Goal/OKR, Feedback, Recognition e Tasks 1-on-1 |
...
Queste informazioni sono state fornite da Teamflect sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Applicazione | Questa autorizzazione viene usata per accedere ai calendari utente per identificare le riunioni 1-on-1 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | Delegato | Directory aziendale: questa autorizzazione viene usata per visualizzare agli utenti finali un elenco dei colleghi quando eseguono una ricerca | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
