---
title: Informazioni sull'applicazione per Scormium di Sense4code
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Scormium, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656189"
---
# <a name="scormium"></a>Scormio
...
* <a href="https://teams.microsoft.com/l/app/ad42b2ed-c5ad-4f2c-99e3-5da268a9c967" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004358" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Sense4code a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Scormio |
| ID | WA200004358 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Sense4code |
| Sito Web dell'azienda | [https://en.scormium.com](https://en.scormium.com) |
| Condizioni per l'utilizzo dell'app | [https://en.scormium.com/podminky-a-pravidla-uziti](https://en.scormium.com/podminky-a-pravidla-uziti) |
| Funzionalità di base dell'app | Godetevi il potere di e-learning, eventi e percorsi di studio con Scormium.  |
...
Queste informazioni sono state fornite da Sense4code sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Messaggio di posta elettronica dell'utente   |
...
| URL dell'informativa sulla privacy | https://en.scormium.com/zasady-ochrany-soukromi |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Accedere e leggere il profilo utente | [ffdbe361-6168-42f7-beef-d1931b7922da](../azure/ffdbe361-6168-42f7-beef-d1931b7922da.md) |
