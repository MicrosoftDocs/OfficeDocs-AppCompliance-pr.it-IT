---
title: Informazioni sull'applicazione per SmartWork di SmartWork di Intumit
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SmartWork, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a938ae1e-a791-4751-9e6a-178c991fa0fa" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | SmartWork |
| ID | WA200001149 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SmartWork of Intumit |
| Sito Web dell'azienda | [https://www.intumit.com/english/](https://www.intumit.com/english/) |
| Condizioni per l'utilizzo dell'app | [https://www.intumit.com/english/TermsOfUse.html](https://www.intumit.com/english/TermsOfUse.html) |
...
Queste informazioni sono state fornite da SmartWork di Intumit sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Uso di userPrincipalName per identificare se la posta dell'utente proviene da AAD validi o meno | [a938ae1e-a791-4751-9e6a-178c991fa0fa](../azure/a938ae1e-a791-4751-9e6a-178c991fa0fa.md) |
