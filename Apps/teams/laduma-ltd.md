---
title: Application Information for Laduma di Laduma Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Laduma, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64784641"
---
# <a name="laduma"></a>Laduma

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 28 febbraio 2022</p>

* <a href="https://teams.microsoft.com/l/app/3bcb0d8a-5ec8-4637-a946-958e5c0277fd" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003907" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Laduma Ltd. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Laduma |
| ID | WA200003907 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Laduma Ltd. |
| Sito Web dell'azienda | [https://laduma.com](https://laduma.com) |
| Condizioni per l'utilizzo dell'app | [https://laduma.com/terms-of-service/](https://laduma.com/terms-of-service/) |
| Funzionalità di base dell'app | Condivisione illimitata di lavagne, documenti e applicazioni per Microsoft Teams |
...
Queste informazioni sono state fornite da Laduma Ltd. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente, dati degli eventi utente, token di accesso GraphAPI, canali di Microsoft Teams, risorse calendario e sala |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati del profilo utente, dati degli eventi utente, token di accesso GraphAPI, canali di Microsoft Teams, risorse calendario e sala |
...
| URL dell'informativa sulla privacy | https://laduma.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Application.Read.All | Applicazione | Assicurarsi che l'applicazione sia installata quando si tenta di aggiungere una riunione al calendario | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
>| Calendars.Read | Entrambi | È necessario aggiungere riunioni al calendario dell'utente | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
