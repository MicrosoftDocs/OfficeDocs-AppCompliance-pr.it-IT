---
title: Informazioni sull'applicazione per Abi di Beroe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Abi, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66564603"
---
# <a name="abi"></a>Abi

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 17 marzo 2022</p>

* <a href="https://teams.microsoft.com/l/app/55560ea0-ae82-48b2-b71e-a45356f56bb1" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003862" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Beroe a Microsoft:
...
| Nome della società partner | Beroe |
| Sito Web dell'azienda | [https://www.beroeinc.com](https://www.beroeinc.com) |
| Condizioni per l'utilizzo dell'app | [https://www.beroeinc.com/terms/](https://www.beroeinc.com/terms/) |
| Funzionalità di base dell'app | Abi &#8211; l'assistente per l'approvvigionamento digitale basato sull'intelligenza artificiale |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://www.beroeinc.com/beroe-live-ai](https://www.beroeinc.com/beroe-live-ai) |
...
Queste informazioni sono state fornite da Beroe sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Nome, Cognome &amp; ID di posta elettronica di lavoro |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome, Cognome, ID &amp; di conversazione di posta elettronica aziendale |
...
| URL dell'informativa sulla privacy | https://www.beroeinc.com/privacy-policy/ |
