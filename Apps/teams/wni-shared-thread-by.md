---
title: Application Information for Shared Thread by WNI by WNI
ms.author: elmalova
author: elenamalova
ms.date: 02/09/2022
ms.topic: article
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Thread condiviso da WNI, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
---
# <a name="shared-thread-by-wni"></a>Thread condiviso da WNI

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: January 10, 2022</p>

* <a href="https://teams.microsoft.com/l/app/33830d7f-553a-46ce-99b3-4dc436b28e45" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003755" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da WNI a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Thread condiviso da WNI |
| ID | WA200003755 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | WNI |
| Sito Web aziendale | [https://www.wni.app](https://www.wni.app) |
| Condizioni per l'uso dell'app | [https://www.wni.app/terms](https://www.wni.app/terms) |
| Funzionalità di base dell'app | Crea una conversazione in Microsoft Teams canale che può essere collegata a una conversazione in un altro canale Microsoft Teams oppure a un thread in Slack.  Una volta configurato,  |
...
Queste informazioni sono state fornite da WNI su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.wni.app/privacy |
