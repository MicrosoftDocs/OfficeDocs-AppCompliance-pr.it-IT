---
title: Informazioni sulle applicazioni per Thinky365-Autotask da Think AI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Thinky365-Autotask, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2291b3d5-ea1d-4605-9a94-ac4523b85c06" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004355" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Think AI to Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Thinky365-Autotask |
| ID | WA200004355 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Pensare all'intelligenza artificiale |
| Sito Web dell'azienda | [https://www.thinky365.com](https://www.thinky365.com) |
| Condizioni per l'utilizzo dell'app | [https://thinky365.com/terms-of-use/](https://thinky365.com/terms-of-use/) |
| Funzionalità di base dell'app | Il chatbot Thinky365 per Autotask è l'agente virtuale 24&#215;7. Con questo chatbot sarà possibile elevare la produttività del team di servizio in modi nuovi e innovativi migliorando al tempo stesso l'esperienza utente complessiva per i clienti.  |
...
Queste informazioni sono state fornite da Think AI su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Endpoint di servizi come Microsoft Graph, CRM e Azure |
...
| Elencare i tipi di criteri supportati | Criteri personalizzati |
