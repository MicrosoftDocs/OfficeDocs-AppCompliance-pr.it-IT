...
description: Tutte le informazioni di sicurezza e conformità disponibili per MeasureUp, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bb1f94be-57aa-452c-9073-7fbb6b8b1797" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | MeasureUp |
| ID | WA200003111 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Media Interactiva Solutions |
| Sito Web dell'azienda | [https://www.measureup.com](https://www.measureup.com) |
| Condizioni per l'utilizzo dell'app | [https://www.measureup.com/legal-notice](https://www.measureup.com/legal-notice) |
| Funzionalità di base dell'app | Valutare le competenze del team in modo più efficiente con MeasureUp. |
| Sede centrale dell'azienda | Spagna |
| Pagina delle informazioni sull'app | [https://docs.measureup.com](https://docs.measureup.com) |
...
Queste informazioni sono state fornite da Media Interactiva Solutions su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Informazioni sul profilo per registrare e consentire l'accesso. Quando gli utenti accedono all'applicazione, i dati del profilo Microsoft sono necessari per creare il profilo utente nella piattaforma. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | Delegato | Informazioni sul profilo per registrare e consentire l'accesso. Quando gli utenti accedono all'applicazione, i dati del profilo Microsoft sono necessari per creare il profilo utente nella piattaforma. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| profile | Delegato | Informazioni sul profilo per registrare e consentire l'accesso. Quando gli utenti accedono all'applicazione, i dati del profilo Microsoft sono necessari per creare il profilo utente nella piattaforma. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
