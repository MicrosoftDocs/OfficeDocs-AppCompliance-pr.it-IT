...
description: Tutte le informazioni di sicurezza e conformità disponibili per YAROOMS, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/495f8194-bdf2-41a3-8292-3f53b004c2e6" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | YAROOMS |
| ID | WA200001225 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | YAROOMS |
| Sito Web dell'azienda | [https://yarooms.com](https://yarooms.com) |
| Condizioni per l'utilizzo dell'app | [https://www.yarooms.com/legal/terms-conditions/](https://www.yarooms.com/legal/terms-conditions/) |
| Funzionalità di base dell'app | Software per la prenotazione di room &amp; desk |
| Sede centrale dell'azienda | Romania |
| Pagina delle informazioni sull'app | [https://yarooms.com/help](https://yarooms.com/help) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? | Iaas |
| Quali provider di servizi cloud di hosting usano l'app? | Aws, Azure, GCP |
...
Queste informazioni sono state fornite da YAROOMS sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.yarooms.com/legal/privacy-policy |
