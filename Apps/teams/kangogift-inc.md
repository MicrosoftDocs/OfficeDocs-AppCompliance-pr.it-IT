---
title: Application Information for KangoGift di KangoGift, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per KangoGift, i criteri di gestione dei dati, le informazioni del catalogo delle app microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a19a36e4-c33d-4988-a706-5c740ccab0eb" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004174" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da KangoGift, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | KangoGift |
| ID | WA200004174 |
| Client di Office 365 supportati | Microsoft Teams |
| Nome della società partner | KangoGift, Inc. |
| Sito Web dell'azienda | [https://www.kangogift.com](https://www.kangogift.com) |
| Condizioni per l'utilizzo dell'app | [https://www.kangogift.com/app_terms](https://www.kangogift.com/app_terms) |
| Funzionalità di base dell'app | Invia riconoscimento e lode. |
...
Queste informazioni sono state fornite da KangoGift, Inc. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Informazioni di base sugli utenti: nome, posta elettronica. Questo viene gestito in un contratto separato che abbiamo con i client.  |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Informazioni di base sugli utenti: nome, posta elettronica. Questo viene gestito in un contratto separato che abbiamo con i client.  |
...
| URL dell'informativa sulla privacy | https://www.kangogift.com/privacy |
