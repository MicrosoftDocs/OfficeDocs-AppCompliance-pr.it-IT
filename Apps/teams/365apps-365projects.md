---
title: Informazioni sull'applicazione per 365Progetti di 365App
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per 365Progetti, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a9c31598-b014-4e20-b3bd-3d275fa738d3" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://365apps.com.au](https://365apps.com.au) |
| Condizioni per l'utilizzo dell'app | [https://365projects.app/eula](https://365projects.app/eula) |
| Funzionalità di base dell'app | Riunire i progetti &amp; Microsoft Teams Creare Project, connetterlo a un canale nuovo o esistente |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://365projects.app](https://365projects.app) |
...
Queste informazioni sono state fornite da 365App su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | indirizzo di posta elettronica del cliente |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Tasks.ReadWrite | Delegato | leggere e aggiornare le attività di Planner | [99a0a9b1-5d28-45df-9f99-792aa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
>| User.Read | Delegato | leggere la posta elettronica dell'utente | [99a0a9b1-5d28-45df-9f99-792aa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
