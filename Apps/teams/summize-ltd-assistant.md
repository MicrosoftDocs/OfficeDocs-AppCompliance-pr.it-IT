...
description: Tutte le informazioni di sicurezza e conformità disponibili per Summize Assistant, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
---
# <a name="summize-assistant"></a>Somma assistente

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 17, 2021</p>

* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003577" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Summize (Ltd) a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Somma assistente |
| ID | WA200003577 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Somma (Ltd) |
| Sito Web aziendale | [https://www.summize.com](https://www.summize.com) |
| Condizioni per l'uso dell'app | [https://www.summize.com/terms-and-conditions](https://www.summize.com/terms-and-conditions) |
| Funzionalità di base dell'app | Somma rende facile la revisione e la creazione dei contratti. Sommare sta cambiando il modo in cui le aziende comprendono e interagiscono con i contratti. Usando il nostro software intelligente e conversazionale, superiamo i processi contrattuali e sbloccheremo le informazioni contrattuali.  Sommare l'app Assistente Teams consente agli utenti di caricare contratti (formati PDF e docx) per la revisione.  Gli utenti possono anche creare contratti usando modelli creati nell'app Somma.   |
...
Queste informazioni sono state fornite da Summize (Ltd) su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Documenti originali e recensioni dei clienti dei documenti |
...
| URL dell'informativa sulla privacy | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |
...
| Sono state esaminate e rispettate tutte le procedure consigliate applicabili descritte nell'elenco Microsoft Identity Platform di integrazione dei dati? | No |
