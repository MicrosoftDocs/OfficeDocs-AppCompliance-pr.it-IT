---
title: Informazioni sull'applicazione per CodeStream di CodeStream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per CodeStream, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880253"
---
# <a name="codestream"></a>CodeStream

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 28 maggio 2021</p>

* <a href="https://teams.microsoft.com/l/app/7cf49ab7-8b65-4407-b494-f02b525eef2b" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | CodeStream |
| ID | WA200001475 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | CodeStream |
| Sito Web dell'azienda | [https://www.codestream.com](https://www.codestream.com) |
| Condizioni per l'utilizzo dell'app | [https://www.codestream.com/terms](https://www.codestream.com/terms) |
| Funzionalità di base dell'app | CodeStream consente di esaminare il &amp; codice di discussione direttamente all'interno dell'IDE. |
...
Queste informazioni sono state fornite da CodeStream sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
