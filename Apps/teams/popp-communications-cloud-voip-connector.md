---
title: Informazioni sull'applicazione per il connettore VoIP cloud POPP di POPP Communications
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/01/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per il connettore VoIP cloud POPP, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 20 settembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/b8e57f6b-31cf-468e-9e99-81f0395cb1f9" target="_blank">Visualizza in Teams store</a>
...
Informazioni fornite da POPP Communications to Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Connettore VoIP cloud POPP |
| ID | WA200003306 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Comunicazioni POPP |
| Sito Web dell'azienda | [https://popp.com](https://popp.com) |
| Condizioni per l'utilizzo dell'app | [https://popp.com/pvnterms/](https://popp.com/pvnterms/) |
| Funzionalità di base dell'app | Effettuare chiamate da Microsoft Teams usando il client MaxUC |
...
Queste informazioni sono state fornite da POPP Communications sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Elencare i tipi di criteri supportati | Criteri di accesso condizionale nella misura in cui tale supporto viene fornito automaticamente dalla libreria MSAL usata per l'autenticazione.  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | Delegato | ID utente e nomi visualizzati dei membri del canale corrente. L'app usa questa opzione per presentare all'utente un elenco di membri del canale da chiamare. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| Chat.Read | Delegato |  Quali dati vengono raccolti o usati? Aggiungere una giustificazione per la raccolta o l'uso dei dati. ID utente e nomi visualizzati dei membri della chat corrente. L'app usa questa opzione per presentare all'utente un elenco di membri della chat da chiamare. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| TeamMember.Read.All | Delegato | ID utente e nomi visualizzati dei membri del team corrente. L'app usa questa opzione per presentare all'utente un elenco di membri del team da chiamare. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| User.Read.All | Delegato |  Quali dati vengono raccolti o usati? Aggiungere una giustificazione per la raccolta o l'uso dei dati. Numero di telefono aziendale e cellulare degli utenti. Ciò è necessario in modo che sia possibile avviare le chiamate telefoniche a questi numeri. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| openid | Delegato | Token di autorizzazione per l'utente, che autorizza l'app ad accedere agli altri endpoint API Graph elencati per loro conto. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
