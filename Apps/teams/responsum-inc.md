---
title: Informazioni sull'applicazione per Responsum di Responsum Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Responsum, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003743" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Responsum Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Responsum |
| ID | WA200003743 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Responsum Inc. |
| Sito Web dell'azienda | [https://www.responsum.ai](https://www.responsum.ai) |
| Condizioni per l'utilizzo dell'app | [https://www.responsum.ai/terms-of-service](https://www.responsum.ai/terms-of-service) |
| Funzionalità di base dell'app | Assistente vendite di intelligenza artificiale per aggiornare le informazioni negli strumenti di vendita e apprendere dalla conoscenza del team. |
...
Queste informazioni sono state fornite da Responsum Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Eventi del calendario utente |
