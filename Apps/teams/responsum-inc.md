---
title: Application Information for Responsum di Responsum Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Responsum, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">Visualizzazione in Teams store</a>
...
| Nome società partner | Responsum Inc. |
| Sito Web aziendale | [https://www.responsum.ai](https://www.responsum.ai) |
| Condizioni per l'uso dell'app | [https://www.responsum.ai/terms-of-service](https://www.responsum.ai/terms-of-service) |
| Funzionalità di base dell'app | Assistente vendite AI per aggiornare le informazioni tra gli strumenti di vendita e imparare dalla conoscenza del team. |
...
Queste informazioni sono state fornite da Responsum Inc. Sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
