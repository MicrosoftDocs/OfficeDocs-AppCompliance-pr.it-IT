---
title: Informazioni sull'applicazione per Read Meeting Navigator di Read AI, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Read Meeting Navigator, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65357117"
---
# <a name="read-meeting-navigator"></a>Lettura dello strumento di navigazione riunioni

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 15 aprile 2022</p>

* <a href="https://teams.microsoft.com/l/app/18eb20ae-cd59-48c6-8060-fbe171a917e5" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003896" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Read AI, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Lettura dello strumento di navigazione riunioni |
| ID | WA200003896 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Read AI, Inc. |
| Sito Web dell'azienda | [https://read.ai](https://read.ai) |
| Condizioni per l'utilizzo dell'app | [https://read.ai/tos](https://read.ai/tos) |
| Funzionalità di base dell'app | Il dashboard di lettura misura il sentiment, l'engagement e le prestazioni complessive delle riunioni. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.read.ai/product](https://www.read.ai/product) |
...
Queste informazioni sono state fornite da Read AI, Inc. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente, dati audio della riunione e dati video delle riunioni  |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati del profilo utente, metriche utente aggregate derivate da dati audio e video |
...
| Data di certificazione SOC2 più recente | 2022-04-14 |
...
| URL dell'informativa sulla privacy | https://read.ai/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegato | Microsoft consente agli utenti di collegare i propri calendari al servizio per abilitare l'invio automatico del bot multimediale di Azure | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.AccessMedia.All | Applicazione | Accedere ai dati audio e video delle riunioni per l'elaborazione delle applicazioni | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.JoinGroupCall.All | Applicazione | Sono necessarie autorizzazioni di aggiunta per il bot multimediale di Azure per partecipare alla riunione di Teams in corso | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| User.Read | Delegato | Nell'ambito del processo SSO, si accede ai dati utente necessari richiedendo l'autorizzazione di lettura per i profili utente | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| email | Delegato | Sono necessari indirizzi di posta elettronica come parte del processo di creazione dell'account  | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| openid | Delegato | Microsoft consente agli utenti di accedere tramite SSO | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| profile | Delegato | È necessario che i dati del profilo utente creino account utente (nome e cognome, in particolare) | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
