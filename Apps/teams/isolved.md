---
title: Informazioni sull'applicazione per isolved by isolved
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per isolved, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66819039"
---
# <a name="isolved"></a>risolto
...
* <a href="https://teams.microsoft.com/l/app/287fab70-2e10-4bc3-9049-8991d7796d81" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004410" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da isolved a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | risolto |
| ID | WA200004410 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | risolto |
| Sito Web dell'azienda | [https://www.isolvedhcm.com](https://www.isolvedhcm.com) |
| Condizioni per l'utilizzo dell'app | [https://www.isolvedhcm.com/legal/agreements/employee-terms-...](https://www.isolvedhcm.com/legal/agreements/employee-terms-and-conditions-for-use) |
| Funzionalità di base dell'app | Consentire alle persone di ottenere rapidamente risposte alle domande sulle risorse umane, all'interno di Microsoft Teams |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.isolvedhcm.com/platform/enhancements/conversati...](https://www.isolvedhcm.com/platform/enhancements/conversational-virtual-assistant) |
...
Queste informazioni sono state fornite da isolved su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | ID tenant di Microsoft Azure, ID utente di Microsoft Azure  |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID tenant di Microsoft Azure, ID utente di Microsoft Azure  |
