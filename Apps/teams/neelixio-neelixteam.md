---
title: Informazioni sull'applicazione per Neelix.Team di Neelix.IO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Neelix.Team, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64876293"
---
# <a name="neelixteam"></a>Neelix.Team

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 10 luglio 2021</p>

* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Neelix.Team |
| ID | WA200003047 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Neelix.IO |
| Sito Web dell'azienda | [https://www.neelix.team](https://www.neelix.team) |
| Condizioni per l'utilizzo dell'app | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| Funzionalità di base dell'app | La piattaforma Neelix gestisce il ciclo di feedback come ciclo completo. Gli utenti possono incanala esperienze in corso, feedback retrospettivo e sentiment nel diario del team. |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://www.neelix.team](https://www.neelix.team) |
...
Queste informazioni sono state fornite da Neelix.IO su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegato | l'app usa id di canale e nomi per offrire praticità agli utenti per la gestione delle preferenze predefinite quando inviano commenti e suggerimenti da MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | Delegato | l'app usa id e nomi del team per fornire praticità agli utenti per la gestione delle preferenze predefinite quando inviano commenti e suggerimenti da MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| email | Delegato | la posta elettronica viene usata come parte della registrazione utente all'interno di Neelix. Dopo la registrazione iniziale, viene usato il messaggio di posta elettronica per le notifiche.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | Delegato | Usato per ottenere il token di aggiornamento | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| profile | Delegato | Il nome utente viene usato per creare un account utente durante la registrazione con Neelix.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | Delegato | L'app Bot usa user.read per poter inviare informazioni all'utente in modo che la piattaforma di base Neelix possa identificare l'utente | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
