...
| Condizioni per l'uso dell'app | [https://brainbot.ai/terms/](https://brainbot.ai/terms/) |
| Funzionalità di base dell'app | BrainBot invia brevi interazioni periodiche per aiutarti a mantenere le conoscenze dei corsi di formazione. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://brainbot.ai](https://brainbot.ai) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | application | Usiamo i nomi completi degli &amp; indirizzi di posta elettronica come parte del processo di autenticazione. Inoltre, gli indirizzi di posta elettronica vengono utilizzati per inviare sequenze di apprendimento all'utente quando ha sottoscritto una | [b256b34a-b377-4fc2-b25a-a8f5f0594e86](../azure/b256b34a-b377-4fc2-b25a-a8f5f0594e86.md) |
