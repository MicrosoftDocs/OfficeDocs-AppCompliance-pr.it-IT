---
title: Informazioni sull'applicazione per Lumio di SMART by SMART Technologies ULC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Lumio by SMART, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e0ffcbc7-f3f2-46b7-a189-afd01c545782" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Lumio by SMART |
| ID | WA200001874 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SMART Technologies ULC |
| Sito Web dell'azienda | [https://smarttech.com](https://smarttech.com) |
| Condizioni per l'utilizzo dell'app | [https://www.smarttech.com/legal/sls-terms](https://www.smarttech.com/legal/sls-terms) |
| Funzionalità di base dell'app | Trasforma le lezioni con attività, valutazioni e collaborazione tra studenti. |
| Sede centrale dell'azienda | Canada |
| Pagina delle informazioni sull'app | [https://www.smarttech.com/smart-learning-suite/](https://www.smarttech.com/smart-learning-suite/) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | AWS, GCP |
...
Queste informazioni sono state fornite da SMART Technologies ULC su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegato | I dati vengono usati per verificare che le autorizzazioni di gruppo non siano raccolte.  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
>| Group.Read.All | Delegato | gruppo di cui sono appart, questo viene usato per verificare che siano parte del gruppo di studenti o docenti per determinare le funzionalità. Nessun dato raccolto.  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
