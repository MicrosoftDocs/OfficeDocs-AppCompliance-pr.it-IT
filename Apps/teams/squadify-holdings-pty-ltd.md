---
title: Informazioni sull'applicazione per Squadify di Squadify Holdings Pty Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Squadify, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/110107b9-4326-43d8-bf43-bf10fcdce8ad" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004349" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Squadify Holdings Pty Ltd a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Squadify |
| ID | WA200004349 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Squadify Holdings Pty Ltd |
| Sito Web dell'azienda | [https://www.squadify.net](https://www.squadify.net) |
| Condizioni per l'utilizzo dell'app | [https://www.squadify.net/mst-terms-of-use](https://www.squadify.net/mst-terms-of-use) |
| Funzionalità di base dell'app | Squadify per Microsoft Teams consente di raccogliere feedback, dialoghi e generare informazioni dettagliate utili per il team. Con Squadify per Microsoft Teams, è possibile configurare un gruppo di creazione con 1 clic e associarlo al team in Microsoft Teams. È anche possibile avviare Squadifys, monitorarne lo stato di avanzamento e generare informazioni dettagliate sulle prestazioni del team in modo da iniziare a creare le conversazioni corrette. |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://www.squadify.net/our-product](https://www.squadify.net/our-product) |
...
Queste informazioni sono state fornite da Squadify Holdings Pty Ltd su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Nome completo utente e indirizzo Email |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome completo utente e indirizzo Email |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Australia |
...
| URL dell'informativa sulla privacy | https://www.squadify.net/privacy-policy |
