---
title: Informazioni sull'applicazione per il contact center CyCX di CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per il Contact Center CyCX, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656165"
---
# <a name="cycx--contact-centre"></a>Centro contatti CyCX

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 27 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da CyTrack a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Centro contatti CyCX |
| ID | WA200004350 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | CyTrack |
| Sito Web dell'azienda | [https://web.cytrack.com](https://web.cytrack.com) |
| Condizioni per l'utilizzo dell'app | [https://web.cytrack.com/subscription-service-software-agree...](https://web.cytrack.com/subscription-service-software-agreement/) |
| Funzionalità di base dell'app | CyCX è rivolto agli utenti aziendali che richiedono di migliorare l'esperienza dei clienti con funzionalità di chiamate vocali e contact center oltre a riunioni, chat e collaborazione.  CyCX è una piattaforma di comunicazione e collaborazione per Microsoft Teams.  Incontra i tuoi clienti sul canale di loro scelta all'interno di Microsoft Teams, CyTrack CyCX offre agli agenti un'unica interfaccia unificata con una visione olistica dei clienti per consentire interazioni più approfondite. |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
