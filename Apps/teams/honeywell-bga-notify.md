---
title: Informazioni sull'applicazione per BGA Notify by Honeywell
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per BGA Notify, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
ms.locfileid: "63459801"
---
# <a name="bga-notify"></a>Notifica BGA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: September 29, 2021</p>

* <a href="https://teams.microsoft.com/l/app/33f1ff9f-5910-4036-9927-e09b90c64518" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003820" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Honeywell a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Notifica BGA |
| ID | WA200003820 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Honeywell |
| Sito Web aziendale | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
| Condizioni per l'uso dell'app | [https://www.honeywell.com/us/en/terms-and-conditions](https://www.honeywell.com/us/en/terms-and-conditions) |
| Funzionalità di base dell'app | Questo bot è principalmente destinato alla messaggistica proattiva ai clienti di Honeywell Business Aviation in base alle preferenze e agli eventi del proprio aereo |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
...
Queste informazioni sono state fornite da Honeywell su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.honeywell.com/us/en/privacy-statement |
