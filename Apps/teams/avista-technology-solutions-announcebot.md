...
description: Tutte le informazioni di sicurezza e conformità disponibili per AnnounceBot, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d13120dd-5961-4589-b470-19d9d01c6668" target="_blank">Visualizzazione in Teams store</a>
...
|:----------------|:-------------|
| Nome app | AnnounceBot |
| ID | WA200003321 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Soluzioni per la tecnologia Avista |
| Sito Web aziendale | [https://announcebot.in](https://announcebot.in) |
| Condizioni per l'uso dell'app | [https://announcebot.in/terms.html](https://announcebot.in/terms.html) |
| Funzionalità di base dell'app | Compleanni, anniversari e saluti dei colleghi di lavoro con AnnounceBot |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni dell'app | [https://announcebot.in](https://announcebot.in) |
