...
| Sito Web aziendale | [https://www.do-tools.net](https://www.do-tools.net) |
| Condizioni per l'uso dell'app | [https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf](https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf) |
| Funzionalità di base dell'app | Rendi le riunioni ancora più convenienti con la lavagna &quot;per la condivisione di materiali&quot;. |
| Sede centrale dell'azienda | Giappone |
| Pagina delle informazioni dell'app | [https://www.do-tools.net](https://www.do-tools.net) |
