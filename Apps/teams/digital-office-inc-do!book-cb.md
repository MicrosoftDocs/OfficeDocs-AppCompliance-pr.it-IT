...
description: Tutte le informazioni di sicurezza e conformità disponibili per do!book CB, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/92abac76-5f78-472f-8dfa-e7c23564cd92" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002597" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Digital Office Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | do!book CB |
| ID | WA200002597 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Digital Office Inc. |
| Sito Web dell'azienda | [https://www.do-tools.net](https://www.do-tools.net) |
| Condizioni per l'utilizzo dell'app | [https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf](https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf) |
| Funzionalità di base dell'app | Rendere le riunioni ancora più convenienti con il &quot;Material Sharing Board&quot;! |
| Sede centrale dell'azienda | Giappone |
| Pagina delle informazioni sull'app | [https://www.do-tools.net](https://www.do-tools.net) |
...
Queste informazioni sono state fornite da Digital Office Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
