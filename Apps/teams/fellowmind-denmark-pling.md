---
title: Informazioni sull'applicazione per Pling di Fellowmind Denmark
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Pling, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9ca359c6-8466-4519-b3b9-29573ebe39ca" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004294" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Fellowmind Denmark a Microsoft:
...
| Nome della società partner | Fellowmind Danimarca |
| Sito Web dell'azienda | [https://intraactive.net](https://intraactive.net) |
| Condizioni per l'utilizzo dell'app | [https://intraactive.net/terms-of-use-pling](https://intraactive.net/terms-of-use-pling) |
| Funzionalità di base dell'app | Notifiche da app integrate o con App per la logica o Power Automate |
...
Queste informazioni sono state fornite da Fellowmind Denmark sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | UPN |
...
| URL dell'informativa sulla privacy | https://intraactive.net/privacy-policy-play |
...
| Elencare i tipi di criteri supportati | Tutti i criteri sono supportati perché lo schema di autenticazione è nativo di Microsoft Teams |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegato | Controllare se l'app è già installata | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | Delegato | Trovare tutti i gruppi per consentire all'utente di scegliere chi deve ricevere un messaggio Pling | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| People.Read | Delegato | Ottenere informazioni sugli utenti allo scopo di garantire un targeting appropriato durante l'invio di messaggi Pling | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.Read | Delegato | Ottenere informazioni sull'utente corrente per verificare chi sono e se sono già registrati con Pling | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.ReadBasic.All | Delegato | Trovare gli utenti in base ai gruppi selezionati per ottenere elenchi di utenti a cui inviare messaggi | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | Applicazione | Quando si inviano messaggi ai gruppi, questa operazione è necessaria per cercare e trovare ogni gruppo | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| Organization.Read.All | Applicazione | Ottenere informazioni sull'organizzazione corrente che ha scaricato Pling per automatizzare l'onboarding | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | Applicazione | Obbligatorio per la messaggistica proattiva in cui Pling viene installato automaticamente quando un utente riceve un messaggio | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
