---
title: Informazioni sull'applicazione per Qooper di COGNATA TECHNOLOGIES, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Qooper, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64878733"
---
# <a name="qooper"></a>Qooper

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 11 giugno 2021</p>

* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002964" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da COGNATA TECHNOLOGIES, LLC a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Qooper |
| ID | WA200002964 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | COGNATA TECHNOLOGIES, LLC |
| Sito Web dell'azienda | [https://qooper.io](https://qooper.io) |
| Condizioni per l'utilizzo dell'app | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| Funzionalità di base dell'app | Raggiungere gli obiettivi con contenuti significativi per le connessioni &amp; . Circonda le persone con connessioni e contenuti significativi tramite mentoring, peer coaching, apprendimento della community e networking. Qooper collabora con aziende, università e organizzazioni non profit di tutte le dimensioni per automatizzare il lavoro di gestione dei programmi di mentoring, connettere le persone su una piattaforma interattiva di mentoring-learning e visualizzare l'analisi dei programmi. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://qooper.io](https://qooper.io) |
...
Queste informazioni sono state fornite da COGNATA TECHNOLOGIES, LLC su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
