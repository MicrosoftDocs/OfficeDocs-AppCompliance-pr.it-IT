---
title: Informazioni sull'applicazione per Freehand di InVision di InVisionApp, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Freehand by InVision, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Visualizza in Teams store</a>
...
| Nome della società partner | InVisionApp Inc. |
| Sito Web dell'azienda | [https://www.invisionapp.com](https://www.invisionapp.com) |
| Condizioni per l'utilizzo dell'app | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| Funzionalità di base dell'app | Collaborare in tempo reale con una lavagna online. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
...
Queste informazioni sono state fornite da InVisionApp, Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-05-13 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2020-06-12 |
