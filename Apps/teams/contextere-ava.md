---
title: Informazioni sull'applicazione per Contextere AVA by Contextere
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Contextere AVA, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64877733"
---
# <a name="contextere-ava"></a>Contextere AVA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 13 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/be5caee0-f2bc-11ea-b597-ef970e2f5141" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Contextere AVA |
| ID | WA200003167 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Contextere |
| Sito Web dell'azienda | [https://contextere.com](https://contextere.com) |
| Condizioni per l'utilizzo dell'app | [https://contextere.com/wp-primary/wp-content/uploads/Contex...](https://contextere.com/wp-primary/wp-content/uploads/Contextere-End-User-License-Agreement-Microsoft-Challenge.pdf) |
| Funzionalità di base dell'app | Contextere Advanced Assistente virtuale (AVA) fornisce informazioni dettagliate sul lavoro per i lavoratori industriali. |
...
Queste informazioni sono state fornite da Contextere su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC3 più recente | 2020-09-30 |
