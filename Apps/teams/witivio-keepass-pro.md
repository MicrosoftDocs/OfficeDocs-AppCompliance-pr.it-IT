...
| Quali dati vengono archiviati nei database? | Team e ID canale |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | delegated | Teams SSO |
>| Files.ReadWrite.All | delegated | Lettura/scrittura del file KDBX in SharePoint |
>| openid | delegated | Teams SSO |
>| profile | delegated | Teams SSO |
>| email | delegated | Teams SSO |
