...
description: Tutte le informazioni di sicurezza e conformità disponibili per Highspot, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/55b7c78e-4768-47e0-97be-e6b953e6a0d0" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Highspot |
| ID | WA200002894 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Highspot |
| Sito Web dell'azienda | [https://www.highspot.com](https://www.highspot.com) |
| Condizioni per l'utilizzo dell'app | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| Funzionalità di base dell'app | Highspot è la piattaforma di abilitazione delle vendite che i rappresentanti amano. Microsoft consente alle aziende di elevare le conversazioni con i clienti che guidano la crescita strategica. La nostra piattaforma intuitiva combina gestione intelligente dei contenuti, formazione, linee guida contestuali, coinvolgimento dei clienti e analisi interattive. I team go-to-market usano Highspot per offrire un'esperienza di acquisto unificata che aumenta i ricavi, la soddisfazione dei clienti e la conservazione. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
...
Queste informazioni sono state fornite da Highspot sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-08-20 |
