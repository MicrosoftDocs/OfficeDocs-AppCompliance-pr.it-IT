...
description: Tutte le informazioni di sicurezza e conformità disponibili per FireWatch, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64879323"
---
# <a name="firewatch"></a>FireWatch

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 29 luglio 2021</p>

* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | FireWatch |
| ID | WA200003303 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Infographics UK Ltd. |
| Sito Web dell'azienda | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| Condizioni per l'utilizzo dell'app | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| Funzionalità di base dell'app | FireWatch Connessione consente ai servizi antincendio e di soccorso di integrare l'applicazione FireWatch con Microsoft Teams in modo che gli utenti possano completare le attività direttamente all'interno Microsoft Teams. Attualmente fornisce supporto e assistenza agli utenti tramite un bot Microsoft Teams per prenotare il servizio on/off direttamente all'interno dell'ambiente utente Microsoft Teams. Le versioni future includeranno il supporto per ulteriori azioni tramite bot e schede, tra cui richieste di festività FireWatch, promemoria di attività e così via. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
...
Queste informazioni sono state fornite da Infographics UK Ltd. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
