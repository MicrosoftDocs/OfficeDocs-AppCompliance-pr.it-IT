...
| Sito Web aziendale | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| Condizioni per l'uso dell'app | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| Funzionalità di base dell'app | FireWatch Connessione consente ai servizi antincendio e di salvataggio di integrare l'applicazione FireWatch con Microsoft Teams in modo che gli utenti possano completare le attività direttamente da Microsoft Teams. Attualmente fornisce supporto e assistenza agli utenti tramite un bot Microsoft Teams per prenotare in servizio direttamente dall'Microsoft Teams'ambiente utente. Le versioni future includeranno il supporto per ulteriori azioni tramite bot e carte, tra cui richieste di festività FireWatch, promemoria di attività e così via. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (la) |
| Pagina delle informazioni dell'app | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
