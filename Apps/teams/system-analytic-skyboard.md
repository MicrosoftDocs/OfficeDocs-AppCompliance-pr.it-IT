---
title: Informazioni sull'applicazione per SkyBoard di System Analytic
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SkyBoard, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9322b063-9069-45fc-aaad-e3a0f9a2462a" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004162" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da System Analytic a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | SkyBoard |
| ID | WA200004162 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Analisi di sistema |
| Sito Web dell'azienda | [https://www.systemanalytic.com](https://www.systemanalytic.com) |
| Condizioni per l'utilizzo dell'app | [https://www.systemanalytic.com/eula.html](https://www.systemanalytic.com/eula.html) |
| Funzionalità di base dell'app | Un comitato di consulenza digitale completo. |
...
Queste informazioni sono state fornite da System Analytic sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://vmlyr-digitalsolutions.com/privacy.html |
