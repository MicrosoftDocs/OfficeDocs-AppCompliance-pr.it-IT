---
title: Informazioni sull'applicazione per Rungway di Rungway
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/27/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Rungway, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4bea8f81-966b-45fe-8c33-4c8843fda977" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004123" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Rungway a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Rungway |
| ID | WA200004123 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Rungway |
| Sito Web dell'azienda | [https://app.rungway.com](https://app.rungway.com) |
| Condizioni per l'utilizzo dell'app | [https://support.rungway.com/terms-conditions.html](https://support.rungway.com/terms-conditions.html) |
| Funzionalità di base dell'app | Porre domande e generare problemi in modo anonimo. Tenere il passo con i consigli condivisi.   |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.rungway.com/product-overview](https://www.rungway.com/product-overview) |
...
Queste informazioni sono state fornite da Rungway sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Indirizzo di posta elettronica utente, informazioni sul profilo utente (personalizzabili per ogni client e immessi dall'utente) |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Indirizzo di posta elettronica utente, informazioni sul profilo utente (personalizzabili per ogni client e immessi dall'utente) |
...
| URL dell'informativa sulla privacy | https://support.rungway.com/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Per accedere al profilo utente in &amp; lettura | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| email | Delegato | Per identificare l'autenticazione &amp; dell'utente | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| offline_access | Delegato | Mantenere l'accesso ai dati | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| openid | Delegato | Per accedere all'utente | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| profile | Delegato | Per visualizzare il profilo di base dell'utente | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
