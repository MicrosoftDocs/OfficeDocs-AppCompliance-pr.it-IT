---
title: Informazioni sull'applicazione per Onsight Connessione da Librestream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per onsight Connessione, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64876333"
---
# <a name="onsight-connect"></a>Onsight Connect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 13 aprile 2021</p>

* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Onsight Connect |
| ID | WA200002769 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Librestream |
| Sito Web dell'azienda | [https://librestream.com](https://librestream.com) |
| Condizioni per l'utilizzo dell'app | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| Funzionalità di base dell'app | Migliorare la strategia di trasformazione digitale per consentire ai lavoratori e ai clienti di accedere immediatamente ai contenuti, alle persone, ai dati intelligenti e alle indicazioni necessarie per esaminare e risolvere rapidamente i problemi. Distribuita a livello globale, Onsight Augmented Reality Platform aumenta l'efficienza operativa in settori quali produzione, aviazione, energia, attrezzature pesanti e assistenza sul campo. |
...
Queste informazioni sono state fornite da Librestream sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
