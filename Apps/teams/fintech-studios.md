---
title: Informazioni sull'applicazione per FinTech Studios di FinTech Studios
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per FinTech Studios, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da FinTech Studios a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | FinTech Studios |
| ID | WA200003969 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | FinTech Studios |
| Sito Web dell'azienda | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| Condizioni per l'utilizzo dell'app | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| Funzionalità di base dell'app | Business Intelligence basata sull'intelligenza artificiale |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
Queste informazioni sono state fornite da FinTech Studios su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente, nomi/id del team, nomi/id di canale (nessun dato di messaggio), nomi/id di chat (nessun dato di messaggio) |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati del profilo utente (nome, posta elettronica, microsoft Graph l'accesso e i token di aggiornamento) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegato | Per richiedere all'utente i canali a cui condividere il contenuto da un modulo attività nell'applicazione | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | Delegato | Per inviare contenuto condiviso ai canali da un modulo attività nell'applicazione | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | Delegato | Per richiedere all'utente le chat in cui condividere il contenuto da un modulo attività nell'applicazione | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | Delegato | Per inviare contenuto condiviso alle chat da un modulo attività nell'applicazione | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | Delegato | È necessario ottenere i team a cui un utente può accedere per poter accedere ai canali disponibili per l'utente | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | Delegato | Per ottenere informazioni di identificazione e comunicazione sull'utente | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
