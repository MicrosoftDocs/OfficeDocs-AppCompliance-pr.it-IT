---
title: Informazioni sull'applicazione per Brightcove Video Connessione da Brightcove Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Brightcove Video Connessione, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/af7b350c-9e21-49a2-98b8-679327ed31c3" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Brightcove Video Connessione |
| ID | WA200003247 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Brightcove Inc. |
| Sito Web dell'azienda | [https://www.brightcove.com/en/](https://www.brightcove.com/en/) |
| Condizioni per l'utilizzo dell'app | [https://www.brightcove.com/en/terms-and-conditions/](https://www.brightcove.com/en/terms-and-conditions/) |
| Funzionalità di base dell'app | Brightcove Video Connessione supporta le opzioni di collaborazione relative agli asset video e multimediali direttamente all'interno di Microsoft Teams |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://integrations.support.brightcove.com/teams/installat...](https://integrations.support.brightcove.com/teams/installation.html) |
...
Queste informazioni sono state fornite da Brightcove Inc. Informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
