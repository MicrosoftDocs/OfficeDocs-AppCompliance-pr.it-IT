---
title: Informazioni sull'applicazione per Priority Matrix HIPAA di Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Priority Matrix HIPAA, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66547333"
---
# <a name="priority-matrix-hipaa"></a>Matrice di priorità HIPAA
...
* <a href="https://teams.microsoft.com/l/app/2b248bdc-b79d-35eb-ece8-e81c1ba9fcef" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004259" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Matrice di priorità HIPAA |
| ID | WA200004259 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Appfluence Inc |
| Sito Web dell'azienda | [https://appfluence.com](https://appfluence.com) |
| Condizioni per l'utilizzo dell'app | [https://hipaa.prioritymatrix.com/eula](https://hipaa.prioritymatrix.com/eula) |
| Funzionalità di base dell'app | Priority Matrix HIPAA è un software completo per la gestione dei progetti che soddisfa le particolari esigenze di privacy degli uffici medici, degli ospedali, degli assicuratori sanitari e di altre aziende sanitarie e dei loro partner. Priority Matrix si integra in modo approfondito in Outlook e Microsoft Teams, consentendo ai team di assegnare priorità, concentrarsi e lavorare in modo più intelligente senza cambio di contesto. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://appfluence.com/hipaa](https://appfluence.com/hipaa) |
...
Queste informazioni sono state fornite da Appfluence Inc sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Indirizzo di posta elettronica dell'utente e nome/cognome come minimo. Facoltativamente, collaboratori, messaggi di posta elettronica, eventi del calendario. |
...
| URL dell'informativa sulla privacy | https://appfluence.com/gdpr/ |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | social-auth-app-django |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegato | Nella visualizzazione 1-on-1, presentare all'utente gli eventi condivisi con un collaboratore | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| Files.Read.All | Delegato | Nella visualizzazione 1 su 1 presentare all'utente i file condivisi con un collaboratore. Inoltre, facoltativamente, possono archiviare gli allegati nel proprio OneDrive anziché nel sistema. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| Mail.Read | Delegato | Nella visualizzazione 1 su 1 presentare all'utente i messaggi di posta elettronica condivisi con un collaboratore. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| Tasks.Read | Delegato | Nella visualizzazione 1-on-1, presentare all'utente le attività condivise con un collaboratore | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| TeamsActivity.Send | Delegato | Inviare avvisi rilevanti (ad esempio, elementi scaduti, menzioni) al feed attività di Teams di un utente. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| User.Read | Delegato | Accedere all'utente e condividere il messaggio di posta elettronica e il nome/cognome in modo da poterli inviare correttamente. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| User.ReadBasic.All | Delegato | Visualizzare i colleghi dell'utente in modo che sia possibile suggerire ad altri collaboratori di invitare a Matrice di priorità o di assegnare attività. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| email | Delegato | Conoscere l'indirizzo di posta elettronica dell'utente in modo da poterli risolvere nelle comunicazioni. Questo è anche il loro ID nel nostro sistema. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| offline_access | Delegato | Mantenere l'accesso ai dati dell'utente in modo da poter preparare i report mentre l'utente non è connesso. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| openid | Delegato | Accedere all'utente tramite Single Sign-On. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| profile | Delegato | Informazioni sul nome/cognome dell'utente in modo che sia possibile risolverli correttamente. | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
