...
description: Tutte le informazioni di sicurezza e conformità disponibili per DELTAoverC, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64878303"
---
# <a name="deltaoverc"></a>DELTAoverC

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 15 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/01b1eb1e-cb02-4a41-bb8d-6811bc514606" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | DELTAoverC |
| ID | WA200003286 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | DELTAoverC |
| Sito Web dell'azienda | [https://DELTAoverC.into](https://DELTAoverC.into) |
| Condizioni per l'utilizzo dell'app | [https://go.microsoft.com](https://go.microsoft.com) |
| Funzionalità di base dell'app | DELTAoverC è progettato per supportare il cambiamento e la trasformazione dell'organizzazione fornendo ai leader interni dati interattivi a livello di team durante l'iniziativa di modifica, che consente quindi di affrontare in modo efficace le aree di resistenza al cambiamento o basso coinvolgimento. Massimizzare l'engagement: tenere traccia dei punteggi di engagement in tempo reale per garantire che i team prosperano durante l'interruzione. Ridurre i rischi e lo sforzo - Analizzare i dati a livello di personale per anticipare i problemi PRIMA che questi si trasformino in sfide importanti. |
| Sede centrale dell'azienda | Canada |
| Pagina delle informazioni sull'app | [https://DELTAoverC.info/change-application](https://DELTAoverC.info/change-application) |
...
Queste informazioni sono state fornite da DELTAoverC su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Autenticazione a più fattori abilitata per: | DNSManagement |
...
| URL dell'informativa sulla privacy | https://DELTAoverC.info/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Entrambi | Leggere tutti i gruppi | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| Group.ReadWrite.All | Entrambi | Leggere e scrivere tutti i gruppi | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read | Delegato | Accedere e leggere il profilo utente | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read.All | Applicazione | Leggere il profilo completo di tutti gli utenti | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite | Delegato | Accesso in lettura e scrittura al profilo utente | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite.All | Entrambi | Leggere e scrivere tutti i profili completi degli utenti | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
