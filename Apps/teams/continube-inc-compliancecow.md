---
title: Informazioni sull'applicazione per ComplianceCow di ContiNube Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per ComplianceCow, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66249738"
---
# <a name="compliancecow"></a>ComplianceCow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 12 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/be1720d1-f7ae-4f6e-ab02-e6911a51bc92" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004247" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da ContiNube Inc a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | ComplianceCow |
| ID | WA200004247 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | ContiNube Inc |
| Sito Web dell'azienda | [https://compliancecow.com](https://compliancecow.com) |
| Condizioni per l'utilizzo dell'app | [https://compliancecow.com/trust/termsandconditions](https://compliancecow.com/trust/termsandconditions) |
| Funzionalità di base dell'app | Flussi di lavoro minimalisti per Sicurezza GRC e Assurance |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://compliancecow.com/docs#compliancecow-chat-applicati...](https://compliancecow.com/docs#compliancecow-chat-applications) |
...
Queste informazioni sono state fornite da ContiNube Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati di conformità |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati di conformità |
