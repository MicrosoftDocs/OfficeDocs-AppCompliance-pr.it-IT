...
description: Tutte le informazioni di sicurezza e conformità disponibili per Vizito, i relativi criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Teams bot necessita dell'ID utente per avviare una conversazione e per inviare messaggi proattivi a un utente quando un visitatore esegue l'accesso. | tenant_id, ID utente, UPN, nome utente | Teams bot necessita dell'ID utente per avviare una conversazione e per inviare messaggi proattivi a un utente quando un visitatore esegue l'accesso. |
