---
title: Informazioni sull'applicazione per Connessione+ by Reward Gateway
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Connessione+, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/feb4e7cc-eb28-483e-a1ac-31bfead47e92" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002611" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Reward Gateway a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Connessione+ |
| ID | WA200002611 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Gateway di ricompensa |
| Sito Web dell'azienda | [https://www.rewardgateway.com](https://www.rewardgateway.com) |
| Condizioni per l'utilizzo dell'app | [https://policies.rewardgateway.net/ms-teams-connect-plus/te...](https://policies.rewardgateway.net/ms-teams-connect-plus/terms-of-use/) |
| Funzionalità di base dell'app | Possibilità per i clienti di condividere il riconoscimento peer-to-peer e di ricevere il riconoscimento condiviso a livello globale. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://success.rewardgateway.com/hc/en-us/articles/3600158...](https://success.rewardgateway.com/hc/en-us/articles/360015834078-Installing-the-MS-Teams-Integration) |
...
Queste informazioni sono state fornite da Reward Gateway su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegato | Nessun dato raccolto | [5e4dadf5-9f90-449b-9e39-934fd10b7c23](../azure/5e4dadf5-9f90-449b-9e39-934fd10b7c23.md) |
