...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Chat.Read | delegated | Ottenere i membri della chat in modo da poter chiamare l'altro membro in una chat privata con Cisco WebEx | L'app NON archivierebbe dati nei relativi database | [9a7ce614-bdc8-4640-aaea-d8c626c58966](https://docs.microsoft.com/microsoft-365-app-certification/azure/9a7ce614-bdc8-4640-aaea-d8c626c58966) |
