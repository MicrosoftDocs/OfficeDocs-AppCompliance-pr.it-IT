---
title: Informazioni sull'applicazione per Mentimeter by Mentimeter
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Mentimeter, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6aa4a751-8a6a-429e-b924-1360ed272414" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Mentimeter |
| ID | WA200002972 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Mentimeter |
| Sito Web dell'azienda | [https://www.mentimeter.com](https://www.mentimeter.com) |
| Condizioni per l'utilizzo dell'app | [https://www.mentimeter.com/terms](https://www.mentimeter.com/terms) |
| Funzionalità di base dell'app | Coinvolgere i partecipanti con sondaggi, quiz, word cloud, domande&amp; e altro ancora per acquisire input in tempo reale.  |
| Sede centrale dell'azienda | Svezia |
| Pagina delle informazioni sull'app | [https://www.mentimeter.com/features](https://www.mentimeter.com/features) |
...
Queste informazioni sono state fornite da Mentimeter sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
