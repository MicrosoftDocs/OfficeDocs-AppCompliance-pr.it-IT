---
title: Informazioni sull'applicazione per Spatial Standup by High Fidelity Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Spatial Standup, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/52f9c87d-262c-4e33-b5b6-fc84b35df529" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Spatial Standup |
| ID | WA200003161 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | High Fidelity Inc |
| Sito Web dell'azienda | [https://www.highfidelity.com](https://www.highfidelity.com) |
| Condizioni per l'utilizzo dell'app | [https://www.highfidelity.com/terms-of-service](https://www.highfidelity.com/terms-of-service) |
| Funzionalità di base dell'app | Audio spaziale, video e condivisione dello schermo per le riunioni standup |
...
Queste informazioni sono state fornite da High Fidelity Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
