...
description: Tutte le informazioni di sicurezza e conformità disponibili per Workbench Intelligence, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64879593"
---
# <a name="workbench-intelligence"></a>Workbench Intelligence

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 22 settembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/d5630318-189a-4912-abae-99b1f8f82cce" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Workbench Intelligence |
| ID | WA200002705 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Temporall |
| Sito Web dell'azienda | [https://www.temporall.com](https://www.temporall.com) |
| Condizioni per l'utilizzo dell'app | [https://www.temporall.com/eula](https://www.temporall.com/eula) |
| Funzionalità di base dell'app | Workbench Intelligence offre informazioni dettagliate in tempo reale che consentono di prendere decisioni più rapide e migliori. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.temporall.com/teams_intelligence/](https://www.temporall.com/teams_intelligence/) |
...
Queste informazioni sono state fornite da Temporall sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegato | Ottiene un elenco di app di teams installate per ottenere l'ID dell'app locale per l'ID esterno noto. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Channel.ReadBasic.All | Applicazione | Nome id &amp; canale. Giustificazione: consentire l'aggiunta o l'uscita dal canale per sincronizzare l'attività del messaggio.  | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| ChannelMessage.Read.All | Applicazione | Tipo di attività &amp; del messaggio, insieme alla destinazione del mittente &amp; . Dati ricevuti da queste route: /teams/${teamId}/channels/${channelId}/messages /teams/${teamId}/channels/${channelId}/messages/${messageId}. Giustificazione: per poter calcolare il report delle &amp; metriche sull'attività dei messaggi. Questo è il nucleo del modulo di analisi della rete organizzativa per poter disegnare un diagramma di attività tra i team di utenti &amp; . | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Directory.Read.All | Applicazione | ClientId, Elenco di utenti, elenco di organizzazioni e canali secondari. Giustificazione: necessario per leggere &amp; gli utenti di sincronizzazione con Temporall Workbench | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Group.ReadWrite.All | Applicazione | Nome id &amp; gruppo. Giustificazione: per installare l'app in ogni gruppo/canale | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamMember.Read.All | Applicazione | Appartenenza utente al team. Giustificazione: consente la sincronizzazione di tutti gli utenti in Teams con a Temporall Workbench | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | Applicazione | Leggere l'elenco delle app installate per Team. Giustificazione: controllare se l'app è già installata in caso contrario installarla per poter ottenere l'attività dei messaggi tramite l'API Graph | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | Applicazione | Leggere l'elenco delle app installate. Controllare se l'app è già installata in caso contrario installarla per interagire con l'utente tramite un questionario | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| User.Read | Delegato | Informazioni di base sulla società utente &amp; . Giustificazione: usato per classificare l'attività dei messaggi da parte dell'utente, consente al bot di partecipare alla messaggistica proattiva. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
