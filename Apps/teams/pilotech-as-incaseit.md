...
description: Tutte le informazioni di sicurezza e conformità disponibili per InCaseIT, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64875383"
---
# <a name="incaseit"></a>InCaseIT

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 3 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | InCaseIT |
| ID | WA200003265 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Pilotech AS |
| Sito Web dell'azienda | [https://incaseit.com](https://incaseit.com) |
| Condizioni per l'utilizzo dell'app | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
...
| Pagina delle informazioni sull'app | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
Queste informazioni sono state fornite da Pilotech AS su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegato | Gli unici dati usati sono la conferma esplicita da parte degli utenti di consentire all'applicazione di usare un token di accesso per chiamare il API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | Delegato | Gli unici dati usati sono la conferma esplicita da parte degli utenti di consentire all'applicazione di usare un token di accesso per chiamare il API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | Delegato | Gli unici dati usati sono la conferma esplicita da parte degli utenti di consentire all'applicazione di usare un token di accesso per chiamare il API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
