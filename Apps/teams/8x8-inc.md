...
description: Tutte le informazioni di sicurezza e conformità disponibili per 8x8, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 10 giugno 2021</p>

* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002665" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da 8x8, Inc a Microsoft:
...
| Nome della società partner | 8x8, Inc |
| Sito Web dell'azienda | [https://www.8x8.com](https://www.8x8.com) |
| Condizioni per l'utilizzo dell'app | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| Funzionalità di base dell'app | 8x8 Voice è un servizio di routing diretto basato sul cloud per effettuare/ricevere chiamate PSTN. Un'esperienza nativa con funzionalità di telefonia e contact center di livello aziendale. Piani di chiamata illimitati in 47 paesi + servizio di sostituzione PSTN in 43 paesi, Analisi, SMS, MMS e Fax. Ottenere piani di chiamata economici a livello locale o internazionale ed estendere le chiamate PSTN ai paesi in cui Microsoft non&#8217;ancora offrire piani, per ottenere il massimo da Microsoft 365. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | AWS, OracleCloud |
...
Queste informazioni sono state fornite da 8x8, Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
