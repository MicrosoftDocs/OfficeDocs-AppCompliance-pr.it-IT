---
title: Informazioni sull'applicazione per Stack Overflow per Teams da Stack Overflow
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Stack Overflow per Teams, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656157"
---
# <a name="stack-overflow-for-teams"></a>Stack Overflow for Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 11 ottobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000739" target="_blank">Visualizzazione in AppSource</a>
...
| Sito Web dell'azienda | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| Condizioni per l'utilizzo dell'app | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| Funzionalità di base dell'app | Stack Overflow for Teams è una casa privata e sicura per il team&#8217;domande e risposte. Non più scavare attraverso wiki obsoleti e messaggi di posta elettronica persi&#8212;dare al team indietro il tempo necessario per creare prodotti migliori. Stack Overflow for Teams&#8217; integrazione con Microsoft Teams connette la chat di Microsoft Teams e il repository di conoscenze interno. Resta aggiornato con le notifiche delle nuove informazioni, cerca le risposte esistenti e avvia la tua domanda direttamente dalla piattaforma Microsoft Teams. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
Queste informazioni sono state fornite da Stack Overflow sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Le informazioni di MS Teams vengono raccolte ed elaborate dall'app per essere visualizzate e fanno riferimento all'interno dell'ambiente Stack Overflow for Teams di un cliente. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Informazioni sull'accesso all'API di MICROSOFT Teams |
...
| URL dell'informativa sulla privacy | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |
