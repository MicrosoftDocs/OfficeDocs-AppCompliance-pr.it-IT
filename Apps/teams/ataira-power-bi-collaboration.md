...
* <a href="https://teams.microsoft.com/l/app/90381cb0-998f-4ba3-9699-130201de5ddb" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Opzioni di collaborazione di Power BI |
| ID | WA104381384 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Ataira |
| Sito Web dell'azienda | [https://www.ataira.com](https://www.ataira.com) |
| Condizioni per l'utilizzo dell'app | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| Funzionalità di base dell'app | Il componente aggiuntivo Ataira consente di visualizzare i dashboard e i report Power BI. Inviare notifiche ai gruppi e ai team aziendali, aggiungere azioni di completamento, incorporare Power BI collegamenti pubblici, aggiungere commenti ai punti dati nei report e aggiungere file di dati come origini dati ai report di Power BI e aggiornarlo in tempo reale. Consentire al team di business intelligence di collaborare più strettamente alle attività di business intelligence in un'unica posizione. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.ataira.com/Microsoft/PowerBI/Collaboration](https://www.ataira.com/Microsoft/PowerBI/Collaboration) |
...
Queste informazioni sono state fornite da Ataira sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Elencare i tipi di criteri supportati | Autenticazione a più fattori Consente solo ai dispositivi registrati Intune di accedere a servizi specifici Limitazione delle posizioni utente e degli intervalli IP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Autorizzazioni anche per ChannelMessage.Send Team.ReadBasic.All User.Read. Questi vengono usati per consentire all'utente di selezionare il gruppo di Teams e il canale per le notifiche | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |
