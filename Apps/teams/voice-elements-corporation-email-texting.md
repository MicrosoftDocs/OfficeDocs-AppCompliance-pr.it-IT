---
title: Informazioni sull'applicazione per l'invio di sms tramite posta elettronica da Voice Elements Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni disponibili sulla sicurezza e sulla conformità per l'invio di sms tramite posta elettronica, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64877053"
---
# <a name="email-texting"></a>email-texting

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 28 luglio 2021</p>

* <a href="https://teams.microsoft.com/l/app/f76a92ed-2c10-4e37-ac84-f2474958d933" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | email-texting |
| ID | WA200003086 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Voice Elements Corporation |
| Sito Web dell'azienda | [https://www.email-texting.com](https://www.email-texting.com) |
| Condizioni per l'utilizzo dell'app | [https://www.email-texting.com/terms-of-use](https://www.email-texting.com/terms-of-use) |
| Funzionalità di base dell'app | Abilitare l'invio di sms sul telefono aziendale - Ricevere e inviare sms usando il messaggio di posta elettronica |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.email-texting.com](https://www.email-texting.com) |
...
Queste informazioni sono state fornite da Voice Elements Corporation sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Necessario per l'accesso SSO da Teams | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |
>| email | Delegato | Necessario per l'accesso SSO da Teams | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |
>| openid | Delegato | Necessario per l'accesso SSO da Teams | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |
>| profile | Delegato | Necessario per l'accesso SSO da Teams | [806359be-da23-4538-80bb-baa82107ec2d](../azure/806359be-da23-4538-80bb-baa82107ec2d.md) |
