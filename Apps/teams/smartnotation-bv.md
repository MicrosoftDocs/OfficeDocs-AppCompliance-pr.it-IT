...
description: Tutte le informazioni di sicurezza e conformità disponibili per Smartnotation, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64876243"
---
# <a name="smartnotation"></a>Smartnotation

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 9 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Smartnotation B.V. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Smartnotation |
| ID | WA200000681 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Smartnotation B.V. |
| Sito Web dell'azienda | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| Condizioni per l'utilizzo dell'app | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| Funzionalità di base dell'app | Smartnotation è una soluzione di minuti di riunione facile da usare e abilitata per la voce. Le note, le azioni e le decisioni sono facili da gestire e le informazioni sono sempre disponibili. Soprattutto, elimina il sovraccarico non necessario consentendo a te e al tuo team di concentrarti sul tuo core business. È possibile integrare completamente Smartnotation con MS Teams. Aggiungere un connettore per ricevere una notifica di tutti gli aggiornamenti importanti, le nuove note, le azioni e le decisioni per un progetto specifico, configurare una scheda o usare smartnotation direttamente. |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | Totaaldomein B.V. |
...
Queste informazioni sono state fornite da Smartnotation B.V. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
