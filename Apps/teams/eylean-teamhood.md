---
title: Informazioni sull'applicazione per Teamhood di Eylean
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Teamhood, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/22372c30-c5de-483e-85b4-8d51db246eda" target="_blank">Visualizza in Teams store</a>
...
Informazioni fornite da Eylean a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Teamhood |
| ID | WA200002568 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Eylean |
| Sito Web dell'azienda | [https://teamhood.com](https://teamhood.com) |
| Condizioni per l'utilizzo dell'app | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| Funzionalità di base dell'app | Teamhood è un software all-in-one per la gestione di progetti e attività per una collaborazione quotidiana efficiente. Teamhood offre funzionalità necessarie per ogni project manager e membro del team per pianificare, eseguire e creare report sui dati di lavoro. |
| Sede centrale dell'azienda | Lituania |
| Pagina delle informazioni sull'app | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
...
Queste informazioni sono state fornite da Eylean sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
