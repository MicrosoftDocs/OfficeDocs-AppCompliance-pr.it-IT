---
title: Informazioni sull'applicazione per Ask Vizir by Vizir.co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/25/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Ask Vizir, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65069694"
---
# <a name="ask-vizir"></a>Ask Vizir

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 22 aprile 2022</p>

* <a href="https://teams.microsoft.com/l/app/7b0641d9-8e1f-4415-99da-c80f8c175c69" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003119" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Vizir.co a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Ask Vizir |
| ID | WA200003119 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Vizir.co |
| Sito Web dell'azienda | [https://www.vizir.co](https://www.vizir.co) |
| Condizioni per l'utilizzo dell'app | [https://vizir.co/mentions-legales](https://vizir.co/mentions-legales) |
| Funzionalità di base dell'app | Il bot Ask Vizir consente agli utenti di teams in Francia di usare prodotti Microsoft Office 365. Realizzato in collaborazione con Microsoft France |
| Sede centrale dell'azienda | Francia |
| Pagina delle informazioni sull'app | [https://www.vizir.co](https://www.vizir.co) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? | Paas |
| Quali provider di servizi cloud di hosting usano l'app? | OVH, Aws |
...
Queste informazioni sono state fornite da Vizir.co su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | indirizzo di posta elettronica utente, nome, cognome |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | indirizzo di posta elettronica utente, nome, cognome |
...
| URL dell'informativa sulla privacy | https://www.vizir.co/politique-confidentialite/ |
