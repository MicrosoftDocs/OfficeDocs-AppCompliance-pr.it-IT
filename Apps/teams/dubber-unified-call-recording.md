...
ms.locfileid: "61406929"
---
# <a name="dubber-unified-call-recording"></a>Registrazione delle chiamate unificate di dubber

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 3, 2021</p>

* <a href="https://teams.microsoft.com/l/app/f31b8e05-b927-4874-851e-997264d13151" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003570" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Dubber a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Registrazione delle chiamate unificate di dubber |
| ID | WA200003570 |
...
Queste informazioni sono state fornite da Dubber su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Nome del cliente e ID Microsoft, dati di registrazione/riunione delle chiamate |
