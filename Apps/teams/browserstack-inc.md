---
title: Informazioni sull'applicazione per BrowserStack di BrowserStack Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per BrowserStack, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/180f19aa-1b79-4b4a-b716-068b81cfb145" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004404" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da BrowserStack Inc a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | BrowserStack |
| ID | WA200004404 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | BrowserStack Inc |
| Sito Web dell'azienda | [https://www.browserstack.com](https://www.browserstack.com) |
| Condizioni per l'utilizzo dell'app | [https://www.browserstack.com/terms](https://www.browserstack.com/terms) |
| Funzionalità di base dell'app | Portare le informazioni dettagliate di BrowserStack direttamente in Microsoft Teams. |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://www.browserstack.com/docs/automate/selenium/microso...](https://www.browserstack.com/docs/automate/selenium/microsoft-teams) |
...
Queste informazioni sono state fornite da BrowserStack Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2021-06-14 |
...
| URL dell'informativa sulla privacy | https://www.browserstack.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Accedere e leggere il profilo utente a scopo di autenticazione | [180f19aa-1b79-4b4a-b716-068b81cfb145](../azure/180f19aa-1b79-4b4a-b716-068b81cfb145.md) |
