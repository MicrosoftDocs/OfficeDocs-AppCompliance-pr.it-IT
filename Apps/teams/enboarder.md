---
title: Informazioni sull'applicazione per Enboarder di Enboarder
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Enboarder, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f6b1f54a-3e72-404f-9085-1d77c4151be0" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Enboarder |
| ID | WA200001980 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Enboarder |
| Sito Web dell'azienda | [https://enboarder.com](https://enboarder.com) |
| Condizioni per l'utilizzo dell'app | [https://enboarder.com/terms/](https://enboarder.com/terms/) |
| Funzionalità di base dell'app | Enboarder è la piattaforma leader Experience-Driven onboarding, cambiando le esperienze di onboarding. |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://enboarder.com/why-enboarder/](https://enboarder.com/why-enboarder/) |
...
Queste informazioni sono state fornite da Enboarder su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
