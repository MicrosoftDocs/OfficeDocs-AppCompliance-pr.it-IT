---
title: Informazioni sull'applicazione per HelloTeam di HelloTeam Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/10/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per HelloTeam, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 10 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/58426e2f-12cd-4b86-bae3-37feb09bf146" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003448" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da HelloTeam Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | HelloTeam |
| ID | WA200003448 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | HelloTeam Inc. |
| Sito Web dell'azienda | [https://www.helloteam.com](https://www.helloteam.com) |
| Condizioni per l'utilizzo dell'app | [https://www.helloteam.com/index.php/terms-and-conditions/](https://www.helloteam.com/index.php/terms-and-conditions/) |
| Funzionalità di base dell'app | Piattaforma all-in-one per il successo delle persone per la forza lavoro moderna |
...
Queste informazioni sono state fornite da HelloTeam Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
