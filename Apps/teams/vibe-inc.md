---
title: Informazioni sull'applicazione per Vibe di Vibe Inc
ms.author: elmalova
author: elenamalova
ms.date: 01/20/2022
ms.topic: article
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Vibe, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f6179d94-de34-4c1b-9303-519fdf048c7e" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001721" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Vibe Inc a Microsoft:
...
| Nome società partner | Vibe Inc |
| Sito Web aziendale | [https://vibe.us](https://vibe.us) |
| Condizioni per l'uso dell'app | [https://vibe.us/term/](https://vibe.us/term/) |
| Funzionalità di base dell'app | Collaborazione in tempo reale su un canvas illimitato con facile accesso ai OneDrive file. |
...
Queste informazioni sono state fornite da Vibe Inc su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Nome visualizzato, indirizzo di posta elettronica e immagine del profilo del cliente |
...
| URL dell'informativa sulla privacy | https://vibe.us/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | Ottenere le informazioni di identità di base dell'utente, ad esempio nome, posta elettronica, immagine del profilo. | [71a7c2ef-6e5f-4d3d-8665-119a2bef0035](https://docs.microsoft.com/microsoft-365-app-certification/azure/71a7c2ef-6e5f-4d3d-8665-119a2bef0035) |
