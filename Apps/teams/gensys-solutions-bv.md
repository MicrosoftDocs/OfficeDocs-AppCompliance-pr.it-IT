...
description: Tutte le informazioni di sicurezza e conformità disponibili per Gensys, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bc1e8e2d-bb5c-47d7-a9e6-f0be9eb83c5a" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Gensys |
| ID | WA200003044 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Gensys Solutions BV |
| Sito Web dell'azienda | [https://gensys.nl](https://gensys.nl) |
| Condizioni per l'utilizzo dell'app | [https://gensys.nl/terms-of-use/](https://gensys.nl/terms-of-use/) |
| Funzionalità di base dell'app | App Gensys per l'integrazione di Gensys Anywhere con Microsoft Teams |
...
Queste informazioni sono state fornite da Gensys Solutions BV su come questa app raccoglie e archivia i dati aziendali e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
