...
description: Tutte le informazioni di sicurezza e conformità disponibili per SuperBeings, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880213"
---
# <a name="superbeings"></a>SuperBeings

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 3 settembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/1e7931be-a76f-4b12-b1b3-8914c7860aec" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | SuperBeings |
| ID | WA200003246 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | JiJi Technologies Pvt Ltd |
| Sito Web dell'azienda | [https://www.superbeings.ai](https://www.superbeings.ai) |
| Condizioni per l'utilizzo dell'app | [https://www.superbeings.ai/terms-of-use](https://www.superbeings.ai/terms-of-use) |
| Funzionalità di base dell'app | Consenti ai tuoi leader di usare strumenti,apprendimento/approfondimenti per potenziare continuamente i loro team. |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://www.superbeings.ai](https://www.superbeings.ai) |
...
Queste informazioni sono state fornite da Haptivity Technologies Pvt Ltd su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
