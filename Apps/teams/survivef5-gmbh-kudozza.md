...
description: Tutte le informazioni di sicurezza e conformità disponibili per Kudozza, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880885"
---
# <a name="kudozza"></a>Kudozza

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 2 febbraio 2022</p>

* <a href="https://teams.microsoft.com/l/app/61a58a9f-3474-4d14-bda6-6547194a7381" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002599" target="_blank">Visualizzazione in AppSource</a>
...
| Sito Web dell'azienda | [https://surviveF5.com](https://surviveF5.com) |
| Condizioni per l'utilizzo dell'app | [https://kudozza.com/terms](https://kudozza.com/terms) |
| Funzionalità di base dell'app | Kudozza permette di dare Kudos ad altri membri del team per mostrare loro il tuo apprezzamento. Offre vari strumenti come le partecipazione alle emoji, le categorie o le classifiche per motivare la donazione di Kudos. |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni sull'app | [https://kudozza.com](https://kudozza.com) |
...
Queste informazioni sono state fornite da surviveF5 GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati profilo utente, dati del messaggio (in ingresso nel bot) |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | userid, teamid, teamname, username, tenantid, messageid, messagetext |
...
| URL dell'informativa sulla privacy | https://www.kudozza.com/privacy/ |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | MSAL, ma è comunque necessario eseguire l'aggiornamento alla versione più recente per Teams |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegato | Lettura dei canali di un team per dare all'utente la possibilità di selezionare un canale in cui vuole pubblicare i complimenti | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| Teams. ReadBasic.All | Delegato | L'utente può selezionare un team e un canale in cui vuole pubblicare i complimenti. Le autorizzazioni di lettura del team sono necessarie per la lettura dei team. | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.Read | Delegato | Ottenere i team di cui un utente fa parte | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.ReadBasic.All | Delegato | Leggere il nome utente | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
