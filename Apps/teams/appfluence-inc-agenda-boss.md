...
description: Tutte le informazioni di sicurezza e conformità disponibili per Agenda Boss, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64881013"
---
# <a name="agenda-boss"></a>Agenda Boss

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 16 maggio 2021</p>

* <a href="https://teams.microsoft.com/l/app/ae645efa-0e64-47d9-91e4-b693a99f7f87" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Agenda Boss |
| ID | WA200002607 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Appfluence Inc |
| Sito Web dell'azienda | [https://agendaboss.com](https://agendaboss.com) |
| Condizioni per l'utilizzo dell'app | [https://agendaboss.com/eula](https://agendaboss.com/eula) |
| Funzionalità di base dell'app | Raggruppare tutte le attività e gli eventi del calendario e aggregarli in un semplice elenco lineare. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://agendaboss.com/about](https://agendaboss.com/about) |
