---
title: Informazioni sull'applicazione per SHL di SHL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SHL, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0c52adc0-18a0-45ca-b6ee-154cf1ef87e2" target="_blank">Visualizza in Teams store</a>
...
| Nome della società partner | SHL |
| Sito Web dell'azienda | [https://shl.com](https://shl.com) |
| Condizioni per l'utilizzo dell'app | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| Funzionalità di base dell'app | SHL è il leader globale nella tecnologia delle risorse umane e nella scienza psicometrica che porta a informazioni approfondite sulle persone, aiutando le aziende a creare potenti soluzioni per la forza lavoro che guidano i risultati aziendali. SHL offre tecnologia di IA potente e trasparente, data science e oggettività per aiutare le aziende ad attirare, sviluppare e far crescere la forza lavoro di cui hanno bisogno per avere successo nell'era digitale. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
...
Queste informazioni sono state fornite da SHL su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | Delegato | Slot calander condivisi disponibili | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |
