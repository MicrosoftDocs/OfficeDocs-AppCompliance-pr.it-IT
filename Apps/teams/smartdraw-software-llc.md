---
title: Informazioni sull'applicazione per SmartDraw di SmartDraw Software, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SmartDraw, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b1879f1f-dba8-49d6-81a1-21ec15e4f94b" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003505" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da SmartDraw Software, LLC a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | SmartDraw |
| ID | WA200003505 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SmartDraw Software, LLC |
| Sito Web dell'azienda | [https://www.smartdraw.com](https://www.smartdraw.com) |
| Condizioni per l'utilizzo dell'app | [https://www.smartdraw.com/support/terms-of-service.pdf](https://www.smartdraw.com/support/terms-of-service.pdf) |
| Funzionalità di base dell'app | Strumento semplice &amp; e potente per creare diagrammi di flusso, UML, ERD, diagrammi tecnici e altro ancora. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.smartdraw.com/features](https://www.smartdraw.com/features) |
...
Queste informazioni sono state fornite da SmartDraw Software, LLC su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | sso auth meta data, token oauth  |
...
| Data di certificazione SOC2 più recente | 2020-11-30 |
