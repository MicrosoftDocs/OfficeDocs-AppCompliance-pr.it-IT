...
description: Tutte le informazioni di sicurezza e conformità disponibili per Smartsheet, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
| Sito Web dell'azienda | [https://www.smartsheet.com](https://www.smartsheet.com) |
| Condizioni per l'utilizzo dell'app | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474843641/Product_42949680935/Asset_06f25ae6-b277-42aa-b769-38e17926ebb4/SmartsheetUserAgreementSmartsh.pdf) |
| Funzionalità di base dell'app | Smartsheet è una piattaforma leader basata sul cloud per i risultati dell'organizzazione, che consente a team e organizzazioni di pianificare, acquisire, gestire, automatizzare e creare report sul lavoro su larga scala, ottenendo processi più efficaci e risultati aziendali migliori. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://help.smartsheet.com/articles/2476201-interact-with-...](https://help.smartsheet.com/articles/2476201-interact-with-smartsheet-items-in-microsoft-teams) |
...
Queste informazioni sono state fornite da Smartsheet sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2021-12-06 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2021-12-06 |
...
| URL dell'informativa sulla privacy | https://www.smartsheet.com/legal/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | Applicazione | Per consentire all'applicazione Smartsheet Tabs di leggere i membri del canale per condividere gli asset di Smartsheet. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Directory.Read.All | Delegato | Per consentire all'app di leggere i dati nell'organizzazione, ad esempio utenti e gruppi. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.Read.All | Delegato | Viene usato per leggere i membri del gruppo. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.ReadWrite.All | Delegato | Per inviare notifiche a un gruppo. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| User.Read.All | Delegato | Viene usato per inviare notifiche in base all'indirizzo di posta elettronica dell'utente. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| offline_access | Delegato | Per consentire l'uso offline. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
