---
title: Informazioni sull'applicazione per SurveyMoodbit di Moodbit
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Tutte le informazioni disponibili sulla sicurezza e sulla conformità per SurveyMoodbit, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/86425243-0129-41f7-bf74-971bee7ff3d3" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003925" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Moodbit a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | SurveyMoodbit |
| ID | WA200003925 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Moodbit |
| Sito Web dell'azienda | [https://mymoodbit.com](https://mymoodbit.com) |
| Condizioni per l'utilizzo dell'app | [https://mymoodbit.com/terms](https://mymoodbit.com/terms) |
| Funzionalità di base dell'app | Ottenere rapidamente commenti e suggerimenti &amp; per sfruttare People Analytics direttamente all'interno di Microsoft Teams |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://mymoodbit.com](https://mymoodbit.com) |
...
Queste informazioni sono state fornite da Moodbit su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://mymoodbit.com/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Per ottenere informazioni dall'utente per visualizzarle nell'app dell'interfaccia utente e fornire un'esperienza utente personalizzata | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| email | Delegato | Autenticazione msal | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| openid | Delegato | Autenticazione msal | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| profile | Delegato | Autenticazione msal | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
