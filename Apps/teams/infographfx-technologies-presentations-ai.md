---
title: Informazioni sull'applicazione per presentazioni per l'intelligenza artificiale delle tecnologie Infographfx
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Presentazioni per intelligenza artificiale, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1f510555-b518-4084-84e0-18c7bebc807c" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001352" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite dalle tecnologie Infographfx a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Presentazioni AI |
| ID | WA200001352 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Tecnologie Infographfx |
| Sito Web dell'azienda | [https://presentations.ai](https://presentations.ai) |
| Condizioni per l'utilizzo dell'app | [https://presentations.ai/terms_teams.html](https://presentations.ai/terms_teams.html) |
| Funzionalità di base dell'app | Presentations.AI è uno strumento intelligente con le migliori procedure di progettazione per creare presentazioni straordinarie. |
...
Queste informazioni sono state fornite dalle tecnologie Infographfx su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Per quanto tempo vengono conservati i dati dopo la chiusura dell'account? | Eliminato entro 3 mesi |
