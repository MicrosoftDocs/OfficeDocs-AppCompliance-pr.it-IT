...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Digiplein, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9a58f891-dad9-4c01-bf1a-3c418fb6b282" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Digiplein |
| ID | WA200003298 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Educatieve Uitgeversgroep B.V. |
| Sito Web dell'azienda | [https://www.uitgeversgroep.nl](https://www.uitgeversgroep.nl) |
| Condizioni per l'utilizzo dell'app | [https://www.uitgeversgroep.nl/voorwaarden](https://www.uitgeversgroep.nl/voorwaarden) |
| Funzionalità di base dell'app | Online leeromgeving van de Uitgeversgroep |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://www.uitgeversgroep.nl/digiplein](https://www.uitgeversgroep.nl/digiplein) |
...
Queste informazioni sono state fornite da Educatieve Uitgeversgroep B.V. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
