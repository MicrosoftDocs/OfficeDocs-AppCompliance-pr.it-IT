---
title: Informazioni sull'applicazione per DoctorOnline di NLSQL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per DoctorOnline, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f9555238-64f3-4ec2-a8fc-3787baa157aa" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004082" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da NLSQL a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | DoctorOnline |
| ID | WA200004082 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | NLSQL |
| Sito Web dell'azienda | [https://nlsql.com](https://nlsql.com) |
| Condizioni per l'utilizzo dell'app | [https://doctoronline.bsmu.edu.ua/terms](https://doctoronline.bsmu.edu.ua/terms) |
| Funzionalità di base dell'app | Prenota un supporto online gratuito per il settore sanitario. Più di 500 medici ucraini autorizzati con diverse categorie. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://doctoronline.bsmu.edu.ua](https://doctoronline.bsmu.edu.ua) |
...
Queste informazioni sono state fornite da NLSQL sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Accedere e leggere il profilo utente | [f9555238-64f3-4ec2-a8fc-3787baa157a](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |
