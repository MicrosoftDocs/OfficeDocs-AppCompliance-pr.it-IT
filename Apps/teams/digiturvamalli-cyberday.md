...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | delegated | Usare la posta elettronica per identificare l'utente e la visualizzazione per gli amministratori dell'app che sono questo utente | Posta elettronica, Teams ID utente | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |
>| openid | delegated | Usare l'ID utente per identificare l'utente | Posta elettronica, Teams ID utente | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| Heroku (Salesforce Inc.) | Teams'ID tenant e Teams del tenant | L'elaborazione di queste informazioni è necessaria per le prestazioni di un contratto in base alle condizioni per l'uso. L'ID tenant e il dominio vengono utilizzati per connettere gli utenti di Cyberday agli account dell'organizzazione corretti (ad esempio, visualizzare linee guida di sicurezza corrette). |
