---
title: Informazioni sull'applicazione per Cyberday di Digiturvamalli
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Cyberday, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a8e43ae4-a97b-4d1a-b364-b27794da19a4" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Cyberday |
| ID | WA200001774 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Digiturvamalli |
| Sito Web dell'azienda | [https://cyberday.ai](https://cyberday.ai) |
| Condizioni per l'utilizzo dell'app | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| Funzionalità di base dell'app | Cyberday è un sistema di gestione della sicurezza delle informazioni che guida il cliente verso la conformità ai framework di sicurezza selezionati. |
| Sede centrale dell'azienda | Finlandia |
| Pagina delle informazioni sull'app | [https://cyberday.ai](https://cyberday.ai) |
...
Queste informazioni sono state fornite da Digiturvamalli sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Usare la posta elettronica per identificare l'utente e la visualizzazione per gli amministratori dell'app che l'utente è | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
>| openid | Delegato | Usare l'ID utente per identificare l'utente | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
