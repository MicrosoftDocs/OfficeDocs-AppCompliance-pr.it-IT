---
title: Informazioni sull'applicazione per Kami di Kami
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Kami, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65874293"
---
# <a name="kami"></a>Kami

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 28 marzo 2022</p>

* <a href="https://teams.microsoft.com/l/app/95b82c84-8994-45f6-946a-dda105f9d5df" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004148" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Kami a Microsoft:
...
| Nome della società partner | Kami |
| Sito Web dell'azienda | [https://kamiapp.com](https://kamiapp.com) |
| Condizioni per l'utilizzo dell'app | [https://kamiapp.com/terms-of-service/](https://kamiapp.com/terms-of-service/) |
| Funzionalità di base dell'app | Consenti a tutti di amare l'apprendimento con Kami &#8211; ora per Microsoft Teams. |
...
Queste informazioni sono state fornite da Kami su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Profilo utente (nome, posta elettronica). OneDrive file e metadati. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati del profilo utente (nome, indirizzo di posta elettronica, ID). OneDrive metadati del file (nome file, ID elemento, ID unità). Annotazioni del documento. |
...
| URL dell'informativa sulla privacy | https://www.kamiapp.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Delegato | Per consentire all'utente di aprire, aggiornare ed esportare file OneDrive e SharePoint in Kami. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
>| User.Read | Delegato | Per accedere ai dati del profilo utente per popolare il profilo Kami, ad esempio: posta elettronica e nome. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
