---
title: Application Information for Humu di Humu Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/01/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Humu, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64879333"
---
# <a name="humu"></a>Humu

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 20 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/7fbbb34f-a0fa-471b-9c2a-abc15daad3cb" target="_blank">Visualizza in Teams store</a>
...
| Nome della società partner | Humu Inc. |
| Sito Web dell'azienda | [https://www.humu.com](https://www.humu.com) |
| Condizioni per l'utilizzo dell'app | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| Funzionalità di base dell'app | Humu è una piattaforma di gestione delle azioni che semplifica il miglioramento delle organizzazioni, ogni singola settimana. Humu traduce le strategie aziendali in azioni personali rilevanti per ogni persona all'interno di un'organizzazione. Il nostro obiettivo principale è promuovere il miglioramento dell'organizzazione su larga scala, che crea forza lavoro più produttiva, collaborativa, innovativa e inclusiva. Humu rende il lavoro migliore rendendo il cambiamento più facile. |
...
Queste informazioni sono state fornite da Humu Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-10-21 |
