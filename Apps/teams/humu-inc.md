...
description: Tutte le informazioni di sicurezza e conformità disponibili per Humu, i criteri di gestione dei dati, le informazioni sul catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://www.humu.com](https://www.humu.com) |
| Condizioni per l'uso dell'app | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| Funzionalità di base dell'app | Humu è una piattaforma di gestione delle azioni che consente alle organizzazioni di migliorare facilmente ogni singola settimana. Humu traduce le strategie aziendali in azioni pertinenti per ogni persona all'interno di un'organizzazione. Il nostro obiettivo principale è guidare il miglioramento dell'organizzazione, su larga scala, che crea forza lavoro più produttiva, collaborativa, innovativa e inclusiva. Humu migliora il lavoro semplificando il cambiamento. |
