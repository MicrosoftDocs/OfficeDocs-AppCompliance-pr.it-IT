---
title: Informazioni sull'applicazione per IdeaScale di IdeaScale
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per IdeaScale, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a4de8de4-33b1-4e55-97ac-9f87b5978c0f" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003868" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da IdeaScale a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | IdeaScale |
| ID | WA200003868 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | IdeaScale |
| Sito Web aziendale | [https://ideascale.com](https://ideascale.com) |
| Condizioni per l'uso dell'app | [https://ideascale.com/terms-and-conditions-of-use](https://ideascale.com/terms-and-conditions-of-use) |
| Funzionalità di base dell'app | IdeaScale è la piattaforma di gestione delle idee leader per i team di innovazione. Tutti gli utenti dell'organizzazione possono condividere idee visibili agli altri utenti della community e raccogliere feedback e risorse per trasformare tali idee in nuovi prodotti o progetti. Ora puoi connettere la community di IdeaScale alla tua Microsoft Teams di lavoro per gestire le idee senza lasciare Teams. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://ideascale.com/teams/](https://ideascale.com/teams/) |
...
Queste informazioni sono state fornite da IdeaScale su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://ideascale.com/privacy-policy |
