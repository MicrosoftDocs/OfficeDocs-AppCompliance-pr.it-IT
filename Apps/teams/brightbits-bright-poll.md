---
title: Informazioni sull'applicazione per bright poll di BrightBits
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Bright Poll, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64879813"
---
# <a name="bright-poll"></a>Bright Poll

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 16 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/3a3156c1-b214-4d42-bc25-6d36f6aabb5e" target="_blank">Visualizza in Teams store</a>
...
Informazioni fornite da BrightBits a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Bright Poll |
| ID | WA200002562 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | BrightBits |
| Sito Web dell'azienda | [https://brightbits.app](https://brightbits.app) |
| Condizioni per l'utilizzo dell'app | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| Funzionalità di base dell'app | Raccogliere commenti e suggerimenti dai colleghi tramite sondaggi in chat. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://brightbits.app/bright-poll/](https://brightbits.app/bright-poll/) |
...
Queste informazioni sono state fornite da BrightBits su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
