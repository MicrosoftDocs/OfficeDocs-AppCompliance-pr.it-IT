...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Contacts.ReadWrite | delegated |  | Avere accesso completo ai contatti degli utenti. |  |
>| Contacts.ReadWrite.Shared | delegated |  | Lettura e scrittura dei contatti utente e condivisi. |  |
>| Files.ReadWrite | delegated |  | Avere accesso completo ai file degli utenti. |  |
>| Files.ReadWrite.All | delegated |  | Avere accesso completo a tutti i file a cui l'utente può accedere. |  |
>| Files.ReadWrite.Selected | delegated |  | Lettura e scrittura dei file selezionati dall'utente. |  |
>| User.ReadBasic.All | delegated |  | Leggere tutti i profili di base dell'utente. |  |
...
>I clienti in quanto data controller hanno sempre accesso ai dati. Gli amministratori possono aggiungere o rimuovere utenti da Zoho Sign. Saranno in grado di visualizzare tutte le informazioni archiviate nell'applicazione, inclusi gli audit trail completi, i report di utilizzo. Possono eliminare dati e utenti, trasferire il controllo dei dati tra gli utenti.
...
<iframe height='1020' title='Microsoft Cloud App Security Informazioni' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35679' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35679" target="_blank">Visualizzazione in una nuova scheda</a>
