---
title: Informazioni sull'applicazione per Jabber di Cisco
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Jabber, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed754df9-2e28-48ef-9f0f-e0909ce4f320" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001496" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Jabber |
| ID | WA200001496 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Cisco |
| Sito Web dell'azienda | [https://www.cisco.com](https://www.cisco.com) |
| Condizioni per l'utilizzo dell'app | [https://www.cisco.com/c/en/us/products/universal-cloud-agre...](https://www.cisco.com/c/en/us/products/universal-cloud-agreement.html) |
| Funzionalità di base dell'app | Effettuare chiamate vocali e videochiamate di Cisco direttamente da MS Teams con l'app Jabber. |
...
Queste informazioni sono state fornite da Cisco sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
