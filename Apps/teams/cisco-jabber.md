...
description: Tutte le informazioni di sicurezza e conformità disponibili per Jabber, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed754df9-2e28-48ef-9f0f-e0909ce4f320" target="_blank">Visualizzazione in Teams store</a>
...
| Funzionalità di base dell'app | Effettuare chiamate vocali e videochiamate Cisco direttamente da MS Teams con l'app Jabber. |
