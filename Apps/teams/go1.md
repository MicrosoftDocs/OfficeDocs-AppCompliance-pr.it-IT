...
| Sito Web aziendale | [https://www.go1.com/user/login](https://www.go1.com/user/login) |
| Condizioni per l'uso dell'app | [https://www.go1.com/en-au/terms/user-terms](https://www.go1.com/en-au/terms/user-terms) |
| Funzionalità di base dell'app | GO1 Teams app aiuta gli usi per trovare, usare, condividere e discutere le risorse di apprendimento dall'interno Microsoft Teams |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | application | l'app non archivia i dati dei file | [c859de61-8a6b-42e6-ba88-f639df33bc72](https://docs.microsoft.com/microsoft-365-app-certification/azure/c859de61-8a6b-42e6-ba88-f639df33bc72) |
>| Group.ReadWrite.All | application | Teams il nome del canale e l'ID univoco archiviati per supportare l'ambiente di apprendimento per la gestione dell'app | [c859de61-8a6b-42e6-ba88-f639df33bc72](https://docs.microsoft.com/microsoft-365-app-certification/azure/c859de61-8a6b-42e6-ba88-f639df33bc72) |
>| User.Read.All | application | nome degli utenti, posta elettronica e UPN archiviati per offrire un'esperienza di apprendimento personale diretta | [c859de61-8a6b-42e6-ba88-f639df33bc72](https://docs.microsoft.com/microsoft-365-app-certification/azure/c859de61-8a6b-42e6-ba88-f639df33bc72) |
