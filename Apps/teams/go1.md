...
description: Tutte le informazioni di sicurezza e conformità disponibili per Go1, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c859de61-8a6b-42e6-ba88-f639df33bc72" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://www.go1.com/user/login](https://www.go1.com/user/login) |
| Condizioni per l'utilizzo dell'app | [https://www.go1.com/en-au/terms/user-terms](https://www.go1.com/en-au/terms/user-terms) |
| Funzionalità di base dell'app | L'app go1 Teams consente di trovare, usare, condividere e discutere le risorse di apprendimento dall'interno di Microsoft Teams |
...
Queste informazioni sono state fornite da Go1 sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Applicazione | l'app non archivia i dati dei file | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| Group.ReadWrite.All | Applicazione | Teams e il nome del canale e gli ID univoci archiviati per supportare l'ambiente di apprendimento per la gestione dell'app | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| User.Read.All | Applicazione | nome utente e indirizzo di posta elettronica e UPN archiviati per offrire un'esperienza di apprendimento personale diretta | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
