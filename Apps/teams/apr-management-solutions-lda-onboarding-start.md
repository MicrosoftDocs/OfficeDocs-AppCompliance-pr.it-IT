---
title: Informazioni sull'applicazione per l'onboarding Start by APR - Management Solutions Lda.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per l'avvio dell'onboarding, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65454998"
---
# <a name="onboarding-start"></a>Avvio onboarding
...
* <a href="https://teams.microsoft.com/l/app/35729029-db8c-4cf5-b71f-9dc9511e0563" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004025" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da APR - Management Solutions Lda. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Avvio onboarding |
| ID | WA200004025 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | APR - Management Solutions Lda. |
| Sito Web dell'azienda | [https://www.apr.pt](https://www.apr.pt) |
| Condizioni per l'utilizzo dell'app | [https://www.apr.pt/terms-and-conditions/](https://www.apr.pt/terms-and-conditions/) |
| Funzionalità di base dell'app | Automatizzare il processo di onboarding dell'organizzazione e comunicare facilmente i nuovi assunti. |
...
Queste informazioni sono state fornite da APR - Management Solutions Lda. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.apr.pt/privacy-statement/ |
