---
title: Informazioni sull'applicazione per Cloud Hub di atwork GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Cloud Hub, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64877783"
---
# <a name="cloud-hub"></a>Cloud Hub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 22 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/0c46172d-7923-422d-902e-f27aaad6994d" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Cloud Hub |
| ID | WA200003034 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | atwork GmbH |
| Sito Web dell'azienda | [https://www.atwork-it.com](https://www.atwork-it.com) |
| Condizioni per l'utilizzo dell'app | [https://www.atwork-it.com/eula](https://www.atwork-it.com/eula) |
| Funzionalità di base dell'app | Cloud Hub è un'app aziendale per Microsoft Teams. Consente agli utenti di tenere traccia delle modifiche imminenti, incluse le funzionalità nuove e modificate, la manutenzione pianificata e altri annunci importanti di Microsoft Message Center. È possibile aggiungere l'app Cloud Hub alla barra dell'app in Microsoft Teams. L'app è attualmente supportata in inglese e senza costi.  |
| Sede centrale dell'azienda | Austria |
| Pagina delle informazioni sull'app | [https://www.atwork-it.com/solutions/cloudhub/](https://www.atwork-it.com/solutions/cloudhub/) |
...
Queste informazioni sono state fornite da atwork GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati utente, dati di accesso, dati di autenticazione, dati del tenant, dati del servizio di Azure, dati Graph, dati di gestione Office 365 |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Graph dati, dati di gestione Office 365 |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Austria |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | Versione più recente |
| L'app supporta i criteri di accesso condizionale? | Sì |
| Elencare i tipi di criteri supportati | App multi-tenant, dipende dalle impostazioni del cliente&#180;s |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Applicazione | Usato per selezionare un canale in cui si vuole pubblicare un messaggio dal Centro messaggi. | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| Mail.Send | Applicazione | Usato per l'invio di messaggi di posta elettronica direttamente dall'app ai canali o alle singole persone.  | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| TeamSettings.Read.All | Applicazione | Usato per selezionare un team in cui si vuole pubblicare un messaggio dal Centro messaggi. | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| User.Read.All | Applicazione | Usato per selezionare una persona a cui si vuole inviare un messaggio di posta elettronica. | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
