...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per Wazoku, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
>|:------------------------|:--------------------|:------------------------------------|
>| email | delegated | Single #A0 |
>| offline_access | delegated | Single #A0 |
>| openid | delegated | Single #A0 |
>| profile | delegated | Single #A0 |
>| User.Read | delegated | Single #A0 |
