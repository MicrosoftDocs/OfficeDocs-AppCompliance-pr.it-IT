---
title: Informazioni sull'applicazione per DailyBot di DailyBot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per DailyBot, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66915654"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 27 aprile 2022</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da DailyBot a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | DailyBot |
| ID | WA200001492 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | DailyBot |
| Sito Web dell'azienda | [https://www.dailybot.com](https://www.dailybot.com) |
| Condizioni per l'utilizzo dell'app | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| Funzionalità di base dell'app | DailyBot riduce la necessità di riunioni automatizzando standup, report di stato giornalieri, retrospettive e archivi periodici. Tiene traccia della motivazione del team e promuove feedback positivi con complimenti e apprezzamento. DailyBot include funzionalità aggiuntive per creare collegamenti/comandi e automatizzare i flussi di lavoro della chat. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
Queste informazioni sono state fornite da DailyBot su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | User Email, Tenant ID, MS Team resource ID and name,, Team Channel ID |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | User Email, Tenant ID, MS Team Resource IDs and Names, Team Channel ID, Content of user responses collected by DailyBot's features and workflows, such as: Check-Ins, Surveys, Forms or Kudos. |
...
| URL dell'informativa sulla privacy | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | DailyBot richiede di leggere le informazioni di base degli utenti dei team, che vengono usate per offrire un'esperienza utente ottimale sui processi di onboarding e semplificare il processo di invito del membro. | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |
