---
title: Informazioni sull'applicazione per CyReport di CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per CyReport, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/10b18ffa-155e-4b1f-89d5-88401ba0aa64" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004272" target="_blank">Visualizzazione in AppSource</a>
...
| Funzionalità di base dell'app | Analisi dell'area di lavoro e creazione di report per informazioni aziendali dettagliate sulle interazioni di produttività &amp; di Microsoft Team&#8217;.  La soluzione analitica e di creazione di report facile da usare per le informazioni aziendali sul team&#8217;produttività, interazioni con i clienti, tendenze, qualità delle chiamate, costi di comunicazione e molto altro ancora. CyReport per Microsoft Teams migliora la collaborazione, le prestazioni delle comunicazioni aziendali e l'efficienza, con un'esperienza eccezionale per i clienti. |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://web.cytrack.com/microsoft-teams/call-reporting-for-...](https://web.cytrack.com/microsoft-teams/call-reporting-for-microsoft-teams/) |
