---
title: Application Information for Unified Contacts by glueckkanja-gab AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per i contatti unificati, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/085251c0-aef3-11ea-bccf-6fc12269b243" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003877" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da glueckkanja-gab AG a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Contatti unificati |
| ID | WA200003877 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | glueckkanja-gab AG |
| Sito Web aziendale | [https://www.glueckkanja-gab.com/en](https://www.glueckkanja-gab.com/en) |
| Condizioni per l'uso dell'app | [https://www.glueckkanja-gab.com/en/products/unified-contact...](https://www.glueckkanja-gab.com/en/products/unified-contacts/terms-and-conditions) |
| Funzionalità di base dell'app | Ricerca unificata per Azure AD, i contatti aziendali, Exchange Online e i contatti personali. |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni dell'app | [https://www.glueckkanja-gab.com/en/products/unified-contacts](https://www.glueckkanja-gab.com/en/products/unified-contacts) |
...
Queste informazioni sono state fornite da glueckkanja-gab AG su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.glueckkanja-gab.com/en/products/unified-contacts/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read.Shared | delegated | Contatti unificati richiede l'accesso ai dati di contatto nel tenant del cliente per fornire funzionalità di base. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| Directory.Read.All | delegated | Contatti unificati richiede l'accesso ai dati di contatto nel tenant del cliente per fornire funzionalità di base. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| User.Read | delegated | Contatti unificati richiede l'accesso ai dati di contatto nel tenant del cliente per fornire funzionalità di base. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
