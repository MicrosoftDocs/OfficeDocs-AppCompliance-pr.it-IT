---
title: Informazioni sull'applicazione per Creately by Creately
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Creately, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656221"
---
# <a name="creately"></a>Crea
...
* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Creately a Microsoft:
...
| Nome della società partner | Crea |
| Sito Web dell'azienda | [https://creately.com](https://creately.com) |
| Condizioni per l'utilizzo dell'app | [https://creately.com/tos](https://creately.com/tos) |
| Funzionalità di base dell'app | Con Creately è possibile sperimentare la collaborazione visiva come mai prima d'ora. Pianificare, analizzare ed eseguire tutto il lavoro senza uscire da Microsoft Teams. Creately offre un'area di disegno visiva in forma libera e infinita per organizzare pensieri, soluzioni di brainstorming, processi di progettazione e collaborare con i colleghi in tempo reale. |
...
Queste informazioni sono state fornite da Creately su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | User Email, User Full Name |
...
| URL dell'informativa sulla privacy | https://creately.com/privacy/ |
