---
title: Application Information for Fireflies AI by Fireflies.ai
ms.author: elmalova
author: elenamalova
ms.date: 11/12/2021
ms.topic: article
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Fireflies AI, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
ms.locfileid: "60953989"
---
# <a name="fireflies-ai"></a>Lucciole AI

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 11, 2021</p>

* <a href="https://teams.microsoft.com/l/app/685d9120-feba-4cb0-934c-efcc69b85fc6" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002618" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Fireflies.ai a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Lucciole AI |
| ID | WA200002618 |
...
| Funzionalità di base dell'app | Fireflies è un assistente per le riunioni che registra, trascrive e prende appunti dalle riunioni.
 ...
 | | Sede centrale aziendale | Stati Uniti d'America | | Pagina info app | | | Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? | Paas | | Quali provider di cloud di hosting usa l'app? | GCP |
...
Queste informazioni sono state fornite da Fireflies.ai su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente |  2021-08-18 |
...
| URL dell'informativa sulla privacy | https://fireflies.ai/privacy_policy.pdf |
