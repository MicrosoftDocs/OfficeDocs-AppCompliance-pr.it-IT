...
description: Tutte le informazioni di sicurezza e conformità disponibili per il controllo di qualità 365, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64881023"
---
# <a name="365-qa"></a>365-QA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 28 dicembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | 365-QA |
| ID | WA200001394 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Advantive |
| Sito Web dell'azienda | [https://www.advantive.be](https://www.advantive.be) |
| Condizioni per l'utilizzo dell'app | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| Funzionalità di base dell'app | Advantive è un team entusiasta di professionisti ICT, che usano la tecnologia Microsoft per sviluppare e implementare soluzioni ICT innovative. Offriamo consigli, prodotti e servizi di alta qualità in base alle funzionalità Standard di Microsoft. Ciò consente ai clienti di Adventive&#8217;di aumentare l'efficienza e di sfruttare le circostanze in rapida evoluzione. Il nostro core business è fornire servizi che includono consulenza, sviluppo, implementazione, supporto e manutenzione del progetto. |
| Sede centrale dell'azienda | Belgio |
| Pagina delle informazioni sull'app | [https://www.advantive.be/365-qa-how-to/](https://www.advantive.be/365-qa-how-to/) |
...
Queste informazioni sono state fornite da Advantive su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
