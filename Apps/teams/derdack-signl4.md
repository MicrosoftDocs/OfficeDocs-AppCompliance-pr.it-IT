...
description: Tutte le informazioni di sicurezza e conformità disponibili per SIGNL4, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66845018"
---
# <a name="signl4"></a>SIGNL4

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 15 luglio 2022</p>
...
| Sito Web dell'azienda | [https://www.derdack.com](https://www.derdack.com) |
| Condizioni per l'utilizzo dell'app | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| Funzionalità di base dell'app | Derdack SIGNL4 consente l'invio di avvisi per dispositivi mobili e la risposta agli eventi imprevisti ovunque per l'infrastruttura critica operativa. Supporta le operazioni e i team oncall. |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni sull'app | [https://www.signl4.com](https://www.signl4.com) |
...
Queste informazioni sono state fornite da Derdack SIGNL4 su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | indirizzo di posta elettronica |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | indirizzo di posta elettronica |
...
| URL dell'informativa sulla privacy | https://www.signl4.com/privacy-policy/ |
