---
title: Informazioni sull'applicazione per AMEX GBT di 30SecondsToFly (Thailand) Co Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per AMEX GBT, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/157b5ffb-b183-453c-b072-9c94bb6c694c" target="_blank">Visualizza in Teams store</a>
...
Informazioni fornite da 30SecondsToFly (Thailand) Co Ltd a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | AMEX GBT |
| ID | WA200003272 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | 30SecondsToFly (Thailandia) Co Ltd |
| Sito Web dell'azienda | [https://www.amexglobalbusinesstravel.com](https://www.amexglobalbusinesstravel.com) |
| Condizioni per l'utilizzo dell'app | [https://www.amexglobalbusinesstravel.com/terms-service/](https://www.amexglobalbusinesstravel.com/terms-service/) |
| Funzionalità di base dell'app | Chatta con un consulente di viaggio. Se avete bisogno di aiuto per trovare un posto dove soggiornare o semplicemente perso un volo, i nostri consulenti di viaggio sono disponibili per chattare 24 ore su 24, 7 giorni su 7. |
...
Queste informazioni sono state fornite da 30SecondsToFly (Thailand) Co Ltd su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
