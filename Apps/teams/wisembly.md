---
title: Informazioni sull'applicazione per Wisembly di Wisembly
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Wisembly, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001554" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Wisembly a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Wisembly |
| ID | WA200001554 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Wisembly |
| Sito Web dell'azienda | [https://wisembly.com](https://wisembly.com) |
| Condizioni per l'utilizzo dell'app | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| Funzionalità di base dell'app | Creare eventi virtuali e ibridi semplici e coinvolgenti Seminari, conferenze, workshop... Wisembly ti guida attraverso il tuo progetto di evento, dall'inizio alla fine, qualunque sia la tua esigenza: home page personalizzabile, registrazione, organizzazione di workshop e sessioni plenarie, strumenti video, funzionalità interattive e molto altro ancora. |
| Sede centrale dell'azienda | Francia |
| Pagina delle informazioni sull'app | [https://wisembly.com](https://wisembly.com) |
...
Queste informazioni sono state fornite da Wisembly su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
