...
description: Tutte le informazioni di sicurezza e conformità disponibili per HighSide, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003916" target="_blank">Visualizzazione in AppSource</a>
...
| Sito Web dell'azienda | [https://highside.io](https://highside.io) |
| Condizioni per l'utilizzo dell'app | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| Funzionalità di base dell'app | File di messaggistica &amp; crittografati E2E per Microsoft Teams. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://highside.io/secureteams](https://highside.io/secureteams) |
...
Queste informazioni sono state fornite da HighSide, Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Utente Microsoft UUID, nome utente, indirizzo di posta elettronica utente |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Utente Microsoft UUID, nome utente, indirizzo di posta elettronica utente |
...
| URL dell'informativa sulla privacy | https://highside.io/privacy-policy |
