...
description: Tutte le informazioni di sicurezza e conformità disponibili per SmileBack, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880558"
---
# <a name="smileback"></a>SmileBack

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 12 aprile 2021</p>

* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da SmileBack a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | SmileBack |
| ID | WA200002623 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SmileBack |
| Sito Web dell'azienda | [https://smileback.com](https://smileback.com) |
| Condizioni per l'utilizzo dell'app | [https://smileback.com/terms](https://smileback.com/terms) |
| Funzionalità di base dell'app | SmileBack è una piattaforma di soddisfazione dei clienti progettata per provider di servizi gestiti, help desk e team di supporto IT. Gli strumenti di&#174; CSAT e NPS consentono ai professionisti IT di raccogliere, segnalare e agire in base al feedback dei clienti. CSAT (Customer Satisfaction Survey) ti aiuta a comprendere l'attuale tasso di soddisfazione dei clienti, offrendoti una misura immediata e diretta di ogni interazione del cliente (ticket di supporto). NPS&#174; (Net Promoter Score) offre informazioni dettagliate sulla relazione complessiva con i clienti. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | AWS, Heroku |
...
Queste informazioni sono state fornite da SmileBack sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
