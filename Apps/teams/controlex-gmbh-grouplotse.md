---
title: Informazioni sull'applicazione per GroupLotse di controlex GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per GroupLotse, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0ec566bc-a37a-46ca-a252-54af50dfa86e" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | GroupLotse |
| ID | WA200002304 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | controlex GmbH |
| Sito Web dell'azienda | [https://grouplotse.com](https://grouplotse.com) |
| Condizioni per l'utilizzo dell'app | [https://grouplotse.com/en/user-terms-of-service/](https://grouplotse.com/en/user-terms-of-service/) |
| Funzionalità di base dell'app | Chiarire rapidamente le responsabilità. Interfacce per intelligenza artificiale, IoT e servizi cloud inclusi. |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni sull'app | [https://grouplotse.com/en/product/](https://grouplotse.com/en/product/) |
...
Queste informazioni sono state fornite da controlex GmbH sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
