---
title: Informazioni sull'applicazione per Wellness Coach di Meditation.live, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Wellness Coach, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9913e2ed-5c17-4d66-b9e7-439290238f29" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Wellness Coach |
| ID | WA200003037 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Meditation.live, Inc. |
| Sito Web dell'azienda | [https://welllnesscoach.live](https://welllnesscoach.live) |
| Condizioni per l'utilizzo dell'app | [https://www.wellnesscoach.live/terms-of-service](https://www.wellnesscoach.live/terms-of-service) |
| Funzionalità di base dell'app | Pratiche mentali e fisiche rapide per tenerti in movimento e motivato per tutto il giorno.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://wellnesscoach.live/teams-app](https://wellnesscoach.live/teams-app) |
...
Queste informazioni sono state fornite da Meditation.live, Inc. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
