---
title: Informazioni sull'applicazione per Bigger Brains eLearning di Biggerbrains
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Bigger Brains eLearning, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/12345514-afee-abcd-acde-c5b34109abcd" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Bigger Brains eLearning |
| ID | WA200002366 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Biggerbrains |
| Sito Web dell'azienda | [https://getbiggerbrains.com](https://getbiggerbrains.com) |
| Condizioni per l'utilizzo dell'app | [https://getbiggerbrains.com/privacy-legal/](https://getbiggerbrains.com/privacy-legal/) |
| Funzionalità di base dell'app | La nostra pluripremiata libreria di corsi di formazione online è ora disponibile direttamente all'interno Microsoft Teams.  Accedi facilmente a oltre 180 corsi eLearning e oltre 3000 lezioni video aggiungendo una scheda Cervello più grande in qualsiasi canale. Gli argomenti disponibili includono: Microsoft Teams &amp; Office 365Microsoft Excel, Word, Outlook, PowerPoint, Power BI e business. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://usedapplicensing001.azurewebsites.net/teamsApp/inde...](https://usedapplicensing001.azurewebsites.net/teamsApp/index.html) |
...
Queste informazioni sono state fornite da Biggerbrains sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC1 più recente | 2021-05-13 |
| L'app è conforme ai controlli dell'organizzazione del servizio (SOC 2)? | Sì |
| Data di certificazione SOC2 più recente | 2021-05-13 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2021-05-13 |
