...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per Moneypenny, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da CALLITECH LIMITED a Microsoft:
...
| Funzionalità di base dell'app | La funzionalità di base dell'app consente agli Teams di eseguire l'onboardboard delle organizzazioni per ricevere chiamate da Moneypenny tramite un bot |
...
Queste informazioni sono state fornite da CALLITECH LIMITED su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Id tenant Microsoft, ID oggetto Microsoft |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Calls.Initiate.All | application | Per effettuare una chiamata a un Teams utente tramite un bot |
>| Calls.AccessMedia.All | application | Per trasmettere elementi multimediali dal bot all'Teams utente |
