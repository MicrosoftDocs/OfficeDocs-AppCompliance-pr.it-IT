---
title: Informazioni sull'applicazione per colloqui personalizzati di Pogo Studio
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per le conferenze personalizzate, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656194"
---
# <a name="tailored-talks"></a>Colloqui su misura

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 23 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/a1f5ad93-accd-463f-a8d5-904c77015815" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004309" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Pogo Studio a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Colloqui su misura |
| ID | WA200004309 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Pogo Studio |
| Sito Web dell'azienda | [https://pogodigitalhealth.com](https://pogodigitalhealth.com) |
| Condizioni per l'utilizzo dell'app | [https://teams.tailored-talks.com/pdf/TermsOfUse.pdf](https://teams.tailored-talks.com/pdf/TermsOfUse.pdf) |
| Funzionalità di base dell'app | Tailored Talks consente ai medici di condividere presentazioni personalizzate con i pazienti. |
...
Queste informazioni sono state fornite da Pogo Studio sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | tenant |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | tenant, posta elettronica |
...
| URL dell'informativa sulla privacy | https://teams.tailored-talks.com/pdf/PrivacyPolicy.pdf |
...
| Elencare i tipi di criteri supportati | I criteri possono essere indirizzati a utenti e gruppi specifici che offrono agli amministratori un controllo granulare sull'accesso. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Applicazione | Identificare l'utente | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| openid | Applicazione | Identificare l'utente | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| profile | Applicazione | Identificare l'utente | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
