---
title: Informazioni sull'applicazione per Sift by Sift
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Sift, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65125371"
---
# <a name="sift"></a>Sift

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 25 aprile 2022</p>

* <a href="https://teams.microsoft.com/l/app/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002545" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Sift a Microsoft:
...
| Nome della società partner | Sift |
| Sito Web dell'azienda | [https://www.justsift.com](https://www.justsift.com) |
| Condizioni per l'utilizzo dell'app | [https://www.justsift.com/sift-msteams-eula](https://www.justsift.com/sift-msteams-eula) |
| Funzionalità di base dell'app | Trovare, individuare e connettersi con gli utenti dell'organizzazione |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.justsift.com/integrating-sift/with-microsoft-te...](https://www.justsift.com/integrating-sift/with-microsoft-teams) |
...
Queste informazioni sono state fornite da Sift su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | L'app Teams richiede informazioni di base sul profilo e il consenso per visualizzare i dati delle riunioni degli utenti da Azure AD. Raccoglie anche volontariamente informazioni aggiuntive sul profilo da parte degli utenti per migliorare i profili all'interno della nostra piattaforma. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Le informazioni sul profilo utente da Microsoft Graph vengono raccolte se il consenso viene concesso da un utente amministratore. |
...
| Data di certificazione SOC2 più recente | 2022-04-25 |
...
| URL dell'informativa sulla privacy | https://www.justsift.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Delegato | Le informazioni sul gruppo vengono recuperate da Graph allo scopo di filtrare gli utenti recuperati in base al gruppo | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| User.Read.All | Delegato | Gli oggetti User vengono recuperati da Graph allo scopo di effettuare il provisioning e aggiornare in modo coerente i profili dei dipendenti nel prodotto | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| OnlineMeetingArtifact.Read.All | Delegato | Per l'estensione riunioni nell'app Teams, è necessaria l'autorizzazione per recuperare informazioni sui partecipanti alla riunione | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
>| OnlineMeetings.Read | Delegato | Per l'estensione riunioni nell'app Teams, è necessaria l'autorizzazione per recuperare informazioni sui partecipanti alla riunione | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
