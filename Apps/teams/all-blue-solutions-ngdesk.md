...
description: Tutte le informazioni di sicurezza e conformità disponibili per ngDesk, i criteri di gestione dei dati, le informazioni sul catalogo app di Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://ngdesk.com](https://ngdesk.com) |
| Condizioni per l'uso dell'app | [https://ngdesk.com/terms-of-service/](https://ngdesk.com/terms-of-service/) |
| Funzionalità di base dell'app | ngDesk include il supporto, le vendite, la gestione delle risorse, il marketing e il pager in un'applicazione all-in-one pronta per l'uso e facile da usare. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://ngdesk.com](https://ngdesk.com) |
