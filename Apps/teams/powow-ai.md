...
* <a href="https://teams.microsoft.com/l/app/5e6f557b-3d89-40e6-9d8e-0ccb5c956c22" target="_blank">Visualizzazione in Teams store</a>
...
| Nome società partner | Powow AI |
| Sito Web aziendale | [https://www.powow.ai](https://www.powow.ai) |
...
Queste informazioni sono state fornite dall'IA di Powow su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | application | Usato per il connettore di ricerca (funzionalità per il push dei dati di Powow negli indici Microsoft per la ricerca servizi Microsoft) |
>| ExternalItem.ReadWrite.All | application | Usato per il connettore di ricerca (funzionalità per il push dei dati di Powow negli indici Microsoft per la ricerca servizi Microsoft) |
