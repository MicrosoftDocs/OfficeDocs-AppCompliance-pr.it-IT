---
title: Informazioni sull'applicazione per DisasterTech DICE by DisasterTech
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per DisasterTech DICE, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65811252"
---
# <a name="disastertech-dice"></a>DisasterTech DICE

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 31 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/7df3e67b-ed62-48e9-a950-c95bd7ebce80" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://www.disastertech.com](https://www.disastertech.com) |
| Condizioni per l'utilizzo dell'app | [https://dice.disastertech.com/tos.html](https://dice.disastertech.com/tos.html) |
| Funzionalità di base dell'app | Disaster Tech Data science Integrated Collaboration Environment (DICE) fornisce software di visualizzazione dei dati e di esplorazione dei dati basato sul Web con strumenti di analisi e data science definiti dall'utente e self-service. DICE fornisce l'accesso all'inventario dei dati più completo sui rischi di emergenza da esplorare in tempo reale prima, durante e dopo le emergenze. |
...
Queste informazioni sono state fornite da DisasterTech sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Profili utente |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Profili utente |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Microsoft Teams Single Sign-On | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| email | Delegato | Microsoft Teams Single Sign-On | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| offline_access | Delegato | Microsoft Teams Single Sign-On | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| openid | Delegato | Microsoft Teams Single Sign-On | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| profile | Delegato | Microsoft Teams Single Sign-On | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
