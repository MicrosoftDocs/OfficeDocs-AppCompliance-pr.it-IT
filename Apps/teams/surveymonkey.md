...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per SurveyMonkey, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 25 ottobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/0fd925a0-357f-4d25-8456-b3022aaa41a9" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://www.surveymonkey.com](https://www.surveymonkey.com) |
| Condizioni per l'utilizzo dell'app | [https://www.surveymonkey.com/mp/legal/terms-of-use/](https://www.surveymonkey.com/mp/legal/terms-of-use/) |
| Funzionalità di base dell'app | Collaborare e acquisire feedback e sentiment dei dipendenti tramite sondaggi e sondaggi rapidi. Acquisire i risultati in un'unica posizione per mantenere il team aggiornato con le nuove risposte. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://help.surveymonkey.com/articles/en_US/kb/Microsoft-T...](https://help.surveymonkey.com/articles/en_US/kb/Microsoft-Teams-Integration) |
...
Queste informazioni sono state fornite da SurveyMonkey su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
