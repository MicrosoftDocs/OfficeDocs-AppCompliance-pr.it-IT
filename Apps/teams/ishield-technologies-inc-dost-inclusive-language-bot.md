...
description: Tutte le informazioni di sicurezza e conformità disponibili per Dost - Inclusive Language Bot, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66547284"
---
# <a name="dost---inclusive-language-bot"></a>Dost - Bot di linguaggio inclusivo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 5 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/14a29007-c5ca-4a2d-9228-b0217d8403d7" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004214" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da ishield Technologies, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Dost - Bot di linguaggio inclusivo |
| ID | WA200004214 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | ishield Technologies, Inc. |
| Sito Web dell'azienda | [https://ishield.ai](https://ishield.ai) |
| Condizioni per l'utilizzo dell'app | [https://ishield.ai/terms-of-service/](https://ishield.ai/terms-of-service/) |
| Funzionalità di base dell'app | Promuovere la messaggistica inclusiva sul posto di lavoro, la collaborazione e le comunicazioni all'interno dei team con l'aiuto di Dost. Quando si aggiunge Dost all'area di lavoro di Microsoft Teams, Dost guiderà l'utente a usare un linguaggio inclusivo nella messaggistica tramite suggerimenti e materiale didattico.  Dost illustra i momenti di apprendimento in tempo reale quando gli utenti pubblicano messaggi che contengono pregiudizi inconsci, microaggressioni o linguaggio non inclusivo con consigli per modificarli e renderli più inclusivi. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://getdost.com](https://getdost.com) |
...
Queste informazioni sono state fornite da ishield Technologies, Inc. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | L'app elabora i messaggi di MS Teams nell'ambito di Teams e Chat, ma non archivia messaggi o dettagli utente |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | Applicazione | Leggere i messaggi nell'ambito di Teams per fornire commenti e suggerimenti all'utente sulla lingua non inclusiva | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
>| ChatMessage.Read.Chat | Applicazione | Leggere i messaggi nell'ambito chat per fornire commenti e suggerimenti all'utente sulla lingua non inclusiva | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
