---
title: Informazioni sull'applicazione per processi di approvazione multipla LTAPP da LTAP SOFTWARE CO.,LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per i provider di servizi LTAP del processo di approvazione multipla, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c1ab19ab-6a95-4f02-b42f-c1df3415e8a8" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | LTAPP processo di approvazione multipla |
| ID | WA200003188 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | LTAPPs SOFTWARE CO.,LTD |
| Sito Web dell'azienda | [https://ltaddins.com](https://ltaddins.com) |
| Condizioni per l'utilizzo dell'app | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| Funzionalità di base dell'app | Il processo di approvazione multipla è un'applicazione facile da usare che consente agli utenti finali di effettuare la richiesta. L'app è completamente personalizzabile e consente agli amministratori di mantenere la coerenza con le specifiche delle organizzazioni. |
...
Queste informazioni sono state fornite da LTAPPs SOFTWARE CO.,LTD su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | ID tenant delle informazioni &amp; utente | [d2682b2a-2037-4545-94b6-3e7216ecca5f](../azure/d2682b2a-2037-4545-94b6-3e7216ecca5f.md) |
