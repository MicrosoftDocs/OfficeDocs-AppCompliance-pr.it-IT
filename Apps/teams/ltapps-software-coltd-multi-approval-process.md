...
| Sito Web aziendale | [https://ltaddins.com](https://ltaddins.com) |
| Condizioni per l'uso dell'app | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| Funzionalità di base dell'app | Il processo di approvazione multipla è un'applicazione facile da usare che consente agli utenti finali di effettuare la richiesta. L'app è completamente personalizzabile consentendo agli amministratori di mantenere la coerenza con le specifiche dell'organizzazione. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | ID tenant delle informazioni &amp; utente | [d2682b2a-2037-4545-94b6-3e7216ecca5f](https://docs.microsoft.com/microsoft-365-app-certification/azure/d2682b2a-2037-4545-94b6-3e7216ecca5f) |
