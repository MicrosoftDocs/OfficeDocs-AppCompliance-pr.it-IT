...
* <a href="https://teams.microsoft.com/l/app/40b745ad-16a8-4eda-bf1c-5b48b0dc947d" target="_blank">Visualizzazione in Teams store</a>
...
|:----------------|:-------------|
| Nome app | Assistente firewall |
| ID | WA200003363 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | DewMaker Design, Inc. |
| Sito Web aziendale | [https://dewmaker.com](https://dewmaker.com) |
...
Queste informazioni sono state fornite da DewMaker Design, Inc. Sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Indirizzo di posta elettronica (per gli account di accesso MS) e dati dell'endpoint della sottoscrizione di Azure |
