...
description: Tutte le informazioni di sicurezza e conformità disponibili per ARGUSnylar, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64879823"
---
# <a name="argusnylar"></a>ARGUSnylar

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 25 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/f14455f8-5bbe-4da9-8df3-9c5533057569" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | ARGUSnylar |
| ID | WA200003186 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | ARGUS DATA INSIGHTS Schweiz AG |
| Sito Web dell'azienda | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| Condizioni per l'utilizzo dell'app | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| Funzionalità di base dell'app | ARGUSnylar è l'estensione utile per l'account. |
| Sede centrale dell'azienda | Svizzera |
| Pagina delle informazioni sull'app | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
...
Queste informazioni sono state fornite da ARGUS DATA INSIGHTS Schweiz AG sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | Applicazione | / | [5c1f85d2-d744-4159-8c01-16e9a7b1207b](../azure/5c1f85d2-d744-4159-8c01-16e9a7b1207b.md) |
