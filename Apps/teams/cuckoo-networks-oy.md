---
title: Informazioni sull'applicazione per Cuckoo di Cuckoo Networks Oy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/22/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Cuckoo, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66547423"
---
# <a name="cuckoo"></a>Cuculo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 20 giugno 2022</p>
...
|:----------------|:-------------|
| Nome dell'app | Cuculo |
| ID | WA200002750 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Cuckoo Networks Oy |
| Sito Web dell'azienda | [https://cuckoo.fi](https://cuckoo.fi) |
| Condizioni per l'utilizzo dell'app | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
| Funzionalità di base dell'app | Esercizi di micro-break divertenti e facili e gamified per aumentare l'energia e il cervello. |
| Sede centrale dell'azienda | Finlandia |
| Pagina delle informazioni sull'app | [https://cuckoo.fi](https://cuckoo.fi) |
...
Queste informazioni sono state fornite da Cuckoo Networks Oy su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati profilo utente, ID tenant, nome tenant |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Attività utente e informazioni identificabili dall'utente |
...
| URL dell'informativa sulla privacy | https://cuckoo.fi/en/privacy-policy/ |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | passport-azure-ad, adal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Autenticazione utente al servizio tramite l'accesso Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| email | Delegato | Contattare i clienti con informazioni sugli eventi dell'applicazione, i concorsi disponibili e il supporto clienti | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | Delegato | Autenticazione utente al servizio tramite l'accesso Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | Delegato | Autenticazione utente al servizio tramite l'accesso Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| profile | Delegato | Autenticazione utente al servizio tramite l'accesso Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
