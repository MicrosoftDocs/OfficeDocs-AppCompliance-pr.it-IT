---
title: Informazioni sull'applicazione per Loopio di Loopio Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Loopio, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c2f87ddb-d2e0-4268-851f-88d57ac6e0a0" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004103" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Loopio Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Loopio |
| ID | WA200004103 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Loopio Inc. |
| Sito Web dell'azienda | [https://www.loopio.com](https://www.loopio.com) |
| Condizioni per l'utilizzo dell'app | [https://loopio.com/terms/](https://loopio.com/terms/) |
| Funzionalità di base dell'app | Cercare e condividere il contenuto della libreria Loopio mantenendo le attività con le notifiche Loopio. |
...
Queste informazioni sono state fornite da Loopio Inc. Informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID Teams utente |
...
| URL dell'informativa sulla privacy | https://loopio.com/privacy/ |
