---
title: Informazioni sull'applicazione per PostBeyond di PostBeyond
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni sulla sicurezza e la conformità disponibili per PostBeyond, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6e588f9e-5271-4583-b373-7991497deaec" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002658" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da PostBeyond a Microsoft:
...
| Nome società partner | PostBeyond |
| Sito Web aziendale | [https://www.postbeyond.com](https://www.postbeyond.com) |
| Condizioni per l'uso dell'app | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| Funzionalità di base dell'app | Attiva i supporti dei social media per aumentare la visibilità del marchio, il coinvolgimento e i risultati misurabili con la consulenza dei dipendenti basata su PostBeyond. Amplifica i tuoi contenuti migliori sui social network dei dipendenti, dando al tuo marchio l'attenzione che merita. Rendiamo la difesa dei dipendenti potente per i marketer e incredibilmente facile per i dipendenti.  |
| Sede centrale dell'azienda | Canada |
| Pagina delle informazioni dell'app | [https://www.postbeyond.com/product/](https://www.postbeyond.com/product/) |
...
Queste informazioni sono state fornite da PostBeyond su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
