---
title: Informazioni sull'applicazione per BRAVO Workhub di Coeus Solutions GmbH
ms.author: elmalova
author: elenamalova
ms.date: 02/07/2022
ms.topic: article
...
description: Tutte le informazioni di sicurezza e conformità disponibili per BRAVO Workhub, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/53ab3c45-3531-47a8-b524-fe8b5fd539ef" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003694" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Coeus Solutions GmbH a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | BRAVO Workhub |
| ID | WA200003694 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Coeus Solutions GmbH |
| Sito Web aziendale | [https://getbravo.io](https://getbravo.io) |
| Condizioni per l'uso dell'app | [https://getbravo.io/terms-and-conditions](https://getbravo.io/terms-and-conditions) |
| Funzionalità di base dell'app | Offri facilmente premi peer-to-peer con Microsoft Teams integrazione con BRAVO. |
...
Queste informazioni sono state fornite da Coeus Solutions GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | L'ID Microsoft Teams e l'ID team vengono archiviati nel database. |
...
| URL dell'informativa sulla privacy | https://getbravo.io/privacy-policy |
