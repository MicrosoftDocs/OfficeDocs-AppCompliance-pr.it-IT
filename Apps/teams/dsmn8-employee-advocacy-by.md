...
* <a href="https://teams.microsoft.com/l/app/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c" target="_blank">Visualizzazione in Teams store</a>
...
|:----------------|:-------------|
| Nome app | Employee Advocacy di DSMN8 |
| ID | WA200003677 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | DSMN8 |
| Sito Web aziendale | [https://dsmn8.com](https://dsmn8.com) |
| Condizioni per l'uso dell'app | [https://dsmn8.com/terms-and-conditions](https://dsmn8.com/terms-and-conditions) |
| Funzionalità di base dell'app |  DSMN8 è una piattaforma basata su app che consente ai dipendenti di diventare influencer aziendali condividendo contenuti aziendali approvati dall'azienda nei propri canali di social media.  |
...
Queste informazioni sono state fornite da DSMN8 sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | posizione, nome, cognome, indirizzo di posta elettronica |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | entrambi | Per leggere la posizione, il nome, il cognome e i dati di posta elettronica durante il processo di accesso per creare un profilo nella nostra app |
