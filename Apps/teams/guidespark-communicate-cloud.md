...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per GuideSpark Communicate Cloud, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 13 ottobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/34b870ca-2417-4660-b835-ebb18ee7ccf9" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | GuideSpark Communicate Cloud |
| ID | WA200003348 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | GuideSpark |
| Sito Web dell'azienda | [https://guidespark.com](https://guidespark.com) |
| Condizioni per l'utilizzo dell'app | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| Funzionalità di base dell'app | Guidare il cambiamento dell'organizzazione rivolgendosi ai destinatari e tenere traccia dei dati di engagement tramite GuideSpark Communicate Cloud. Espandere i canali di recapito e raggiungere le persone in cui sono per facilitare comunicazioni interne efficaci. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.guidespark.com/change-communications-software/](https://www.guidespark.com/change-communications-software/) |
...
Queste informazioni sono state fornite da GuideSpark su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
