...
Informazioni fornite da HeyTaco, LLC a Microsoft:
...
| Nome società partner | HeyTaco, LLC |
| Sito Web aziendale | [https://www.heytaco.chat](https://www.heytaco.chat) |
| Condizioni per l'uso dell'app | [https://www.heytaco.chat/terms](https://www.heytaco.chat/terms) |
| Funzionalità di base dell'app | HeyTaco! aiuta a creare una cultura aziendale più forte ispirando una comunicazione positiva e unendo le persone attraverso il riconoscimento, l'apprezzamento e i premi. Ogni giorno, ogni persona ha 5 tacos da dare agli altri membri del team. I tacos sono dati per mostrare apprezzamento e riconoscere tutto, dalle piccole vittorie ai grandi risultati. Le persone possono quindi usare i loro tacos maturati per riscattare interessanti premi individuali o basati sul team che hai creato. |
...
Queste informazioni sono state fornite da HeyTaco, LLC su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome, e-mail, avatar |
...
| URL dell'informativa sulla privacy | https://www.heytaco.chat/privacy |
