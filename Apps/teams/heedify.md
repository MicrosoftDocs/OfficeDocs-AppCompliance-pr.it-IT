---
title: Informazioni sull'applicazione per Heedify by Heedify
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/24/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Heedify, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64877273"
---
# <a name="heedify"></a>Heedify

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 2 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003512" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Heedify a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Heedify |
| ID | WA200003512 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Heedify |
| Sito Web dell'azienda | [https://heedify.io](https://heedify.io) |
| Condizioni per l'utilizzo dell'app | [https://heedify.io/terms](https://heedify.io/terms) |
| Funzionalità di base dell'app | Operatore receptionist nativo e agente call center per Microsoft Teams. |
...
Queste informazioni sono state fornite da Heedify sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Informazioni sulla presenza e dettagli della chiamata (dal call center )  |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Informazioni sulla presenza e dettagli della chiamata (dal call center )  |
...
| URL dell'informativa sulla privacy | https://heedify.io/privacy |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | Si usa ADAL (Javascript) perché MSAL non supporta ancora l'autenticazione con ADFS  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegato | Receptionist deve controllare il calendario degli utenti prima di trasferire una chiamata o condividere le informazioni con il cliente al telefono | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite | Delegato | L'applicazione deve essere in grado di aggiungere contatti all'utente(agente) e leggere anche i contatti  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite.Shared | Delegato | l'applicazione deve essere in grado di aggiungere contatti di condivisione con altri utenti(agente) e leggere anche i contatti condivisi  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Presence.Read.All | Delegato | Le informazioni sulla presenza sono necessarie per l'agente del contact center per una migliore gestione delle chiamate e dei contatti, soprattutto in caso di trasferimento delle chiamate  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| User.Read.All | Delegato | per gestire il contatto, l'utente registrato deve essere in grado di sfogliare gli utenti e leggere le loro informazioni, inclusi i loro partenze e manager (nel caso di un receptionist)  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
