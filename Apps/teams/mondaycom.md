...
description: Tutte le informazioni di sicurezza e conformità disponibili per monday.com, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eab2d3ce-6d6a-4415-abc4-5f40a8317b1f" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://monday.com](https://monday.com) |
| Condizioni per l'utilizzo dell'app | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| Funzionalità di base dell'app | monday.com è un sistema operativo di lavoro versatile che supporta il lavoro in team remoto, per organizzare, strutturare e semplificare tutti i programmi, i progetti e i processi.  Tramite monday.com, è possibile usare blocchi predefiniti &#8211; come lavagne, visualizzazioni, grafici, automazioni e integrazioni, per creare app del flusso di lavoro personalizzate per l'esecuzione di processi, progetti e attività quotidiane. Creare una nuova scheda monday.com o aggiungerla a una scheda esistente direttamente all'interno di Microsoft Teams e visualizzare facilmente il lavoro del team&#8217;in un'unica area di lavoro collaborativa. |
...
| Data di certificazione SOC1 più recente | 2021-05-01 |
| L'app è conforme ai controlli dell'organizzazione del servizio (SOC 2)? | Sì |
| Data di certificazione SOC2 più recente | 2021-05-01 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2021-05-01 |
