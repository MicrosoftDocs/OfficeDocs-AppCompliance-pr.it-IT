---
title: Informazioni sull'applicazione per SwiftAssess di GamaLearn
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SwiftAssess, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001973" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da GamaLearn a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | SwiftAssess |
| ID | WA200001973 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | GamaLearn |
| Sito Web dell'azienda | [https://gamalearn.com](https://gamalearn.com) |
| Condizioni per l'utilizzo dell'app | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| Funzionalità di base dell'app | Un punto di partenza unico per tutte le esigenze di valutazione, che spazia da metodologie e funzionalità collaudate che guidano il percorso attraverso la creazione, la distribuzione e il rilevamento della strategia di trasformazione della valutazione a tutti i livelli dell'organizzazione. SwiftAssess offre più soluzioni, funzionalità e flussi di lavoro chiave che semplificano e automatizzano i processi di valutazione reali in diversi istituti. Questo riguarda gli standard del settore in materia di sicurezza, accessibilità, analisi, item banking e altro ancora |
| Sede centrale dell'azienda | Emirati Arabi Uniti (il) |
| Pagina delle informazioni sull'app | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
...
Queste informazioni sono state fornite da GamaLearn su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
