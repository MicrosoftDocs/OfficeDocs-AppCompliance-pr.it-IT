---
title: Informazioni sull'applicazione per la trasmissione di Cerkl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Broadcast, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Broadcast |
| ID | WA200002697 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Cerkl |
| Sito Web dell'azienda | [https://cerkl.com](https://cerkl.com) |
| Condizioni per l'utilizzo dell'app | [https://cerkl.com/terms](https://cerkl.com/terms) |
| Funzionalità di base dell'app | Cerkl Broadcast collega i destinatari dei dipendenti con l'organizzazione&#8217;importanti comunicazioni. Usando la personalizzazione basata sul comportamento, Broadcast recapita il messaggio giusto al dipendente giusto al momento giusto sul canale giusto. Questo&#8217;è il punto in cui ci distiriamo davvero dalla concorrenza: consentiamo ai comunicatori esperti di comunicare attraverso i canali senza duplicare gli sforzi. Broadcast fornisce anche metriche leader del settore che consentono ai nostri clienti di sapere quali&#8217;funzionano per il loro pubblico. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
...
Queste informazioni sono state fornite da Cerkl sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-07-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Il messaggio di posta elettronica dell'utente viene raccolto e usato per verificare se l'utente si trova attualmente nel sistema e se è stato aggiunto da un'organizzazione. | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
