...
description: Tutte le informazioni di sicurezza e conformità disponibili per ADI, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/de5717a1-6884-4b96-8b1e-ee17b5d778f3" target="_blank">Visualizza in Teams store</a>
...
Informazioni fornite da Akari Solutions Limited to Microsoft:
...
| Nome della società partner | Akari Solutions Limited |
| Sito Web dell'azienda | [https://akari.io](https://akari.io) |
| Condizioni per l'utilizzo dell'app | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| Funzionalità di base dell'app | AdI è qui per aiutarti a soddisfare tutte le tue esigenze di accessibilità e ad aumentare i programmi di gestione delle modifiche. È possibile chiedere ad ADI di fornire risposte, consigli e informazioni su come usare le funzionalità di accessibilità all'interno di Microsoft Teams, è possibile conoscere le disabilità nascoste e situazionali e quali strumenti e suggerimenti possono essere utili. AdI risponderà con una combinazione di risposte conversazionali basate su testo, video con dimensioni di byte e collegamenti concettuali da una varietà di origini. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://akari.io/adi](https://akari.io/adi) |
...
Queste informazioni sono state fornite da Akari Solutions Limited su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
