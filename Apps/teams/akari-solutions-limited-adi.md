...
description: Tutte le informazioni di sicurezza e conformità disponibili per ADI, i relativi criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://akari.io](https://akari.io) |
| Condizioni per l'uso dell'app | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| Funzionalità di base dell'app | ADI è qui per aiutarti con tutte le tue esigenze di accessibilità e per aumentare i programmi di gestione delle modifiche. È possibile chiedere ad ADI di fornire risposte, consigli e informazioni su come usare le funzionalità di accessibilità all'interno di Microsoft Teams, è possibile conoscere le disabilità nascoste e situazioni e quali strumenti e suggerimenti possono essere utili. ADI risponderà con una combinazione di risposte conversazionali basate su testo, video di dimensioni a byte e collegamenti concettuali da un'ampia gamma di origini. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (la) |
| Pagina delle informazioni dell'app | [https://akari.io/adi](https://akari.io/adi) |
