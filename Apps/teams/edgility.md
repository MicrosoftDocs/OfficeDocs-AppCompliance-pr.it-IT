---
title: Informazioni sull'applicazione per Edgility di Edgility
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Edgility, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Edgility a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Edgility |
| ID | WA200003970 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Edgility |
| Sito Web dell'azienda | [https://edgility.com.au](https://edgility.com.au) |
| Condizioni per l'utilizzo dell'app | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| Funzionalità di base dell'app | Edgility è leader nello sviluppo di strumenti di comunicazione aziendale integrati. Queste soluzioni SMS consentono alle organizzazioni di semplificare il processo di ricordare, promuovere, avvisare e notificare le persone che contano per la loro azienda, usando le piattaforme su cui si basano già. Questi includono prodotti Microsoft come Excel, Outlook e Teams. Gli utenti sono in grado di sfruttare questo efficace strumento di conversazione ricevendo SMS in Microsoft Outlook e Teams. |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
...
Queste informazioni sono state fornite da Edgility su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Nomi |
