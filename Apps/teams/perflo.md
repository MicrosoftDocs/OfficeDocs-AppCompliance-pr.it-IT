...
description: Tutte le informazioni di sicurezza e conformità disponibili per Perflo, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/374c7844-f88a-43f3-b6d5-5cf58b5b293e" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004251" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Perflo |
| ID | WA200004251 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Perflo |
| Sito Web dell'azienda | [https://www.perflo.co](https://www.perflo.co) |
| Condizioni per l'utilizzo dell'app | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| Funzionalità di base dell'app | La soluzione di diagnostica del team definitiva che consente ai team di migliorare continuamente. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.perflo.co](https://www.perflo.co) |
...
Queste informazioni sono state fornite da Perflo sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | ID DI MICROSOFT Teams, immagine del profilo |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID DI MICROSOFT Teams, immagine del profilo |
