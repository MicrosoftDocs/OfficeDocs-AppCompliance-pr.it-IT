...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Tendfor, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64876183"
---
# <a name="tendfor"></a>Tendfor

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Ultimo aggiornamento da parte dello sviluppatore: 15 febbraio 2022</p>

* <a href="https://teams.microsoft.com/l/app/212fcd92-bc06-4746-85c4-f7b5d39579ba" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Tendfor |
| ID | WA200002996 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Tendfor |
| Sito Web dell'azienda | [https://www.tendfor.com](https://www.tendfor.com) |
| Condizioni per l'utilizzo dell'app | [https://tendfor.com/tendfor_docs/en/StandardContractMarch20...](https://tendfor.com/tendfor_docs/en/StandardContractMarch2019.pdf) |
| Funzionalità di base dell'app | Un centro contatti completo e una console operatore per Microsoft Teams. |
| Sede centrale dell'azienda | Svezia |
| Pagina delle informazioni sull'app | [https://www.tendfor.com](https://www.tendfor.com) |
...
Queste informazioni sono state fornite da Tendfor su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente, dati del calendario utente, supporti di chiamata |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Per poter accedere agli utenti | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | Applicazione | Per poter importare le informazioni dell'utente | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | Delegato | Per poter importare le informazioni dell'utente | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
