---
title: Informazioni sull'applicazione per iManage di iManage
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per iManage, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c941fa60-c3a3-4bc6-b846-a63406009c15" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | iManage |
| ID | WA200003178 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | iManage |
| Sito Web dell'azienda | [https://imanage.com](https://imanage.com) |
| Condizioni per l'utilizzo dell'app | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| Funzionalità di base dell'app | Collaborare liberamente mentre il contenuto viene salvato e regolato in iManage. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
...
Queste informazioni sono state fornite da iManage su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2021-04-16 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2021-04-16 |
