...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per iManage, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://imanage.com](https://imanage.com) |
| Condizioni per l'uso dell'app | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| Funzionalità di base dell'app | Collaborare liberamente mentre il contenuto viene salvato e regolamentato in iManage. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
