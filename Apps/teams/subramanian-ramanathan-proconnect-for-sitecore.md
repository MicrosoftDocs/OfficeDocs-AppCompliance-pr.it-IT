---
title: Informazioni sull'applicazione per Proconnect for Sitecore di Subramanian Ramanathan
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
Informazioni fornite da Subramanian Ramanathan a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Proconnect for Sitecore |
| ID | WA200003274 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Subramanian Ramanathan |
| Sito Web dell'azienda | [https://subbu.ca](https://subbu.ca) |
| Condizioni per l'utilizzo dell'app | [https://github.com/SubbuRamanathan/sitecore-microsoft-teams...](https://github.com/SubbuRamanathan/sitecore-microsoft-teams-integration/blob/main/terms-of-use.md) |
| Funzionalità di base dell'app | Migliora l'esperienza di creazione del contenuto con avvisi istantanei sugli aggiornamenti della pubblicazione del flusso di lavoro &amp; . Questo connettore include anche azioni appropriate per gli avvisi, consentendo agli autori di contenuti di svolgere il loro lavoro più rapidamente. Questo connettore stabilisce la trasparenza nella comunicazione e include anche informazioni dettagliate sulle prestazioni del sito/pagina. |
...
Queste informazioni sono state fornite da Subramanian Ramanathan sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-04-30 |
