...
ms.locfileid: "61787279"
---
# <a name="proconnect-for-sitecore"></a>Proconnect per Sitecore
...
|:----------------|:-------------|
| Nome app | Proconnect per Sitecore |
| ID | WA200003274 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Ramanathan subramaniano |
...
Queste informazioni sono state fornite da Subramanian Ramanathan su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
