...
>I dati dell'applicazione vengono archiviati in un database MySQL ospitato in Google Cloud, il sistema di backup viene aggiunto per i database e vengono gestiti tramite PMA e IP protetti.
