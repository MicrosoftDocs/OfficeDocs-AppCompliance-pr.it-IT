---
title: Informazioni sull'applicazione per JustLogin di JustLogin
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per JustLogin, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cfbb8888-3227-45fc-a4b7-423af170defa" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004314" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da JustLogin a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | JustLogin |
| ID | WA200004314 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | JustLogin |
| Sito Web dell'azienda | [https://justlogin.com](https://justlogin.com) |
| Condizioni per l'utilizzo dell'app | [https://justlogin.com/terms/](https://justlogin.com/terms/) |
| Funzionalità di base dell'app | JustLogin : software per le risorse umane adatto ai dipendenti. |
...
Queste informazioni sono state fornite da JustLogin sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://justlogin.com/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Delegato | bisogno di posta elettronica per l'accesso a JustLogin tramite SSO | [af5883db-bda9-4d1a-b1ce-022bea20f021](../azure/af5883db-bda9-4d1a-b1ce-022bea20f021.md) |
