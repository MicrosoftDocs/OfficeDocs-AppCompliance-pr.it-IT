---
title: Informazioni sull'applicazione per Beagle by Decision Point
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Beagle, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Beagle |
| ID | WA200002687 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Punto decisionale |
| Sito Web dell'azienda | [https://decisionpoint.ai](https://decisionpoint.ai) |
| Condizioni per l'utilizzo dell'app | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| Funzionalità di base dell'app | Beagle è uno strumento bi basato su chat integrato con piattaforme come MS Teams. Beagle riduce le barriere all'adozione ed elimina la necessità di formazione (di singoli utenti) portando i dati agli utenti tramite un'app di collaborazione.  Beagle mostra i dati rilevanti a un utente sotto forma di schede di informazioni dettagliate e consente di approfondire l'analisi usando i filtri e consente di prendere decisioni più velocemente.  |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
...
Queste informazioni sono state fornite dal punto di decisione su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
