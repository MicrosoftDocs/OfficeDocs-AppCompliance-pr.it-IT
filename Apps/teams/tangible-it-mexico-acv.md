---
title: Informazioni sull'applicazione per ACV di Tangible IT Mexico
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per ACV, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0a3b1cc0-1cda-4373-90b9-7740e604c5e3" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004237" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Tangible IT Mexico a Microsoft:
...
| Nome della società partner | Messico IT tangibile |
| Sito Web dell'azienda | [https://www.tangibleit.com](https://www.tangibleit.com) |
| Condizioni per l'utilizzo dell'app | [https://www.acv.app/terms](https://www.acv.app/terms) |
| Funzionalità di base dell'app | Gestire il controllo delle presenze, fornire visibilità ai dirigenti tramite i dashboard e facilitare l'esperienza di insegnamento tramite l'uso di lavagne. Tutto in una soluzione che rispecchia l'istituto di istruzione. |
| Sede centrale dell'azienda | Messico |
| Pagina delle informazioni sull'app | [https://www.acv.app](https://www.acv.app) |
...
Queste informazioni sono state fornite da Tangible IT Mexico sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente, dati di posta elettronica utente per l'autenticazione. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome utente, indirizzo di posta elettronica utente, ruolo utente, telefono dell'istituto di istruzione, indirizzo dell'istituto di istruzione, nome dell'istituto di istruzione, materie, classi, lezioni. |
...
| URL dell'informativa sulla privacy | https://www.acv.app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | entrambi | Per pubblicare il collegamento whiteboard collaboration (Our Feature) nel canale. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| Group.ReadWrite.All | entrambi | Per pubblicare il collegamento whiteboard collaboration (Our Feature) nel canale. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| User.Read | entrambi | I processi di autenticazione vengono eseguiti e i dati vengono ottenuti sul profilo degli studenti appartenenti a un gruppo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| email | entrambi | I processi di autenticazione vengono eseguiti e i dati vengono ottenuti sul profilo degli studenti appartenenti a un gruppo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| openid | entrambi | I processi di autenticazione vengono eseguiti e i dati vengono ottenuti sul profilo degli studenti appartenenti a un gruppo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| profile | entrambi | I processi di autenticazione vengono eseguiti e i dati vengono ottenuti sul profilo degli studenti appartenenti a un gruppo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
