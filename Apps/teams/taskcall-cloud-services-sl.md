---
title: Informazioni sull'applicazione per TaskCall di TaskCall Servizi cloud, S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per TaskCall, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da TaskCall Servizi cloud, S.L. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | TaskCall |
| ID | WA200003914 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | TaskCall Cloud Services, S.L. |
| Sito Web dell'azienda | [https://taskcallapp.com](https://taskcallapp.com) |
| Condizioni per l'utilizzo dell'app | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| Funzionalità di base dell'app | L'integrazione bidirezionale Microsoft Teams TaskCall semplifica la comunicazione e la collaborazione IT-Ops consentendo la gestione degli eventi imprevisti dall'interno di Microsoft Teams. |
| Sede centrale dell'azienda | Spagna |
| Pagina delle informazioni sull'app | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
Queste informazioni sono state fornite da TaskCall Servizi cloud, S.L. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
