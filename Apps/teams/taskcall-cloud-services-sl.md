---
title: Informazioni sull'applicazione per TaskCall da TaskCall Servizi cloud, S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per TaskCall, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Visualizzazione in Teams store</a>
...
| Nome società partner | TaskCall Servizi cloud, S.L. |
| Sito Web aziendale | [https://taskcallapp.com](https://taskcallapp.com) |
| Condizioni per l'uso dell'app | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| Funzionalità di base dell'app | L'integrazione bidirezionale Microsoft Teams TaskCall semplifica la comunicazione e la collaborazione IT-Ops consentendo la gestione degli incidenti dall'interno di Microsoft Teams. |
| Sede centrale dell'azienda | Spagna |
| Pagina delle informazioni dell'app | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
Queste informazioni sono state fornite da TaskCall Servizi cloud, S.L. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
