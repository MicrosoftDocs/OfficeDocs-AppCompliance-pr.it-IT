---
title: Informazioni sull'applicazione per Pavestep di Pavestep
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Pavestep, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/aaa83b14-3857-43e0-88ca-b726f5df5db3" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004114" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Pavestep a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Pavestep |
| ID | WA200004114 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Pavestep |
| Sito Web dell'azienda | [https://www.pavestep.com](https://www.pavestep.com) |
| Condizioni per l'utilizzo dell'app | [https://www.pavestep.com/user-agreement](https://www.pavestep.com/user-agreement) |
| Funzionalità di base dell'app | Pavestep è una soluzione intuitiva di gestione delle prestazioni. |
...
Queste informazioni sono state fornite da Pavestep sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Nomi, cognome, messaggi di posta elettronica, ruoli del processo |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nomi, cognome, messaggi di posta elettronica, ruoli del processo |
