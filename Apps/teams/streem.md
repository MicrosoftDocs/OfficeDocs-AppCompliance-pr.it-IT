...
description: Tutte le informazioni di sicurezza e conformità disponibili per Streem, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/608c5480-b3aa-4a0f-8f26-b97715313f4a" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Streem |
| ID | WA200000197 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Streem |
| Sito Web dell'azienda | [https://www.streem.com.au](https://www.streem.com.au) |
| Condizioni per l'utilizzo dell'app | [https://www.streem.com.au/terms](https://www.streem.com.au/terms) |
| Funzionalità di base dell'app | Streem offre servizi di monitoraggio dei media in tempo reale raccogliendo e analizzando contenuti da fonti di stampa, online, TV, radio e social media in Australia e Nuova Zelanda. Ogni nuovo contenuto viene confrontato con le parole chiave a cui i clienti si interessano e gli avvisi e i report pertinenti vengono inviati tramite posta elettronica, applicazioni desktop per dispositivi mobili &amp; o integrazione con Slack e Microsoft Teams. |
...
Queste informazioni sono state fornite da Streem su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
