...
description: Tutte le informazioni di sicurezza e conformità disponibili per Attività WorkJam, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64876113"
---
# <a name="workjam-tasks"></a>Attività WorkJam

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 6 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/9a8a5779-52a9-4400-989a-b0284ea78557" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Attività WorkJam |
| ID | WA200003241 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | WorkJam |
| Sito Web dell'azienda | [https://www.workjam.com](https://www.workjam.com) |
| Condizioni per l'utilizzo dell'app | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| Funzionalità di base dell'app | WorkJam è la soluzione Digital Workplace che i leader del settore scelgono di orchestrare la forza lavoro in prima linea &#8212; come piattaforma di produttività in prima linea o all'interno della soluzione per i dipendenti in prima linea. Disponibile in oltre 37 lingue e distribuito in oltre 38 paesi, WorkJam offre orchestrazione totale della forza lavoro attraverso strumenti leader di mercato per la gestione delle attività, la gestione dei turni, il sondaggio e il micro learning.  |
| Sede centrale dell'azienda | Canada |
| Pagina delle informazioni sull'app | [https://www.workjam.com/portfolio-items/workjam-microsoft-t...](https://www.workjam.com/portfolio-items/workjam-microsoft-teams/) |
...
Queste informazioni sono state fornite da WorkJam sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-08-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | Applicazione | Invio di notifiche agli utenti finali. | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
>| User.Read | Delegato | Per l'identificazione e l'autenticazione | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
