---
title: Informazioni sull'applicazione per l'eformità | Gestione dei modelli per eformità
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per i | di eformità Gestione dei modelli, i criteri di gestione dei dati, i Microsoft Cloud App Security le informazioni del catalogo delle app e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64771447"
---
# <a name="eformity--template-management"></a>| di eformità Gestione dei modelli

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 19 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da eformity a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | eformità - Gestione dei modelli |
| ID | WA200003519 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | eformità |
| Sito Web dell'azienda | [https://eformity.nl](https://eformity.nl) |
| Condizioni per l'utilizzo dell'app | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| Funzionalità di base dell'app | Usare modelli gestiti centralmente per la creazione di documenti e presentazioni da Microsoft Teams. |
...
Queste informazioni sono state fornite dall'eformità su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | User Mail, User Name, User First Name, User Last Name |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | User Mail, User Name, User First Name, User Last Name |
...
| URL dell'informativa sulla privacy | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Delegato | Salvare i modelli generati | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | Delegato | Raccogliere dati per l'aggiornamento del profilo utente nella piattaforma | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| openid | Delegato | Accesso di un utente | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| profile | Delegato | Accesso di un utente | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
