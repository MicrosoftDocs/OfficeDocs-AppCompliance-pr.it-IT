---
title: Informazioni sull'applicazione per il dizionario EN-UA di Skyline Consulatnts
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per il dizionario EN-UA, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66564597"
---
# <a name="en-ua-dictionary"></a>Dizionario EN-UA
...
* <a href="https://teams.microsoft.com/l/app/1a24a3a3-1fda-4f70-abee-40bba8c638e8" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004310" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Skyline Consulatnts a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Dizionario EN-UA |
| ID | WA200004310 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Skyline Consulatnts |
| Sito Web dell'azienda | [https://skylineconsultants.com](https://skylineconsultants.com) |
| Condizioni per l'utilizzo dell'app | [https://skylineconsultants.com/terms-and-conditions/](https://skylineconsultants.com/terms-and-conditions/) |
| Funzionalità di base dell'app | English-Ukrainian'applicazione dizionario di Skyline Consultants è completamente organizzata per consentire agli utenti di cercare le parole sconosciute mentre lavorano in Microsoft Teams. |
...
Queste informazioni sono state fornite da Skyline Consulatnts su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Il database mantiene le informazioni: dove l'utente si è arrestato nell'app e ripristina tale posizione al successivo accesso dell'utente all'applicazione. ID utente graph |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | Microsoft.Graph; Microsoft.TeamsFx; |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Per accedere al profilo utente | [2da850e4-5b9d-455c-ae32-bec270de4b60](../azure/2da850e4-5b9d-455c-ae32-bec270de4b60.md) |
