---
title: Informazioni sull'applicazione per testo da parte del contatto approvato
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/20/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Text, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880987"
---
# <a name="text"></a>Testo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 10 maggio 2021</p>

* <a href="https://teams.microsoft.com/l/app/a622ceb4-b6e2-4557-8218-e22e80975ba4" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://www.approvedcontact.com](https://www.approvedcontact.com) |
| Condizioni per l'utilizzo dell'app | [https://approvedcontact.com/Terms%20of%20use.pdf](https://approvedcontact.com/Terms%20of%20use.pdf) |
| Funzionalità di base dell'app | Il contatto approvato consente di condividere facilmente i calendari con chiunque. Le modifiche apportate al calendario vengono aggiornate automaticamente al contatto approvato. L'uso del contatto approvato consente di connettere il calendario a siti Web, sms, posta elettronica, dispositivi mobili, riconoscimento vocale e sistemi telefonici. |
...
Queste informazioni sono state fornite dal contatto approvato su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | Delegato | Per il BOT di testo si acquisisce l'identificatore del team per la creazione di canali futuri per i messaggi di testo in ingresso. | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| email | Delegato | indirizzi di posta elettronica | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| offline_access | Delegato | I token di aggiornamento vengono archiviati nel database. | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| openid | Delegato | Credenziali di accesso | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| profile | Delegato | indirizzi di posta elettronica | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
