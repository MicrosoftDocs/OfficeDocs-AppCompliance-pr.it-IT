---
title: Informazioni sull'applicazione per gli amanti dell'intelligenza artificiale di Clovers
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/22/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per gli amanti della sicurezza, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003795" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Clovers AI a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Clovers |
| ID | WA200003795 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Clovers AI |
| Sito Web dell'azienda | [https://clovers.ai](https://clovers.ai) |
| Condizioni per l'utilizzo dell'app | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| Funzionalità di base dell'app | Clovers : la guida all'intervista per aiutare i team ad assumere in modo più efficiente |
...
Queste informazioni sono state fornite da Clovers AI su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2021-10-25 |
