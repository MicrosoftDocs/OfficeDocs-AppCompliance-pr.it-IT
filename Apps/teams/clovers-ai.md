---
title: Application Information for Clovers by Clovers AI
ms.author: elmalova
author: elenamalova
ms.date: 02/22/2022
ms.topic: article
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Clovers, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
ms.locfileid: "63081459"
---
# <a name="clovers"></a>Trifoglio

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: January 24, 2022</p>

* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">Visualizzazione in Teams store</a>
...
| Nome società partner | Clovers AI |
| Sito Web aziendale | [https://clovers.ai](https://clovers.ai) |
| Condizioni per l'uso dell'app | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| Funzionalità di base dell'app | Clovers - Guida al colloquio per aiutare i team ad assumere in modo più efficiente |
...
Queste informazioni sono state fornite da Clovers AI su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
