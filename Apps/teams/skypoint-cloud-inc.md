...
* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002580" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da SkyPoint Cloud Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | SkyPoint Cloud |
| ID | WA200002580 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | SkyPoint Cloud Inc. |
| Sito Web aziendale | [https://skypointcloud.com](https://skypointcloud.com) |
| Condizioni per l'uso dell'app | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| Funzionalità di base dell'app | SkyPoint aiuta i marchi a conoscere i propri clienti, a prendere decisioni strategiche e a intraprendere in modo coerente l'azione giusta per servire meglio i propri consumatori e continuare a far crescere le proprie aziende. We're a customer data platform that provides intelligent capabilities across data management and unification, privacy compliance, analytics and insights, and activation.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
...
Queste informazioni sono state fornite da SkyPoint Cloud Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
