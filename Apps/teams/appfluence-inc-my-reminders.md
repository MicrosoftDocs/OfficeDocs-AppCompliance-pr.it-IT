---
title: Informazioni sull'applicazione per i promemoria personali di Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per i promemoria personali, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656089"
---
# <a name="my-reminders"></a>Promemoria personali
...
* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693569f7fc3" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004342" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Promemoria personali |
| ID | WA200004342 |
...
| Condizioni per l'utilizzo dell'app | [https://teamsreminder.com/eula](https://teamsreminder.com/eula) |
| Funzionalità di base dell'app | Pianificare un messaggio di promemoria da inviare all'utente tramite il chat bot. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://teamsreminder.com](https://teamsreminder.com) |
...
| Quali dati vengono elaborati dall'app? | Elencare le chat dell'utente in Teams per consentire all'utente di indicare se un promemoria è correlato a una conversazione specifica. |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | next-auth/react |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | Delegato | Visualizzare l'utente che si trova in una chat in modo da comprendere se un promemoria è associato a una chat | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.Read | Delegato | Accedere all'utente e apprendere il nome dell'utente | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.ReadBasic.All | Delegato | Visualizzare l'avatar dei collaboratori correlati quando si pianificare un promemoria relativo a una chat personale con loro | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| offline_access | Delegato | Consenti all'app di agire come l'utente al momento pianificare per la consegna del promemoria | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| profile | Delegato | Accedere all'utente e apprendere il nome dell'utente | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
