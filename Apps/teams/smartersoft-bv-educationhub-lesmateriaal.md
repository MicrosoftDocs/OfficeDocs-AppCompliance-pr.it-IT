---
title: Informazioni sull'applicazione per EducationHUB Lesmateriaal di Smartersoft B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per EducationHUB Lesmateriaal, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Smartersoft B.V. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Smartersoft B.V. |
| Sito Web dell'azienda | [https://smartersoft.nl](https://smartersoft.nl) |
| Condizioni per l'utilizzo dell'app | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| Funzionalità di base dell'app | Consentire alle scuole di fornire l'accesso diretto al contenuto digitale fornito dalla scuola invece di forzare gli studenti a un altro sito Web. |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
Queste informazioni sono state fornite da Smartersoft B.V. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | ID utente, appartenenza al gruppo, contenuto personale aggiunto all'applicazione |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID utente, ID gruppo, collegamenti forniti dall'utente al contenuto dell'istituto di istruzione digitale |
...
| Elencare i tipi di criteri supportati | Tutti, la piattaforma Microsoft è responsabile di darci un token per un utente. L'amministratore decide in che modo l'utente viene convalidato o forzato a usare l'autenticazione a più fattori |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Delegato | Accedere alle informazioni salvate negli attributi dell'estensione del gruppo | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | Delegato | Informazioni sui team degli utenti | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | Delegato | Accesso | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
