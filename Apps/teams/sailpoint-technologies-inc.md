---
title: Informazioni sull'applicazione per Sailpoint di SailPoint Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Sailpoint, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64875343"
---
# <a name="sailpoint"></a>Sailpoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 3 maggio 2021</p>

* <a href="https://teams.microsoft.com/l/app/ceca14aa-4fd9-4a8b-b51f-ee05bf98accc" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002761" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da SailPoint Technologies, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Sailpoint |
| ID | WA200002761 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SailPoint Technologies, Inc. |
| Sito Web dell'azienda | [https://sailpoint.com](https://sailpoint.com) |
| Condizioni per l'utilizzo dell'app | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| Funzionalità di base dell'app | La soluzione di sicurezza delle identità di SailPoint unisce la gestione degli accessi alla sicurezza delle identità, garantendo ai lavoratori l'accesso corretto per svolgere il proprio lavoro&#8211;non più, non meno. |
...
Queste informazioni sono state fornite da SailPoint Technologies, Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC1 più recente | 2020-10-31 |
