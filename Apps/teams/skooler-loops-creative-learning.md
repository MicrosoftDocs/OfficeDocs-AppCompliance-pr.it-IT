---
title: Informazioni sull'applicazione per cicli - Creative Learning di Skooler
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Loops - Creative Learning, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d612b92e-2828-4a94-9e83-92dee316bdb3" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Loops - Creative Learning |
| ID | WA200003074 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Skooler |
| Sito Web dell'azienda | [https://www.loopseducation.com](https://www.loopseducation.com) |
| Condizioni per l'utilizzo dell'app | [https://www.loopseducation.com/assets/terms.en-US.201126.pdf](https://www.loopseducation.com/assets/terms.en-US.201126.pdf) |
| Funzionalità di base dell'app | I cicli sono uno strumento per l'insegnamento e l'apprendimento attraverso mappe mentali interattive. |
| Sede centrale dell'azienda | Svezia |
| Pagina delle informazioni sull'app | |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | AWS, GleSYS |
...
Queste informazioni sono state fornite da Skooler su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | UPN per consentire l'accesso con Microsoft. Nome e cognome specificati per la precompilazione del profilo. | [dc171e47-c074-4bc2-9e7b-3856b71e0630](../azure/dc171e47-c074-4bc2-9e7b-3856b71e0630.md) |
