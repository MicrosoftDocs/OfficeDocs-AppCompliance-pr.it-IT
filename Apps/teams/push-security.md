---
title: Informazioni sull'applicazione per la sicurezza push tramite sicurezza push
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Push Security, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66817693"
---
# <a name="push-security"></a>Sicurezza push
...
* <a href="https://teams.microsoft.com/l/app/db06ca6c-96a2-48ef-804e-54295b5c035a" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002833" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Push Security in Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Sicurezza push |
| ID | WA200002833 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Sicurezza push |
| Sito Web dell'azienda | [https://pushsecurity.com](https://pushsecurity.com) |
| Condizioni per l'utilizzo dell'app | [https://pushsecurity.com/legal/terms/](https://pushsecurity.com/legal/terms/) |
| Funzionalità di base dell'app | Aiutiamo le aziende a essere più produttive con SaaS dotando i dipendenti di usare le app in modo sicuro. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://pushsecurity.com/kb/10004/](https://pushsecurity.com/kb/10004/) |
...
Queste informazioni sono state fornite da Push Security su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Il push elabora l'orario di lavoro del cliente per fornire avvisi quando il cliente lavora.  |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Push archivia l'orario di lavoro del cliente per fornire avvisi quando il cliente sta lavorando.  |
...
| URL dell'informativa sulla privacy | https://pushsecurity.com/legal/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Applicazione | Elencare i canali per semplificare l'installazione del bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| MailboxSettings.Read | Applicazione | Eseguire query sull'orario di lavoro del cliente in modo che non vengano visualizzati messaggi dopo ore | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| Team.ReadBasic.All | Applicazione | Elencare i team per semplificare l'installazione del bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForTeam.All | Applicazione | Consentire al bot di installarsi per un team | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | Applicazione | Consentire al bot di installarsi per un utente | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| User.Read.All | Applicazione | Elencare gli utenti in modo che sia possibile inviare messaggi | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
