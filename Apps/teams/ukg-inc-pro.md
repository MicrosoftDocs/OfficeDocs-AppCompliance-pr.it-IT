---
title: Informazioni sull'applicazione per UKG Pro da UKG, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per ukg Pro, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f2120944-5201-4c71-8314-770f7806fff0" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | UKG Pro |
| ID | WA200003173 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | UKG, Inc. |
| Sito Web dell'azienda | [https://ukg.com](https://ukg.com) |
| Condizioni per l'utilizzo dell'app | [https://ukg.com](https://ukg.com) |
| Funzionalità di base dell'app | Accedere facilmente alle informazioni sui dipendenti, visualizzare i dettagli di pagamento e completare altre azioni delle risorse umane su richiesta. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://ukg.com](https://ukg.com) |
...
Queste informazioni sono state fornite da UKG, Inc. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
