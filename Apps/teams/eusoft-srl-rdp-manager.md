---
title: Informazioni sull'applicazione per Eusoft Rdp Manager di Eusoft S.r.l.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Eusoft Rdp Manager, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cbe80cd5-d89b-45e4-9d24-345b43378b9d" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004321" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Eusoft S.r.l. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Eusoft Rdp Manager |
| ID | WA200004321 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Eusoft S.r.l. |
| Sito Web dell'azienda | [https://www.eusoft.it](https://www.eusoft.it) |
| Condizioni per l'utilizzo dell'app | [https://www.eusoft.co.uk/privacy-cookies/](https://www.eusoft.co.uk/privacy-cookies/) |
| Funzionalità di base dell'app | Eusoft.Lab RDP Manager è l'app sviluppata da Eusoft per la visualizzazione dei report di test |
...
Queste informazioni sono state fornite da Eusoft S.r.l. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.eusoft.co.uk/privacy-cookies |
