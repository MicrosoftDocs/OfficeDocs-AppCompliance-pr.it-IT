---
title: Application Information for Skoach by Cultify, Lda
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Skoach, i criteri di gestione dei dati, le informazioni del catalogo app di Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/401ece51-d146-4cfb-b426-d7c8b70b056b" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003455" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Cultify, Lda a Microsoft:
...
| Nome società partner | Cultify, Lda |
| Sito Web aziendale | [https://skoach.com](https://skoach.com) |
| Condizioni per l'uso dell'app | [https://www.skoach.com/terms-of-service](https://www.skoach.com/terms-of-service) |
| Funzionalità di base dell'app | Skoach è un tecnico virtuale sul lavoro per mantenere i team uniti, allineati e produttivi che spinge le persone ad adottare nuovi comportamenti, in base ai risultati ricorrenti del sondaggio. Skoach non solo aumenta il flusso di comunicazione dei team, portando all'appartenenza e all'allineamento, ma aiuta anche le persone ad affrontare le nuove sfide che si presentano con il lavoro ibrido, aumentando la produttività di &amp; conservazione. |
...
Queste informazioni sono state fornite da Cultify, Lda su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Nomi dei clienti e, se forniti, messaggi di posta elettronica. |
...
| URL dell'informativa sulla privacy | https://www.skoach.com/privacy-policy |
