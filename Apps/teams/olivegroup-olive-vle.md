...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per OLIVE VLE, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64877613"
---
# <a name="olive-vle"></a>OLIVE VLE

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 12 luglio 2021</p>

* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da OliveGroup a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | OLIVE VLE |
| ID | WA200003331 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | OliveGroup |
| Sito Web dell'azienda | [https://www.olivegroup.io](https://www.olivegroup.io) |
| Condizioni per l'utilizzo dell'app | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| Funzionalità di base dell'app | Olive VLE aiuta i tutor e i fornitori di istruzione a creare e gestire corsi, programmi di apprendistato e studenti. Gli amministratori dei provider di istruzione possono creare corsi online, test, assegnazioni, programmi e assegnarli agli studenti. Microsoft Teams è integrato usando API Graph in modo che gli amministratori possano anche creare una classe video all'interno di Teams e invitare gli studenti alla classe video. Gli studenti possono visualizzare e seguire i corsi, i programmi e gestire le evidenze del portfolio. Gli amministratori possono anche pubblicare feed di notizie. |
...
Queste informazioni sono state fornite da OliveGroup sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
