...
description: Tutte le informazioni di sicurezza e conformità disponibili per Attensa, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0c42cdbf-56a5-4cdb-ae89-9253cb8138f0" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Attensa |
| ID | WA200003148 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Attensa Corporation |
| Sito Web dell'azienda | [https://attensa.com](https://attensa.com) |
| Condizioni per l'utilizzo dell'app | [https://attensa.com/terms/](https://attensa.com/terms/) |
| Funzionalità di base dell'app | Mantenere i team informati e aggiornati sulle notizie e le informazioni incentrate sul progetto con i briefing di Attensa in |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://attensa.com/product/](https://attensa.com/product/) |
...
Queste informazioni sono state fornite da Attensa Corporation sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
