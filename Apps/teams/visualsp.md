...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per VisualSP, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f656b280-46c5-11ea-9317-4db94d176db2" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001426" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da VisualSP a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | VisualSP |
| ID | WA200001426 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | VisualSP |
| Sito Web dell'azienda | [https://visualsp.com](https://visualsp.com) |
| Condizioni per l'utilizzo dell'app | [https://www.visualsp.com/terms-of-service](https://www.visualsp.com/terms-of-service) |
| Funzionalità di base dell'app | Fornire l'accesso immediato a Microsoft 365 contenuto di training dell'utente finale e al proprio training personalizzato |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.visualsp.com/products/microsoft-teams-training/](https://www.visualsp.com/products/microsoft-teams-training/) |
...
Queste informazioni sono state fornite da VisualSP su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Indirizzo di posta elettronica utente. |
| L'app supporta TLS 1.1 o versione successiva? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | nome utente e indirizzo di posta elettronica |
