...
* <a href="https://teams.microsoft.com/l/app/f656b280-46c5-11ea-9317-4db94d176db2" target="_blank">Visualizzazione in Teams store</a>
...
| Funzionalità di base dell'app | Fornire l'accesso istantaneo ai Microsoft 365 di formazione degli utenti finali e alla formazione personalizzata |
...
| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Esegui test di penetrazione annuali nell'app? |  |
...
| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app è conforme all'Health Insurance Portability and Accounting Act (HIPAA)? |  |
| L'app è conforme a Health Information Trust Alliance, Common Security Framework (HITRUST CSF)? |  |
...
| Eseguire valutazioni PCI DSS annuali sull'app e sull'ambiente di supporto? |  |
...
| L'app è conforme all'International Organization for Standardization (ISO 27017)? |  |
...
| L'app è conforme al Children's Online Privacy Protection Act (COPPA)? |  |
| L'app è conforme Sarbanes-Oxley Act (SOX)? |  |
...
| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'applicazione si integra con Microsoft Identity Platform (Azure AD) per single sign-on, accesso API e così via? |  |
...
| Le app e i componenti aggiuntivi per Microsoft 365 potrebbero usare API Microsoft aggiuntive al di fuori di Microsoft Graph. L'app o il componente aggiuntivo usa api Microsoft aggiuntive? |  |
