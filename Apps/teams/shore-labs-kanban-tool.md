---
title: Informazioni sull'applicazione per Kanban Tool by Shore Labs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Kanban Tool, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64877153"
---
# <a name="kanban-tool"></a>Kanban Tool

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 15 giugno 2021</p>

* <a href="https://teams.microsoft.com/l/app/b3c15d4f-1972-4836-a1eb-7575dd56a17e" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Kanban Tool |
| ID | WA200002121 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Shore Labs |
| Sito Web dell'azienda | [https://www.shorelabs.com](https://www.shorelabs.com) |
| Condizioni per l'utilizzo dell'app | [https://kanbantool.com/policy/terms-of-service](https://kanbantool.com/policy/terms-of-service) |
| Funzionalità di base dell'app | Visualizzare il lavoro e tenere traccia del tempo su una scheda kanban. |
| Sede centrale dell'azienda | Polonia |
| Pagina delle informazioni sull'app | [https://kanbantool.com](https://kanbantool.com) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | AWS, SelfHosted, GCP |
...
Queste informazioni sono state fornite da Shore Labs su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Delegato | Indirizzo di posta elettronica dell'utente per la comunicazione, la corrispondenza delle identità e il recapito delle notifiche. | [4e820d60-9e62-403c-accd-857b987cc13c](../azure/4e820d60-9e62-403c-accd-857b987cc13c.md) |
>| Team.ReadBasic.All | Delegato | Identificatori e nomi dei team di cui l'utente è membro diretto. Vengono usati per assegnare automaticamente gli utenti ai gruppi corretti nello strumento Kanban. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| User.Read | Delegato | Informazioni aziendali di base degli utenti connessi. Viene usato per popolare i dettagli dell'account per i nuovi account e per riconoscere gli utenti che appartengono all'organizzazione per fornire funzionalità single Sign-On. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| offline_access | Delegato | Consente la funzionalità "Accedi con Microsoft" e la sincronizzazione dei dati a cui hai concesso l'accesso all'app, all'accesso dell'utente. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| openid | Delegato | Aprire i token ID che consentono agli utenti di accedere all'app con gli account aziendali o dell'istituto di istruzione tramite il pulsante "Accedi con Microsoft". | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| profile | Delegato | Nome utente da ripopolare automaticamente nello strumento Kanban e mantenere sincronizzato con le modifiche apportate in Microsoft Teams. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
