---
title: Informazioni sull'applicazione per Photo Filer di Ichicraft
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Photo Filer, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Ichicraft a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Photo Filer |
| ID | WA200003881 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Ichicraft |
| Sito Web dell'azienda | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
| Condizioni per l'utilizzo dell'app | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| Funzionalità di base dell'app | Il modo più semplice per condividere e archiviare le tue foto in Microsoft Teams. |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
Queste informazioni sono state fornite da Ichicraft sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Delegato | Creazione di un messaggio di chat con un piccolo riepilogo delle foto caricate dall'utente. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | Delegato | Lettura della struttura di cartelle e caricamento di file nella raccolta documenti SharePoint. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | Delegato | Leggere dal profilo degli utenti. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
