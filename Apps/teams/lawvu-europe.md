---
title: Application Information for LawVu Europe by LawVu
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per LawVu Europe, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64769108"
---
# <a name="lawvu-europe"></a>LawVu Europe

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 22 febbraio 2022</p>

* <a href="https://teams.microsoft.com/l/app/ce6fa59d-9c48-492c-b0e2-434abe99c355" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003931" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | LawVu Europe |
| ID | WA200003931 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | LawVu |
| Sito Web dell'azienda | [https://lawvu.com](https://lawvu.com) |
| Condizioni per l'utilizzo dell'app | [https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-202...](https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-2021.pdf) |
| Funzionalità di base dell'app | Gli utenti aziendali possono generare richieste legali direttamente da Teams.  L'integrazione acquisisce tutti i campi pertinenti, inclusi il contenuto e gli eventuali allegati del messaggio originale, e crea la questione in LawVu in modo che&#8217;parte del team legale&#8217;sistema di registrazione. |
| Sede centrale dell'azienda | Nuova Zelanda |
| Pagina delle informazioni sull'app | [https://help.lawvu.com/en/articles/5953276-microsoft-teams-...](https://help.lawvu.com/en/articles/5953276-microsoft-teams-integration-coming-soon) |
...
Queste informazioni sono state fornite da LawVu su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | File allegato in MS Teams. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Il file allegato nei team ms viene estratto nell'archivio dati. |
...
| Sono state esaminate e rispettate tutte le procedure consigliate applicabili descritte nell'elenco di controllo di integrazione di Microsoft Identity Platform? | No |
