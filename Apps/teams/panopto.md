---
title: Informazioni sull'applicazione per Panopto di Panopto
ms.author: elmalova
author: elenamalova
ms.date: 03/07/2022
ms.topic: article
...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per Panopto, i relativi criteri di gestione dei dati, le informazioni del catalogo app di Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Panopto a Microsoft:
...
| Nome società partner | Panopto |
| Sito Web aziendale | [https://www.panopto.com](https://www.panopto.com) |
| Condizioni per l'uso dell'app | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| Funzionalità di base dell'app | Esporta Teams registrazioni in Panopto e cerca, condividi e visualizza i video di Panopto senza lasciare Teams.  Aggiunge funzionalità come l'indice visivo di ogni riunione e i sottotitoli codificati verificati dall'utente. Accedere alle funzionalità di Panopto senza uscire da Teams: creare una nuova scheda del canale mappata a una cartella Panopto, cercare e condividere video Panopto, presentare video Panopto nelle riunioni pianificate e ricevere notifiche quando è pronto un nuovo video Panopto. Serve un sito Panopto? Visita www.panopto.com/plans per iniziare. |
...
Queste informazioni sono state fornite da Panopto su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Metadati su Teams registrazioni di riunioni e Teams canali. |
...
| Data di certificazione SOC2 più recente |  2021-08-19 |
| L'app è conforme ai controlli dell'organizzazione del servizio (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente |  2021-10-13 |
...
| URL dell'informativa sulla privacy | https://www.panopto.com/privacy/ |
