---
title: Informazioni sull'applicazione per GitHub da Microsoft Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per GitHub, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ca9e26b7-dce5-44a0-b2b7-a70a3d65ce25" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002077" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Microsoft Corporation a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | GitHub |
| ID | WA200002077 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Microsoft Corporation |
| Sito Web dell'azienda | [https://github.com](https://github.com) |
| Condizioni per l'utilizzo dell'app | [https://github.com/site/terms](https://github.com/site/terms) |
| Funzionalità di base dell'app | GitHub è una piattaforma di hosting del codice per la collaborazione e il controllo della versione. Consente agli sviluppatori di collaborare ai propri progetti direttamente dalla pianificazione e dalla scrittura di codice alla spedizione del software. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://teams.github.com](https://teams.github.com) |
...
Queste informazioni sono state fornite da Microsoft Corporation su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
