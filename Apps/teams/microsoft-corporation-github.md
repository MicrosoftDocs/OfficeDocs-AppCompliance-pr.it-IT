---
title: Application Information for GitHub by Microsoft Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per GitHub, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ca9e26b7-dce5-44a0-b2b7-a70a3d65ce25" target="_blank">Visualizzazione in Teams store</a>
...
| Sito Web aziendale | [https://github.com](https://github.com) |
| Condizioni per l'uso dell'app | [https://github.com/site/terms](https://github.com/site/terms) |
| Funzionalità di base dell'app | GitHub è una piattaforma di hosting di codice per la collaborazione e il controllo della versione. Consente agli sviluppatori di collaborare ai propri progetti direttamente dalla pianificazione e codifica alla spedizione del software. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://teams.github.com](https://teams.github.com) |
...
Queste informazioni sono state fornite da Microsoft Corporation su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
