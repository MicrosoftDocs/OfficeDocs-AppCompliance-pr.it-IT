---
title: 'Informazioni sull''applicazione per 1Page di OAYAW, Inc.'
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: 'Tutte le informazioni di sicurezza e conformità disponibili per 1Page, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.'
...
* <a href="https://teams.microsoft.com/l/app/2b876f4d-2e6b-4ee7-9b09-8893808c1380" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003900" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da OAYAW, Inc. a Microsoft:
...
| Nome società partner | OAYAW, Inc. |
| Sito Web aziendale | [https://www.get1page.com](https://www.get1page.com) |
| Condizioni per l'uso dell'app | [https://www.get1page.com/en/terms-of-use](https://www.get1page.com/en/terms-of-use) |
| Funzionalità di base dell'app | Sovrapprezzo delle riunioni con 1Pagina &amp; di avvio delle conversazioni di riepilogo, minuti prima di ogni riunione |
| Sede centrale dell'azienda | Stati Uniti of America |
| Pagina delle informazioni dell'app | [https://www.get1page.com](https://www.get1page.com) |
...
Queste informazioni sono state fornite da OAYAW, Inc. Sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Indirizzo di posta elettronica, nome, eventi del calendario |
| Se l'infastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove sono archiviati geograficamente? | Francia |
...
| URL dell'informativa sulla privacy | https://www.get1page.com/en/privacy-policy |
...
| Elencare i tipi di criteri supportati | In base alle applicazioni che hanno connesso e agli elementi in-app acquistati, l'utente sarà in grado di visualizzare o meno schede specifiche. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegated | Con le informazioni del calendario, saremo in grado di fornire dati pertinenti per gli utenti della riunione. | [d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73](../azure/d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73.md) |
