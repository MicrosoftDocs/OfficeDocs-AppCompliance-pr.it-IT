...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per ThoughtWire EWS, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 17 giugno 2021</p>

* <a href="https://teams.microsoft.com/l/app/ed27363f-755e-4658-b7bf-409d475959d6" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | ThoughtWire EWS |
| ID | WA200003239 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | ThoughtWire Corp. |
| Sito Web dell'azienda | [https://thoughtwire.com](https://thoughtwire.com) |
| Condizioni per l'utilizzo dell'app | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| Funzionalità di base dell'app | L'app ThoughtWire supporta EarlyWarning, uno strumento avanzato di rilevamento e intervento che ha dimostrato di ridurre del 61% gli eventi blu del codice. La soluzione di avviso rapido è progettata per rilevare il deterioramento dei pazienti in base ai dati vitali dei pazienti, informare i medici degli eventi negativi sulla salute e consentire loro di intervenire. Il personale del team di risposta ha accesso al contesto del paziente e è consapevole dello stato e della disponibilità del team che risponde, consentendo flussi di lavoro di risposta e assistenza ai pazienti semplificati. |
...
Queste informazioni sono state fornite da ThoughtWire Corp. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | Applicazione | Consente all'applicazione di creare gruppi/team per reparti/unità ospedaliere. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | Applicazione | Obbligatorio per consentire all'applicazione di determinare quali gruppi potrebbe essere necessario creare/ricreare e gestire l'appartenenza. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | Applicazione | Obbligatorio in modo che l'applicazione possa gestire l'appartenenza ai gruppi. ad esempio l'aggiunta o la rimozione di infermieri da un team quando cambiano i turni. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | Applicazione | Obbligatorio in modo che l'applicazione possa gestire l'appartenenza ai gruppi. ad esempio l'aggiunta o la rimozione di infermieri da un team quando cambiano i turni. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamsAppInstallation.ReadWriteForTeam | Applicazione | Consente all'applicazione di installare automaticamente il bot ThoughtWire nei team creati/gestiti. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| User.Read | Applicazione | Consentire all'applicazione di recuperare l'AADID/nome utente di un utente in base alle esigenze durante la gestione dell'appartenenza e/o il recupero del nome utente per identificare l'utente all'interno dell'applicazione. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
