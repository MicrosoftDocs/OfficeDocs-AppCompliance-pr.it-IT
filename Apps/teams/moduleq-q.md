---
title: Informazioni sull'applicazione per Q by ModuleQ
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Q, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64878613"
---
# <a name="q"></a>Q

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 29 gennaio 2022</p>

* <a href="https://teams.microsoft.com/l/app/72bb25c7-3644-4318-8249-a08e5493a520" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://moduleq.com](https://moduleq.com) |
| Condizioni per l'utilizzo dell'app | [https://moduleq.com/terms-of-service](https://moduleq.com/terms-of-service) |
| Funzionalità di base dell'app | Q funziona come un collega attendibile, monitorando l'attenzione del cliente e inviando le notizie aziendali che è necessario visualizzare prima di dover chiedere. Basato su ModuleQ AI e Knowledge Graph di Thomson Reuters. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://moduleq.com/product](https://moduleq.com/product) |
...
Queste informazioni sono state fornite da ModuleQ sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente, metadati di posta elettronica utente, metadati del calendario utente |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati del profilo utente, metadati di posta elettronica utente, metadati del calendario utente |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | Microsoft.AspNetCore.Authentication.MicrosoftAccount |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Applicazione | Obbligatorio per la funzionalità del prodotto. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| Group.Read.All | Delegato | Obbligatorio per la funzionalità del prodotto. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| Mail.Read | Applicazione | Obbligatorio per la funzionalità del prodotto. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| User.Read | Delegato | Obbligatorio per la funzionalità del prodotto. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| User.Read.All | Delegato | Obbligatorio per la funzionalità del prodotto. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
