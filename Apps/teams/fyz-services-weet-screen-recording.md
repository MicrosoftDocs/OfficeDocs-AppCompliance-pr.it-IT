---
title: Informazioni sull'applicazione per la registrazione dello schermo weet da parte di FYZ SERVICES
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Tutte le informazioni disponibili sulla sicurezza e sulla conformità per Weet Screen Recording, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64878653"
---
# <a name="weet-screen-recording"></a>Weet Screen Recording

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 23 settembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/f0c0f156-329e-4083-a1a7-89649407a31b" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Weet Screen Recording |
| ID | WA200003284 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SERVIZI FYZ |
| Sito Web dell'azienda | [https://weet.co](https://weet.co) |
| Condizioni per l'utilizzo dell'app | [https://weet.co/terms-of-service/](https://weet.co/terms-of-service/) |
| Funzionalità di base dell'app | Weet, il primo registratore video dello schermo &amp; collaborativo semplice, registrazione dello schermo gratuita e illimitata |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://weet.co/weet-teams-integration/](https://weet.co/weet-teams-integration/) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | GCP, AWS |
...
Queste informazioni sono state fornite da FYZ SERVICES su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-12-15 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | Delegato | Consenti di rilevare se l'app weet è già installata | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | Delegato | Non raccogliamo dati, ma usiamo la posta elettronica solo per aiutare l'utente con la funzionalità di completamento automatico | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | Delegato | Non raccogliamo dati, ma usiamo la posta elettronica solo per aiutare l'utente con la funzionalità di completamento automatico | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | Delegato | Non raccogliamo dati, ma usiamo la posta elettronica solo per aiutare l'utente con la funzionalità di completamento automatico | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| openid | Delegato | Non raccogliamo dati, ma usiamo la posta elettronica solo per aiutare l'utente con la funzionalità di completamento automatico | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| profile | Delegato | Non raccogliamo dati, ma usiamo la posta elettronica solo per aiutare l'utente con la funzionalità di completamento automatico | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
