---
title: Informazioni sull'applicazione per Grafana OnCall di Grafana Labs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Grafana OnCall, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed13a4a6-7d9c-4904-913c-402dbca12d1e" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004307" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Grafana Labs a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Grafana OnCall |
| ID | WA200004307 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Grafana Labs |
| Sito Web dell'azienda | [https://grafana.com](https://grafana.com) |
| Condizioni per l'utilizzo dell'app | [https://grafana.com/legal/terms/](https://grafana.com/legal/terms/) |
| Funzionalità di base dell'app | Il modo più semplice per eseguire la gestione delle chiamate |
...
Queste informazioni sono state fornite da Grafana Labs sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://grafana.com/legal/terms |
...
| Agli utenti viene fornita un'opzione per l'oggetto dell'elaborazione? | No |
