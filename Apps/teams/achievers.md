---
title: Informazioni sull'applicazione per i responsabili del raggiungimento da parte dei responsabili del raggiungimento
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per achiever, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66912923"
---
# <a name="achievers"></a>Achievers
...
* <a href="https://teams.microsoft.com/l/app/76903584-359f-4e1e-9f6e-741f48322709" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000573" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Achiever a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Achievers |
| ID | WA200000573 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Achievers |
| Sito Web dell'azienda | [https://www.achievers.com](https://www.achievers.com) |
| Condizioni per l'utilizzo dell'app | [https://developer.achievers.com/docs/achievers-terms-of-use](https://developer.achievers.com/docs/achievers-terms-of-use) |
| Funzionalità di base dell'app | Creare il riconoscimento per i colleghi nella piattaforma Achievers con meno attriti all'interno dell'ecosistema Microsoft. |
| Sede centrale dell'azienda | Canada |
| Pagina delle informazioni sull'app | [https://www.achievers.com/connect/teams/](https://www.achievers.com/connect/teams/) |
...
Queste informazioni sono state fornite da Achievers su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID tenant, ID utente, Indirizzo di posta elettronica utente, Impostazioni locali utente, ID bot, Nome bot, URL del servizio Bot |
...
| Data di certificazione SOC2 più recente | 2021-12-25 |
...
| URL dell'informativa sulla privacy | https://over.achievers.com/ilr_privacy_policy |
