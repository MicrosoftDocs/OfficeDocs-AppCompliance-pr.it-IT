...
description: Tutte le informazioni di sicurezza e conformità disponibili per Weekly10, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880278"
---
# <a name="weekly10"></a>Weekly10

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 19 agosto 2021</p>

* <a href="https://teams.microsoft.com/l/app/c80cee99-d17f-4b2d-a2a4-57652ffd2a4b" target="_blank">Visualizza in Teams store</a>
...
Informazioni fornite da Binary Geek Limited per Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Weekly10 |
| ID | WA200001441 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Binary Geek Limited |
| Sito Web dell'azienda | [https://www.weekly10.com](https://www.weekly10.com) |
| Condizioni per l'utilizzo dell'app | [https://www.weekly10.com/terms/customer](https://www.weekly10.com/terms/customer) |
| Funzionalità di base dell'app | Aumentare il feedback, gestire le prestazioni e misurare l'engagement dei dipendenti tramite check-in settimanali. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.weekly10.com/integrations/microsoft-teams/](https://www.weekly10.com/integrations/microsoft-teams/) |
...
Queste informazioni sono state fornite da Binary Geek Limited su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Applicazione | Sincronizzazione degli utenti da Azure AD a Weekly10 (facoltativo) | [2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb](../azure/2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb.md) |
>| Calendars.ReadWrite | Applicazione | Controllo della disponibilità dei dipendenti e prenotazione automatica delle riunioni (facoltativo). | [494610b2-b490-4f54-8384-312d6f9b4869](../azure/494610b2-b490-4f54-8384-312d6f9b4869.md) |
>| User.Read | Delegato | Verifica dell'utente ai fini dell'accesso Single Sign-On nel Azure AD. | [6fd1421e-89e8-4a8b-bd01-9397656a50d5](../azure/6fd1421e-89e8-4a8b-bd01-9397656a50d5.md) |
