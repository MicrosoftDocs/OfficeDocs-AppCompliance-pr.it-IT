...
description: Tutte le informazioni di sicurezza e conformità disponibili per NE, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">Visualizza in Teams store</a>
...
| Nome della società partner | NE |
| Sito Web dell'azienda | [https://www.ne.se](https://www.ne.se) |
| Condizioni per l'utilizzo dell'app | [https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillk...](https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillkor/fleranv%c3%a4ndare/) |
| Funzionalità di base dell'app | Un'app teams che consente ai clienti NE di accedere ai propri servizi di contenuto dall'interno dei team. Aggiunge anche un'estensione di messaggio di Teams che consente agli utenti di eseguire ricerche nell'enciclopedia NE digitando @ne in una chat. |
| Sede centrale dell'azienda | Svezia |
| Pagina delle informazioni sull'app | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
...
Queste informazioni sono state fornite da NE su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
