---
title: Informazioni sull'applicazione per MyCheckins di Cloud Catalogs LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per MyCheckins, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Cloud Catalogs LLC a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | MyCheckins |
| ID | WA200004375 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Cloud Catalogs LLC |
| Sito Web dell'azienda | [https://mycheckins.io](https://mycheckins.io) |
| Condizioni per l'utilizzo dell'app | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| Funzionalità di base dell'app | Eseguire stand-up asincroni, retrospettive e altro ancora in Microsoft Teams. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://mycheckins.io](https://mycheckins.io) |
...
Queste informazioni sono state fornite da Cloud Catalogs LLC sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati profilo utente, Email utente, Messaggi utente inviati al bot |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati profilo utente, Email utente, Messaggi utente inviati al bot |
...
| URL dell'informativa sulla privacy | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Applicazione | Recupero dei dettagli utente, ad esempio nome, cognome e indirizzo di posta elettronica | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |
