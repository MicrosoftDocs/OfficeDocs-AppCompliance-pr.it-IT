...
description: Tutte le informazioni di sicurezza e conformità disponibili per Switchvox, i criteri di gestione dei dati, le informazioni del catalogo app di Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eb668aa5-abb2-445c-81b4-3c174db84fe2" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001535" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Sangoma a Microsoft:
...
| Nome società partner | Sangoma |
| Sito Web aziendale | [https://www.sangoma.com](https://www.sangoma.com) |
...
Queste informazioni sono state fornite da Sangoma su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Record della cronologia delle chiamate (inclusi numero, nome, e-mail di contatto) per le chiamate avviate tramite applicazione |
...
| URL dell'informativa sulla privacy | https://cdn.sangoma.com/wp-content/uploads/Privacy-Policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | delegated | Eseguire la ricerca dei contatti nella directory |
>| Group.Read.All | delegated | Eseguire la risoluzione dei membri del gruppo |
>| Chat.Read | delegated | Eseguire la risoluzione dei membri della chat |
