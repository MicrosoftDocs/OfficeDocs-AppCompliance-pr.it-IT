...
description: Tutte le informazioni di sicurezza e conformità disponibili per Workboard, i relativi criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://www.workboard.com](https://www.workboard.com) |
| Condizioni per l'uso dell'app | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| Funzionalità di base dell'app | Allineare le priorità strategiche all'interno dell'organizzazione e localizzare obiettivi e risultati chiave (OKR) a team e singoli utenti interfunzionanti. Grafico, calcolo e condivisione dello stato di avanzamento sui risultati chiave e sulle metriche di successo.  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | indirizzo di posta elettronica e ID degli utenti.  Viene usato per mappare l'utente all'ID utente di WorkBoard | [User.Read](https://docs.microsoft.com/microsoft-365-app-certification/azure/User.Read) |
