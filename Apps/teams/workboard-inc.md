...
| Pagina delle informazioni dell'app | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | indirizzo di posta elettronica e ID degli utenti.  Viene usato per mappare l'utente all'ID utente di WorkBoard | [User.Read](../azure/User.Read.md) |
