...
description: Tutte le informazioni di sicurezza e conformità disponibili per Workboard, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
| Nome della società partner | Workboard Inc. |
| Sito Web dell'azienda | [https://www.workboard.com](https://www.workboard.com) |
| Condizioni per l'utilizzo dell'app | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| Funzionalità di base dell'app | Allineare le priorità strategiche attraverso l'organizzazione e localizzare gli obiettivi e i risultati chiave (OKR) per team e singoli utenti interfunzionali. Grafico, calcolo e condivisione dello stato dei risultati chiave e delle metriche di successo.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
Queste informazioni sono state fornite da Workboard Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC1 più recente | 2020-07-31 |
| L'app è conforme ai controlli dell'organizzazione del servizio (SOC 2)? | Sì |
| Data di certificazione SOC2 più recente | 2020-10-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | indirizzo di posta elettronica e id degli utenti.  Viene usato per eseguire il mapping dell'utente all'ID utente di WorkBoard | [](../azure/.md) |
