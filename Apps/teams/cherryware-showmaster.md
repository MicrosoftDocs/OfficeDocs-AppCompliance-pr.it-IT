---
title: Informazioni sull'applicazione per Showmaster by cherryware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
ms.locfileid: "66892039"
---
# <a name="showmaster"></a>Showmaster

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 5 luglio 2022</p>

* <a href="https://teams.microsoft.com/l/app/8c9f8e8e-fe2d-4542-84ab-1d30c4a735fc" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004411" target="_blank">Visualizzazione in AppSource</a>
...
| Funzionalità di base dell'app | Showmaster crea un'emozionante cornice intorno al tuo discorso durante il tempo di attesa e rompe con titoli, conto alla rovescia, musica e altro ancora. |
