...
* <a href="https://teams.microsoft.com/l/app/73ee6b52-6b68-41c1-a7c5-91919e05b845" target="_blank">Visualizzazione in Teams store</a>
...
| Nome società partner | European Code Factory s.r.o. |
| Sito Web aziendale | [https://ecodef.cz](https://ecodef.cz) |
| Condizioni per l'uso dell'app | [https://ecodef.cz/terms_of_use.html](https://ecodef.cz/terms_of_use.html) |
| Funzionalità di base dell'app | Gestione password |
| Sede centrale dell'azienda | Cecoslovacchia |
| Pagina delle informazioni dell'app | [https://vimheslo.cz](https://vimheslo.cz) |
...
Queste informazioni sono state fornite da European Code Factory s.r.o. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
