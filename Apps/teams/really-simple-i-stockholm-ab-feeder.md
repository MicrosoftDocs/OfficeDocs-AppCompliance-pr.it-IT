---
title: Informazioni sull'applicazione per Feeder di Really Simple i Stockholm AB
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Feeder, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66246013"
---
# <a name="feeder"></a>Alimentatore
...
* <a href="https://teams.microsoft.com/l/app/6810f6a8-1f9a-4504-a916-e2d9814062e0" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004254" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Really Simple i Stockholm AB a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Alimentatore |
| ID | WA200004254 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Davvero semplice i Stoccolma AB |
| Sito Web dell'azienda | [https://feeder.co](https://feeder.co) |
| Condizioni per l'utilizzo dell'app | [https://feeder.co/teams-license](https://feeder.co/teams-license) |
| Funzionalità di base dell'app | Ottenere gli aggiornamenti delle notizie dai feed RSS e da altre origini digitali |
...
| Quali provider di servizi cloud di hosting usano l'app? | OVH, DigitalOcean, Aws |
...
Queste informazioni sono state fornite da Really Simple i Stockholm AB su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Posta elettronica, indirizzo IP, ID tenant |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Posta elettronica, ID tenant |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Canada, Francia |
...
| URL dell'informativa sulla privacy | https://feeder.co/help/legal/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | entrambi | Autenticazione e accesso utente | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| email | Delegato | Autenticazione e accesso utente | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| openid | entrambi | Autenticazione e accesso utente | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| profile | entrambi | Autenticazione e accesso utente | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
