...
description: Tutte le informazioni di sicurezza e conformità disponibili per DBit, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64876433"
---
# <a name="dbit"></a>DBit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 24 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| Condizioni per l'utilizzo dell'app | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| Funzionalità di base dell'app | Soluzioni di gestione delle password DBit con meno problemi. DBit è uno strumento di gestione delle password per team di piccole e grandi dimensioni. Con DBit è possibile condividere in modo sicuro le password tra i membri del team. Le password condivise e le password generate scadranno automaticamente dopo una durata di minuti impostata. Le password vengono crittografate in memoria nei server e non vengono mai archiviate nell'archiviazione su disco. Una volta scaduto, le password vengono rimosse dalla memoria del server. Questa app è sviluppata da Diamondsoft Solutions, LLC |
...
Queste informazioni sono state fornite da Diamondsoft Solutions, LLC su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | TenantId |
