---
title: Application Information for Are You Cassaforte? by Avista Technology Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: 'Tutte le informazioni di sicurezza e conformità disponibili per Sei Cassaforte?, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.'
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">Visualizzazione in Teams store</a>
...
| Nome società partner | Soluzioni per la tecnologia Avista |
| Sito Web aziendale | [https://safetybot.in](https://safetybot.in) |
| Condizioni per l'uso dell'app | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| Funzionalità di base dell'app | &quot;AreYouSafe?&quot; bot è l'assistente personalizzato per la gestione delle crisi. Ideale per gli amministratori della sicurezza e il personale delle risorse umane da configurare e utilizzare durante le emergenze.  Non hai bisogno di altro software o servizio per usare questa app. Il bot è facile da usare ed evita di dover scambiare tra app Teams ed esterne durante la crisi.  Usa il bot per conoscere lo stato dei dipendenti interessati da un incidente grave. &quot;AreYouSafe?&quot; bot consente di offrire assistenza a chi ne ha bisogno fornendo aggiornamenti in tempo reale. |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni dell'app | [https://safetybot.in](https://safetybot.in) |
...
Queste informazioni sono state fornite da Avista Technology Solutions su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
