---
title: Informazioni sull'applicazione per Are You Cassaforte? di Avista Technology Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Are You Cassaforte?, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="are-you-safe"></a>sei al sicuro?
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003863" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Avista Technology Solutions a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | sei al sicuro? |
| ID | WA200003863 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Soluzioni per la tecnologia Avista |
| Sito Web dell'azienda | [https://safetybot.in](https://safetybot.in) |
| Condizioni per l'utilizzo dell'app | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| Funzionalità di base dell'app | &quot;AreYouSafe?&quot; bot è l'assistente personalizzato per la gestione delle crisi. Ideale per gli amministratori della sicurezza e il personale delle risorse umane da configurare e usare durante le emergenze.  Non è necessario alcun altro software o servizio per usare questa app. Il bot è facile da usare ed evita di dover scambiare tra Teams e app esterne durante la crisi.  Usare il bot per conoscere lo stato dei dipendenti interessati da un evento imprevisto grave. &quot;AreYouSafe?&quot; il bot consente di offrire assistenza a coloro che ne hanno bisogno fornendo aggiornamenti in tempo reale. |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://safetybot.in](https://safetybot.in) |
...
Queste informazioni sono state fornite da Avista Technology Solutions su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
