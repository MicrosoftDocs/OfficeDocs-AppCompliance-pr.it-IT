---
title: Informazioni sull'applicazione per Teamble by Teamble
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Teamble, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ee7907e3-f0b3-4e18-b882-baa83e87812f" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Teamble |
| ID | WA200002259 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Teamble |
| Sito Web dell'azienda | [https://teamble.com](https://teamble.com) |
| Condizioni per l'utilizzo dell'app | [https://teamble.com/#/terms-of-service](https://teamble.com/#/terms-of-service) |
| Funzionalità di base dell'app | Teamble rende 360 feedback semplice, continuo e di impatto. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://teamble.com](https://teamble.com) |
...
Queste informazioni sono state fornite da Teamble su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
