...
description: Tutte le informazioni di sicurezza e conformità disponibili per Teamble, i relativi criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://teamble.com](https://teamble.com) |
| Condizioni per l'uso dell'app | [https://teamble.com/#/terms-of-service](https://teamble.com/#/terms-of-service) |
| Funzionalità di base dell'app | Teamble rende 360 feedback semplice, continuo e di impatto. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://teamble.com](https://teamble.com) |
