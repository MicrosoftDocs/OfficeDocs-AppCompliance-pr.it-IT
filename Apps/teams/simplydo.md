---
title: Informazioni sull'applicazione per SimplyDo di SimplyDo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SimplyDo, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66248885"
---
# <a name="simplydo"></a>SimplyDo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 14 marzo 2022</p>

* <a href="https://teams.microsoft.com/l/app/dbf692fe-35c1-4511-9178-9131e6511712" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004248" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da SimplyDo a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | SimplyDo |
| ID | WA200004248 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SimplyDo |
| Sito Web dell'azienda | [https://www.simplydo.co.uk](https://www.simplydo.co.uk) |
| Condizioni per l'utilizzo dell'app | [https://www.simplydo.co.uk/terms-of-use](https://www.simplydo.co.uk/terms-of-use) |
| Funzionalità di base dell'app | SimplyDo consente alle organizzazioni di acquisire idee e informazioni dettagliate da tutta la base del personale, potenziando il miglioramento continuo e l'innovazione. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.simplydo.co.uk/product](https://www.simplydo.co.uk/product) |
...
Queste informazioni sono state fornite da SimplyDo su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente (nome, reparto, titolo del processo, posta elettronica). |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Dati del profilo utente (nome, reparto, titolo del processo, posta elettronica) |
...
| URL dell'informativa sulla privacy | https://www.simplydo.co.uk/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Per accedere ai dati del profilo per l'accesso Single Sign-On | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| email | Delegato | Per supportare le funzionalità o l'accesso di OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| offline_access | Delegato | Per supportare le funzionalità o l'accesso di OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| openid | Delegato | Per supportare le funzionalità o l'accesso di OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
