---
title: Informazioni sull'applicazione per la riproduzione di IntraActive di Fellowmind Denmark
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/02/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Replay by IntraActive, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="replay-by-intraactive"></a>Replay by IntraActive
...
|:----------------|:-------------|
| Nome dell'app | Replay by IntraActive |
| ID | WA200004169 |
