---
title: Informazioni sull'applicazione per PayaFy di NimbleSoft Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per PayaFy, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003397" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da NimbleSoft Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | PayaFy |
| ID | WA200003397 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | NimbleSoft Inc. |
| Sito Web dell'azienda | [https://payafy.com](https://payafy.com) |
| Condizioni per l'utilizzo dell'app | [https://payafy.com/termsofservice](https://payafy.com/termsofservice) |
| Funzionalità di base dell'app | PayaFy consente alle aziende di accettare pagamenti. È possibile collegare un account Stripe esistente o registrarne uno nuovo. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://payafy.com](https://payafy.com) |
...
Queste informazioni sono state fornite da NimbleSoft Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Nome e indirizzo di posta elettronica |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome e indirizzo di posta elettronica |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | Entrambi | Leggerà le informazioni di base usate per la registrazione dell'utente. | [1e96a64b-9c1c-4cbc-b015-70243ea06c9b](../azure/1e96a64b-9c1c-4cbc-b015-70243ea06c9b.md) |
