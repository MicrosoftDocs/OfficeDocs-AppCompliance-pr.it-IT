...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per Training Assistant, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
ms.locfileid: "61350314"
---
# <a name="training-assistant"></a>Assistente formazione

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: August 2, 2021</p>

* <a href="https://teams.microsoft.com/l/app/40049dbc-3781-491d-ad2e-d59009538e45" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003547" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da The Bot Platform a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Assistente formazione |
| ID | WA200003547 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Piattaforma bot |
| Sito Web aziendale | [https://thebotplatform.com](https://thebotplatform.com) |
| Condizioni per l'uso dell'app | [https://thebotplatform.com/wp-content/uploads/2021/11/TBP-T...](https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Customer-Terms-of-Use.pdf) |
| Funzionalità di base dell'app | Questo assistente digitale consente di eseguire una serie di moduli di formazione che coprono tutto ciò che è necessario sapere per configurare e lavorare su Teams. Ogni modulo contiene video di esercitazioni e contenuti di formazione specifici per garantire che il personale sia pienamente a conoscenza dell'ampiezza delle funzionalità disponibili in Microsoft Teams e su come usarle. |
...
Queste informazioni sono state fornite da The Bot Platform sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Nome |
...
| URL dell'informativa sulla privacy | https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Privacy-Statement.pdf |
