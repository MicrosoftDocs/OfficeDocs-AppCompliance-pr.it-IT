...
|:----------------|:-------------|
| Nome app | Assistente alla formazione |
| ID | WA200003547 |
...
| Funzionalità di base dell'app | Questo assistente digitale ti consente di eseguire una serie di moduli di formazione che coprono tutto ciò che devi sapere per configurare e lavorare su Teams. Ogni modulo contiene video di esercitazioni e contenuti di formazione specifici per garantire che il personale sia pienamente a conoscenza dell'ampiezza delle funzionalità disponibili in Microsoft Teams e su come usarle. |
