---
title: Informazioni sull'applicazione per Bonfyre di Bonfyre, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Bonfyre, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66547214"
---
# <a name="bonfyre"></a>Bonfyre

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 30 marzo 2022</p>

* <a href="https://teams.microsoft.com/l/app/829fa155-8058-4b1e-b43a-86efb74da5d4" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004185" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Bonfyre, Inc a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Bonfyre |
| ID | WA200004185 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Bonfyre, Inc |
| Sito Web dell'azienda | [https://bonfyreapp.com](https://bonfyreapp.com) |
| Condizioni per l'utilizzo dell'app | [https://bonfyreapp.com/terms-of-use-teams](https://bonfyreapp.com/terms-of-use-teams) |
| Funzionalità di base dell'app | Porta la potenza delle funzionalità di coinvolgimento di Bonfyre nel canale di lavoro che i tuoi dipendenti usano ogni giorno. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
Queste informazioni sono state fornite da Bonfyre, Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Contenuto inviato dall'utente e dati del profilo utente. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nomi utente, indirizzi di posta elettronica e immagini del profilo.  Queste informazioni possono essere precon condivise durante l'onboarding dei clienti, ma microsoft esegue la sincronizzazione con i profili utente per mantenere aggiornate le informazioni. |
...
| URL dell'informativa sulla privacy | https://bonfyreapp.com/privacy-policy-teams |
