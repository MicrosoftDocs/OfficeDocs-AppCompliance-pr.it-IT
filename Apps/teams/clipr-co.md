---
title: Informazioni sull'applicazione per CLIPr by CLIPr Co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per l'interfaccia della riga di comandoPr, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66952611"
---
# <a name="clipr"></a>CLIPr

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 3 dicembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/2d6b2a6d-a20d-4206-a11c-e01d34d0d3a0" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003612" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da CLIPr Co a Microsoft:
...
| Nome della società partner | CLIPr Co |
| Sito Web dell'azienda | [https://www.clipr.ai](https://www.clipr.ai) |
| Condizioni per l'utilizzo dell'app | [https://www.clipr.ai/terms-of-use](https://www.clipr.ai/terms-of-use) |
| Funzionalità di base dell'app | L'interfaccia della riga di comando usa L'intelligenza artificiale/Machine Learning per rendere i contenuti video ricercabili e interattivi. |
...
Queste informazioni sono state fornite da CLIPr Co su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Vengono raccolti il nome e l'indirizzo di posta elettronica dell'utente. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome utente, indirizzo di posta elettronica e nome della società collegato all'ID tenant.  |
...
| URL dell'informativa sulla privacy | https://www.clipr.ai/privacy-policy |
