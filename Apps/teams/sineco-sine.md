---
title: Informazioni sull'applicazione per Sine by Sine.co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Sine, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b0d37fb7-080f-4288-992b-36790712c016" target="_blank">Visualizza in Teams store</a>
...
| Nome della società partner | Sine.co |
| Sito Web dell'azienda | [https://www.sine.co](https://www.sine.co) |
| Condizioni per l'utilizzo dell'app | [https://www.sine.co/terms/](https://www.sine.co/terms/) |
| Funzionalità di base dell'app | Software sine workplace che migliora la sicurezza, la sicurezza, la conformità dei visitatori e dei lavoratori. |
| Sede centrale dell'azienda | Australia |
| Pagina delle informazioni sull'app | [https://www.sine.co](https://www.sine.co) |
...
Queste informazioni sono state fornite da Sine.co su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
