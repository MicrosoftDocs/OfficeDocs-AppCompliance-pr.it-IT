...
| Sito Web aziendale | [https://app.fifty.do](https://app.fifty.do) |
| Condizioni per l'uso dell'app | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| Funzionalità di base dell'app | 50 ti aiuta a passare dalla conoscenza all'azione offrendo le tue sfide personalizzate. Queste sfide aiuteranno a consolidare o migliorare alcune delle tue competenze principali. |
| Sede centrale dell'azienda | Francia |
| Pagina delle informazioni dell'app | [https://www.fifty.do](https://www.fifty.do) |
