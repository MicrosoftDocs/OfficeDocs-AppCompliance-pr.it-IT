---
title: Informazioni sull'applicazione per Quadra Visitorz di Quadrasystems.net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Quadra Visitorz, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/86458973-657f-4072-8e6a-f1baf684c62f" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004199" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Quadrasystems.net a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Quadra Visitorz |
| ID | WA200004199 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Quadrasystems.net |
| Sito Web dell'azienda | [https://www.quadrasystems.net](https://www.quadrasystems.net) |
| Condizioni per l'utilizzo dell'app | [https://www.quadrasystems.net/tou](https://www.quadrasystems.net/tou) |
| Funzionalità di base dell'app | Visitorz è una soluzione intuitiva, facile da usare e scalabile per la gestione dei visitatori. |
...
Queste informazioni sono state fornite da Quadrasystems.net su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
