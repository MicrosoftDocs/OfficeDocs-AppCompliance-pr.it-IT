...
description: Tutte le informazioni di sicurezza e conformità disponibili per NewCOS, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001104" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Newtech a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | NewCOS |
| ID | WA200001104 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Newtech |
| Sito Web dell'azienda | [https://newtech.com.ar](https://newtech.com.ar) |
| Condizioni per l'utilizzo dell'app | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| Funzionalità di base dell'app | Distribuire una soluzione di comunicazione intelligente in modo rapido, semplice e in modalità di servizio. La piattaforma NewCOS consente di eseguire, gestire, monitorare e supportare l'installazione in modo rapido, semplice e senza l'intervento dell'IT.  Andiamo con voi in modo che il processo di adozione della tecnologia sia di successo. Facilitiamo l'adattamento dei cambiamenti nelle aree di lavoro collaborative di oggi. Tramite l'adozione di Microsoft 365 possiamo accelerare il processo di trasformazione digitale all'interno dell'organizzazione.  |
| Sede centrale dell'azienda | Argentina |
| Pagina delle informazioni sull'app | [https://N.A](https://N.A) |
...
Queste informazioni sono state fornite da Newtech sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| profile | Entrambi | Questi dati vengono usati per l'autenticazione nelle autorizzazioni dell'app | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | Entrambi | Microsoft Teams l'utilizzo, per segnalare e governance | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |
