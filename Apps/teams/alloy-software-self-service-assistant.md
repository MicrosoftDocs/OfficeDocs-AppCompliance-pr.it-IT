---
title: Application Information for Alloy Self-Service Assistant by Alloy Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Alloy Self-Service Assistant, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/da84bd82-1002-4487-be1a-ebec71d9a61a" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003492" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Alloy Software a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Alloy Self-Service Assistant |
| ID | WA200003492 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Alloy Software |
| Sito Web aziendale | [https://alloysoftware.com](https://alloysoftware.com) |
| Condizioni per l'uso dell'app | [https://www.alloysoftware.com/resources/eula/](https://www.alloysoftware.com/resources/eula/) |
| Funzionalità di base dell'app | Creare ticket del service desk, cercare nella Knowledge Base e approvare le richieste. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://docs.alloysoftware.com/alloynavigator/2021/docs/int...](https://docs.alloysoftware.com/alloynavigator/2021/docs/integrations/topics/microsoft-teams-bot.htm) |
...
Queste informazioni sono state fornite da Alloy Software su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | tenant dei clienti |
...
| Data di certificazione SOC2 più recente |  2021-11-15 |
| L'app è conforme ai controlli dell'organizzazione del servizio (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente |  2021-11-09 |
...
| URL dell'informativa sulla privacy | https://www.alloysoftware.com/resources/privacy/ |
