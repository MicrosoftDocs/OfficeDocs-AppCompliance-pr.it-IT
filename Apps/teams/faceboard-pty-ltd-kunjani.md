---
title: Informazioni sull'applicazione per Kunjani di FACEBOARD (PTY) LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/10/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Kunjani, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64875433"
---
# <a name="kunjani"></a>Kunjani

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 10 ottobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/6b4ac65a-764d-4021-bf3f-40cb2d137a33" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Kunjani |
| ID | WA200003049 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | FACEBOARD (PTY) LTD |
| Sito Web dell'azienda | [https://www.kunjani.co](https://www.kunjani.co) |
| Condizioni per l'utilizzo dell'app | [https://www.kunjani.co/termsandconditions](https://www.kunjani.co/termsandconditions) |
| Funzionalità di base dell'app | Vivi il tuo meeting con un gioco interattivo Kunjani progettato da te. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://Kunjani.co](https://Kunjani.co) |
...
Queste informazioni sono state fornite da FACEBOARD (PTY) LTD su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
