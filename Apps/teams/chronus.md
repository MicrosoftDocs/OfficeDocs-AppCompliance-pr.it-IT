...
description: Tutte le informazioni di sicurezza e conformità disponibili per Chronus, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://chronus.com](https://chronus.com) |
| Condizioni per l'uso dell'app | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| Funzionalità di base dell'app | Il software Chronus alimenta migliaia di programmi di tutoraggio di successo per alcune delle&#8217;più grandi organizzazioni. Semplifica l'avvio, la gestione e la misurazione dell'impatto del tutoraggio.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://chronus.com/services](https://chronus.com/services) |
