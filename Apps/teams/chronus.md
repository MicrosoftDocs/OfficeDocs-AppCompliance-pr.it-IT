...
description: Tutte le informazioni di sicurezza e conformità disponibili per Chronus, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bb32d4e5-ae29-4c59-ba7e-a11611ca9710" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Chronus |
| ID | WA200003051 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Chronus |
| Sito Web dell'azienda | [https://chronus.com](https://chronus.com) |
| Condizioni per l'utilizzo dell'app | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| Funzionalità di base dell'app | Il software Chronus alimenta migliaia di programmi di mentoring di successo per alcune delle organizzazioni più grandi del mondo&#8217;. Semplifica l'avvio, la gestione e la misura dell'impatto del mentoring.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://chronus.com/services](https://chronus.com/services) |
...
Queste informazioni sono state fornite da Chronus su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
