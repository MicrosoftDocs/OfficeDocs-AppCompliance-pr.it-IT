...
description: Tutte le informazioni di sicurezza e conformità disponibili per ParkHere Corporate, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bc9ce604-cd9b-4aee-9cee-29028e1b00ab" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | ParkHere Corporate |
| ID | WA200003124 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | ParkHere GmbH |
| Sito Web dell'azienda | [https://park-here.eu](https://park-here.eu) |
| Condizioni per l'utilizzo dell'app | [https://park-here.eu/ms-teams-terms-of-use/](https://park-here.eu/ms-teams-terms-of-use/) |
| Funzionalità di base dell'app | Finden und Reservieren Sie einen verf&#252;gbaren Parkplatz an Ihrer Arbeitsstelle |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni sull'app | [https://park-here.eu/komplettloesung/](https://park-here.eu/komplettloesung/) |
...
Queste informazioni sono state fornite da ParkHere GmbH sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
