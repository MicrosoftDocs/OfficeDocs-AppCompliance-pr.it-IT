---
title: Informazioni sull'applicazione per PerformYard di PerformYard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per PerformYard, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66547264"
---
# <a name="performyard"></a>PerformYard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 10 giugno 2022</p>

* <a href="https://teams.microsoft.com/l/app/ae947de1-da03-4e37-a420-3c5316f01e73" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004215" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da PerformYard a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | PerformYard |
| ID | WA200004215 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | PerformYard |
| Sito Web dell'azienda | [https://performyard.com](https://performyard.com) |
| Condizioni per l'utilizzo dell'app | [https://www.performyard.com/master-subscription-agreement](https://www.performyard.com/master-subscription-agreement) |
| Funzionalità di base dell'app | PerformYard semplifica la gestione delle prestazioni per tutti. Flessibile per le risorse umane &amp; semplice per i dipendenti. |
...
Queste informazioni sono state fornite da PerformYard sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Informazioni sull'identificazione del tenant, i nomi di tutti i team e di tutti i canali in tale team; installare e disinstallare gli eventi. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Informazioni sull'identificazione del tenant, i nomi di tutti i team e di tutti i canali. |
...
| URL dell'informativa sulla privacy | https://www.performyard.com/privacy |
