...
description: Tutte le informazioni di sicurezza e conformità disponibili per Micromate, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Micromate |
| ID | WA200002981 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Paixon GmbH |
| Sito Web dell'azienda | [https://paixon.ch](https://paixon.ch) |
| Condizioni per l'utilizzo dell'app | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| Funzionalità di base dell'app | Micromate vermittelt durch personalisierte Lerneinheiten direkt im Chat nachhaltig Wissen. Micromate setzt dabei auf Microlearning durch die Ausspielung von Quizzes in Form von Adaptive Cards. Die pers&#246;nliche Ansprache des Lernenden, ein Tutorial zur Funktionsweise der App und die Integration spannender Gamification Elemente motivieren den Lernenden zur nachhaltigen Nutzung. |
| Sede centrale dell'azienda | Svizzera |
| Pagina delle informazioni sull'app | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di servizi cloud di hosting usano l'app? | Cloudscale |
...
Queste informazioni sono state fornite da Paixon GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
