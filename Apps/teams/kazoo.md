---
title: Informazioni sull'applicazione per Kazoo di Kazoo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Kazoo, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/afd11b2b-88b8-4f07-8902-a6e445b6e753" target="_blank">Visualizza in Teams store</a>
...
| Nome della società partner | Kazoo |
| Sito Web dell'azienda | [https://www.kazoohr.com](https://www.kazoohr.com) |
| Condizioni per l'utilizzo dell'app | [https://www.kazoohr.com/terms-of-use](https://www.kazoohr.com/terms-of-use) |
| Funzionalità di base dell'app | Uno strumento di engagement e gestione delle prestazioni dei dipendenti per migliorare la cultura aziendale e la soddisfazione dei dipendenti tramite riconoscimenti e ricompense peer-peer, insieme alla gestione continua delle prestazioni. |
...
Queste informazioni sono state fornite da Kazoo su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2019-06-30 |
