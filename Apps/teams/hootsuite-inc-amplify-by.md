---
title: Application Information for Amplify di Hootsuite di Hootsuite Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Amplify di Hootsuite, i criteri di gestione dei dati, le informazioni sul catalogo delle app di Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
|:----------------|:-------------|
| Nome dell'app | Amplify di Hootsuite |
| ID | WA200003153 |
| Client di Office 365 supportati | Microsoft Teams |
| Nome della società partner | Hootsuite Inc. |
| Sito Web dell'azienda | [https://www.hootsuite.com](https://www.hootsuite.com) |
| Condizioni per l'utilizzo dell'app | [https://www.hootsuite.com/legal/eula](https://www.hootsuite.com/legal/eula) |
| Funzionalità di base dell'app | Condividere contenuti da Microsoft Teams ai canali social dei team, basati su Hootsuite Amplify. |
| Sede centrale dell'azienda | Canada |
| Pagina delle informazioni sull'app | [https://www.hootsuite.com/about/contact-us](https://www.hootsuite.com/about/contact-us) |
...
Queste informazioni sono state fornite da Hootsuite Inc. Informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | Delegato | Per l'accesso al feed di notifica delle attività degli utenti | [e308040f-41b5-4b8c-8f08-c2c38056f7e2](../azure/e308040f-41b5-4b8c-8f08-c2c38056f7e2.md) |
