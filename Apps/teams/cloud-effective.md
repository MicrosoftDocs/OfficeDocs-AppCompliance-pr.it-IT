---
title: Informazioni sull'applicazione per cloud efficaci dal cloud
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Cloud Effective, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c976a771-1aa9-4e98-b87d-32f271bd6e7f" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Cloud Effective |
| ID | WA200002408 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Cloud Effective |
| Sito Web dell'azienda | [https://CloudEffective.com](https://CloudEffective.com) |
| Condizioni per l'utilizzo dell'app | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
| Funzionalità di base dell'app | Ottimizzare la collaborazione. Gestisci team, obiettivi, progetti e attività trasformando le idee in risultati! |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://cloudeffective.com/products-pricing](https://cloudeffective.com/products-pricing) |
...
Queste informazioni sono state fornite da Cloud Effective su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | Delegato | Sincronizzare i nomi e i membri del team per assicurarsi che i membri del team di MS-Teams abbiano lo stesso accesso al team corrispondente in Cloud Effective.  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](../azure/50356ee3-b48b-424b-a7a7-35e53c2ce736.md) |
