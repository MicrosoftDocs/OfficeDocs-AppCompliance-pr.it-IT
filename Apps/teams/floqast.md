...
description: Tutte le informazioni di sicurezza e conformità disponibili per FloQast, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/326749cd-77f8-4579-8944-6837ebeb175d" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | FloQast |
| ID | WA200003117 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | FloQast |
| Sito Web dell'azienda | [https://floqast.com](https://floqast.com) |
| Condizioni per l'utilizzo dell'app | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| Funzionalità di base dell'app | FloQast offre una soluzione di gestione stretta e l'automazione del flusso di lavoro progettata per assistere i contabili nell'esecuzione della chiusura di fine mese. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://floqast.com](https://floqast.com) |
...
Queste informazioni sono state fornite da FloQast su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2/28/2021 |
