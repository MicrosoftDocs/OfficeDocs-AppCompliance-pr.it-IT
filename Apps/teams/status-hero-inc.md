---
title: Informazioni sull'applicazione per Status Hero by Status Hero, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Status Hero, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Status Hero, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Status Hero |
| ID | WA200004205 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Status Hero, Inc. |
| Sito Web dell'azienda | [https://statushero.com](https://statushero.com) |
| Condizioni per l'utilizzo dell'app | [https://statushero.com/terms](https://statushero.com/terms) |
| Funzionalità di base dell'app | Status Hero trasforma i check-in e i dati asincroni dagli strumenti del team in report concisi e approfonditi. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
Queste informazioni sono state fornite da Status Hero, Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2021-11-01 |
...
| URL dell'informativa sulla privacy | https://statushero.com/privacy |
