---
title: Application Information for SurveySparrow by SurveySparrow inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SurveySparrow, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
Informazioni fornite da SurveySparrow inc. a Microsoft:
...
| Nome della società partner | SurveySparrow inc. |
| Sito Web dell'azienda | [https://surveysparrow.com](https://surveysparrow.com) |
| Condizioni per l'utilizzo dell'app | [https://surveysparrow.com/legal/terms-of-service/](https://surveysparrow.com/legal/terms-of-service/) |
| Funzionalità di base dell'app | Condurre stand-up giornalieri, felicità mensile e misurare facilmente il polso dei dipendenti. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://surveysparrow.com/apps/microsoft-teams-survey-integ...](https://surveysparrow.com/apps/microsoft-teams-survey-integration/) |
...
Queste informazioni sono state fornite da SurveySparrow inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
