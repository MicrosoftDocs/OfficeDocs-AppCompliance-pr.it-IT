...
| Sito Web aziendale | [https://lexion.ai](https://lexion.ai) |
| Condizioni per l'uso dell'app | [https://lexion.ai/terms](https://lexion.ai/terms) |
| Funzionalità di base dell'app | Microsoft Teams Bot per la gestione del ciclo di vita dei contratti basata su IA di Lexion.
 |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://lexion.ai](https://lexion.ai) |
