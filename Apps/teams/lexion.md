---
title: Informazioni sull'applicazione per Lexion di Lexion
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Lexion, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Lexion |
| ID | WA200003176 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Lexion |
| Sito Web dell'azienda | [https://lexion.ai](https://lexion.ai) |
| Condizioni per l'utilizzo dell'app | [https://lexion.ai/terms](https://lexion.ai/terms) |
| Funzionalità di base dell'app | Microsoft Teams bot per la gestione del ciclo di vita dei contratti basata su Intelligenza artificiale di Lexion.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://lexion.ai](https://lexion.ai) |
...
Queste informazioni sono state fornite da Lexion sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
