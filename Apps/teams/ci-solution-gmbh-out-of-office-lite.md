...
* <a href="https://teams.microsoft.com/l/app/e76af3f9-8fb6-4018-84c0-d5444ad72b4c" target="_blank">Visualizzazione in Teams store</a>
...
| URL della Teams info dell'applicazione | [https://www.ci-solution.com/support/en/ci-oof-lite/](https://www.ci-solution.com/support/en/ci-oof-lite/) |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| email | delegated | Visualizzare l'indirizzo di posta elettronica degli utenti | Es werden keine Daten gespeichert. | [fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da](https://docs.microsoft.com/microsoft-365-app-certification/azure/fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da) |
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/39113" target="_blank">Visualizzazione in una nuova scheda</a>
...
Queste informazioni sono state fornite da ci solution GmbH su come questa app gestisce l'autenticazione, l'autorizzazione, le procedure consigliate per la registrazione delle applicazioni e altri criteri di identità.
