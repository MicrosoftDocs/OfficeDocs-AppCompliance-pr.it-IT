---
title: Informazioni sull'applicazione per Motionlab di Motionlab
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Motionlab, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66549493"
---
# <a name="motionlab"></a>Motionlab

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 30 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/8ad5fc1b-251b-4d14-aceb-2624bcab0e85" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004250" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Motionlab a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Motionlab |
| ID | WA200004250 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Motionlab |
| Sito Web dell'azienda | [https://www.motionlab.io](https://www.motionlab.io) |
| Condizioni per l'utilizzo dell'app | [https://www.motionlab.io/term-of-use](https://www.motionlab.io/term-of-use) |
| Funzionalità di base dell'app | Creare facilmente video personalizzati direttamente in Microsoft Teams. |
...
Queste informazioni sono state fornite da Motionlab sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Informazioni necessarie per creare un video personalizzato. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Informazioni necessarie per creare un video personalizzato. |
