...
description: Tutte le informazioni di sicurezza e conformità disponibili per eCademy Lernplattform, i criteri di gestione dei dati, le informazioni sul catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
| Condizioni per l'uso dell'app | [https://www.ecademy-learning.com/agb/](https://www.ecademy-learning.com/agb/) |
| Funzionalità di base dell'app | Per i formatori e i tirocinanti che desiderano abilitare l'insegnamento e l'apprendimento innovativi, eCademy Lernplattform è la soluzione di apprendimento digitale che apre percorsi di apprendimento individuali e pratici in qualsiasi momento e in qualsiasi luogo. Aiutiamo le aziende e gli istituti di istruzione a formare e sviluppare con successo lavoratori e dipendenti qualificati per il mercato del lavoro del futuro e per consentire loro di ottenere prestazioni migliori di fronte alle crescenti esigenze e ai pool di talenti sempre più eterogenei. |
