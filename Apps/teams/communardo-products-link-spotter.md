---
title: Informazioni sull'applicazione per Link Spotter di Communardo Products
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Link Spotter, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64878333"
---
# <a name="link-spotter"></a>Link Spotter

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 27 luglio 2021</p>

* <a href="https://teams.microsoft.com/l/app/9e486bb8-9633-48ba-8416-71da1d30cd08" target="_blank">Visualizza in Teams store</a>
...
Informazioni fornite da Prodotti Communardo a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Link Spotter |
| ID | WA200003092 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Communardo Products |
| Sito Web dell'azienda | [https://www.communardo.com](https://www.communardo.com) |
| Condizioni per l'utilizzo dell'app | [https://www.communardo.com/customer-agreement/](https://www.communardo.com/customer-agreement/) |
| Funzionalità di base dell'app | Link Spotter consente di trovare più velocemente tutti i collegamenti condivisi nei canali Microsoft Teams. |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni sull'app | [https://communardo.atlassian.net/wiki/spaces/LINK/overview](https://communardo.atlassian.net/wiki/spaces/LINK/overview) |
...
Queste informazioni sono state fornite da Communardo Products su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegato | Controllo dell'appartenenza al canale dell'utente corrente | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| ChannelMessage.Read.All | Applicazione | URL all'interno di messaggi, messageid, ID messaggio di risposta, ID canale, ID autore... Queste informazioni sono necessarie perché Graph non offre un modo efficiente per recuperare tutti i collegamenti pubblicati nei messaggi su un canale. Di conseguenza, i messaggi devono essere analizzati attivamente per fornire la funzionalità di collegamento nella scheda Teams. | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.Read | Delegato | Accedere e leggere il profilo utente | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.Read.All | Applicazione | Determinare il numero di utenti che hanno una licenza Teams. Usato per aggiornare le dimensioni del posto della sottoscrizione di origine dell'app con pagamento per il tenant del cliente. | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.ReadBasic.All | Delegato | visualizzazione dell'immagine del profilo e del nome dell'autore del messaggio all'interno dell'app | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| email | Delegato | Connessione OpenID | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| offline_access | Delegato | Connessione OpenID | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| openid | Delegato | Connessione OpenID | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| profile | Delegato | Connessione OpenID | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
