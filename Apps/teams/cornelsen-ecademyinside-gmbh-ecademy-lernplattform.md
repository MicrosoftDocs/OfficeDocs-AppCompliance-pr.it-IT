---
title: Application Information for eCademy Lernplattform di Cornelsen eCademy &amp; inside GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per eCademy Lernplattform, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8b1066b0-59c2-4a7b-8ac6-f43edcfe5eef" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | eCademy Lernplattform |
| ID | WA200002717 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Cornelsen eCademy &amp; inside GmbH |
| Sito Web dell'azienda | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
| Condizioni per l'utilizzo dell'app | [https://www.ecademy-learning.com/agb/](https://www.ecademy-learning.com/agb/) |
| Funzionalità di base dell'app | Per i formatori e i partecipanti che vogliono abilitare l'insegnamento e l'apprendimento innovativi, eCademy Lernplattform è la soluzione di apprendimento digitale che apre percorsi di apprendimento individuali e pratici in qualsiasi momento e in qualsiasi luogo. Aiutiamo le aziende e le istituzioni educative a formare e sviluppare con successo lavoratori e dipendenti qualificati per il mercato del lavoro del futuro e a consentire loro di ottenere prestazioni migliori di fronte alle crescenti richieste e ai pool di talenti sempre più eterogenei. |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni sull'app | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
...
Queste informazioni sono state fornite da Cornelsen eCademy &amp; all'interno di GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
