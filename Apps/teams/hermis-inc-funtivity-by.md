...
description: Tutte le informazioni di sicurezza e conformità disponibili per La funtività di Hermis, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="funtivity-by-hermis"></a>Funtivity di Hermis

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 19 giugno 2022</p>

* <a href="https://teams.microsoft.com/l/app/d75e14a9-9bfd-43b4-8430-7264da3b6995" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004244" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Hermis, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Funtivity di Hermis |
| ID | WA200004244 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Hermis, Inc. |
| Sito Web dell'azienda | [https://www.herm.is](https://www.herm.is) |
| Condizioni per l'utilizzo dell'app | [https://www.herm.is/terms](https://www.herm.is/terms) |
| Funzionalità di base dell'app | Funtivity by Hermis ha una pletora di contenuti di attività &amp; per un'ampia gamma di occasioni tra cui team building, sessioni di breakout conferenza, eventi culturali e altro ancora. Con più di una dozzina di attività diverse e nuovi eventi meticolosamente realizzati ogni settimana, ci&#8217;qualcosa per tutti di godere. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.herm.is/integrations/funtivity-msteams](https://www.herm.is/integrations/funtivity-msteams) |
...
Queste informazioni sono state fornite da Hermis, Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | L'ID del cliente, il nome &amp; e-mail vengono usati per registrare l'utente in Hermis. |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Il messaggio di posta elettronica del nome &amp; utente viene archiviato nel database. Il messaggio di posta elettronica dell'utente viene crittografato tramite AES-256-CBC |
...
| URL dell'informativa sulla privacy | https://www.herm.is/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Usiamo i dettagli del profilo dell'utente per registrare l'utente sulla piattaforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| email | Delegato | Usiamo i dettagli del profilo dell'utente per registrare l'utente sulla piattaforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| openid | Delegato | Usiamo i dettagli del profilo dell'utente per registrare l'utente sulla piattaforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| profile | Delegato | Usiamo i dettagli del profilo dell'utente per registrare l'utente sulla piattaforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
