...
| URL del sito Web del partner | [https://www.contexxt.ai](https://www.contexxt.ai) |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Tecnicamente non è possibile evitare che Microsoft Teams (ID utente) automaticamente | No |  |
...
>Non abbiamo accesso né controllo sui dati nei sistemi dei nostri partner
