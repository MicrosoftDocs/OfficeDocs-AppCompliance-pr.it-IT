...
description: Tutte le informazioni di sicurezza e conformità disponibili per RingCentral, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880933"
---
# <a name="ringcentral"></a>RingCentral

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 18 maggio 2021</p>

* <a href="https://teams.microsoft.com/l/app/2f285d77-896a-4c5f-901e-0902316003b5" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | RingCentral |
| ID | WA200000135 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | RingCentral, Inc. |
| Sito Web dell'azienda | [https://www.ringcentral.com](https://www.ringcentral.com) |
| Condizioni per l'utilizzo dell'app | [https://www.ringcentral.com/legal/last-update-October-15-20...](https://www.ringcentral.com/legal/last-update-October-15-2019/eulatos.html) |
| Funzionalità di base dell'app | Avviare e aggiungere chiamate video o audio ringcentral con comandi rapidi del bot e funzionalità di messaggistica. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.ringcentral.com/apps/ringcentral-for-microsoft-...](https://www.ringcentral.com/apps/ringcentral-for-microsoft-teams) |
...
| Data di certificazione SOC2 più recente | 2020-05-11 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegato |  Consente all'applicazione di inviare l'evento di invito alla riunione tramite il calendario | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| offline_access | Delegato |  Consente all'applicazione di ottenere e aggiornare il token oauth | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read | Delegato |  Consente all'app di leggere un utente&#8217;profilo di base (indirizzo di posta elettronica, nome) per eseguire corrispondenze di contatto alla fine. E consente all'utente di accedere e collegare il proprio account O365 con l'account RingCentral | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | Delegato | Consente all'applicazione di leggere il profilo completo di un utente con numeri di telefono per effettuare chiamate telefoniche con i nostri servizi. | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
