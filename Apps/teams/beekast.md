...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Beekast, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/377da6a7-efc3-4599-887a-1d3eda45120a" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Beekast |
| ID | WA200001447 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Beekast |
| Sito Web dell'azienda | [https://www.beekast.com](https://www.beekast.com) |
| Condizioni per l'utilizzo dell'app | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| Funzionalità di base dell'app | Beekast è una piattaforma collaborativa per velocizzare le riunioni. |
| Sede centrale dell'azienda | Francia |
| Pagina delle informazioni sull'app | [https://www.beekast.com](https://www.beekast.com) |
...
Queste informazioni sono state fornite da Beekast su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Posta elettronica, nome e cognome: questi dati vengono usati per collaborare all'interno dell'applicazione beekast. | [4d0997dc-df53-4b18-9df1-bb283f8a0377](../azure/4d0997dc-df53-4b18-9df1-bb283f8a0377.md) |
