---
title: Informazioni sull'applicazione per Pandos di Pandos Intelligence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/10/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Pandos, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0e777926-2ab4-4e40-9fe5-80dc68e5044f" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003534" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Pandos Intelligence Inc a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Pandos |
| ID | WA200003534 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Pandos Intelligence Inc |
| Sito Web dell'azienda | [https://pandos.io](https://pandos.io) |
| Condizioni per l'utilizzo dell'app | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| Funzionalità di base dell'app | Pandos è una piattaforma di apprendimento e sviluppo one-stop-shop per manager di team e persone, responsabili di progetto, formatori e istruttori didattici. Supporta funzionalità fondamentali, ad esempio la formazione di team in base a criteri (tra cui disponibilità, personalità, competenze o qualsiasi criterio personalizzato), gestione delle attività del team e valutazione peer. La piattaforma genera automaticamente un profilo per le competenze soft dei membri, verificate dai peer.  |
| Sede centrale dell'azienda | Canada |
| Pagina delle informazioni sull'app | [https://pandos.io](https://pandos.io) |
...
Queste informazioni sono state fornite da Pandos Intelligence Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://pandos.io/gdpr/ |
