---
title: Informazioni sull'applicazione per beep di Medxnote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Beep, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66852704"
---
# <a name="beep"></a>Bip

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 11 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/6b8b29d8-5beb-4eae-915e-5a56a0e1f5a6" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004364" target="_blank">Visualizzazione in AppSource</a>
...
| Nome della società partner | Medxnote |
| Sito Web dell'azienda | [https://medxnote.com](https://medxnote.com) |
| Condizioni per l'utilizzo dell'app | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
| Funzionalità di base dell'app | Migliorare la collaborazione clinica con l'integrazione delle attività EPR di MedxPlanner in Microsoft Teams. |
...
Queste informazioni sono state fornite da Medxnote sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | ID tenant, profilo utente, tag |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | ID tenant, profilo utente, tag |
| Se l'infrastruttura sottostante elabora o archivia i dati dei clienti Microsoft, dove vengono archiviati geograficamente questi dati? | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
...
| URL dell'informativa sulla privacy | https://medxnote.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | entrambi | Stiamo ricevendo le informazioni sull'organizzazione dell'utente | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamsActivity.Send | Applicazione | Questa autorizzazione viene usata per inviare attività all'utente. Viene quindi usato per creare un'attività a livello di codice nel feed dell'utente, per renderli consapevoli che l'attività viene aggiornata. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamworkTag.ReadWrite | Applicazione | Questa autorizzazione viene usata per ottenere e creare i tag all'interno dei team in Microsoft Teams. In modo da poterli menzionare a livello di codice. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read | Delegato | Usando questa autorizzazione, si ottengono le informazioni di base degli utenti, ad esempio displayName, mail, userPrincipalName, ID e photo. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read.All | Applicazione | In questo modo vengono recuperate le proprietà totali. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.ReadWrite.All | Applicazione | Usando questo si ottengono i team aggiunti degli utenti. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
