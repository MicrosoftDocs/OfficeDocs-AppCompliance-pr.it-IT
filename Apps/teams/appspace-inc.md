---
title: Informazioni sull'applicazione per Appspace di Appspace, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Appspace, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
|:----------------|:-------------|
| Nome dell'app | Appspace |
| ID | WA200001738 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Appspace, Inc. |
| Sito Web dell'azienda | [https://www.appspace.com](https://www.appspace.com) |
| Condizioni per l'utilizzo dell'app | [https://www.appspace.com/legal/user-agreement/](https://www.appspace.com/legal/user-agreement/) |
| Funzionalità di base dell'app | Appspace è una piattaforma di comunicazione e gestione dello spazio per aiutare l'azienda con l'organizzazione e l'efficienza, lavorando da qualsiasi luogo. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.appspace.com](https://www.appspace.com) |
...
Queste informazioni sono state fornite da Appspace, Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-11-09 |
| L'app è conforme ai controlli dell'organizzazione dei servizi (SOC 3)? | Sì |
| Data di certificazione SOC3 più recente | 2020-11-09 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Team.ReadBasic.All | Delegato | Ottenere i team a cui appartiene l'utente. | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
>| User.ReadBasic.All | Delegato | Leggere le proprietà di base del profilo di altri utenti dell'organizzazione per conto dell'utente connesso. Sono inclusi nome visualizzato, nome e cognome, indirizzo di posta elettronica, estensioni aperte e foto. Consente inoltre all'app di leggere il profilo completo dell'utente connesso. | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
