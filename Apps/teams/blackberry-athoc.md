...
description: Tutte le informazioni di sicurezza e conformità disponibili per BlackBerry AtHoc, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | BlackBerry AtHoc |
| ID | WA200003065 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | BlackBerry |
| Sito Web dell'azienda | [https://www.blackberry.com](https://www.blackberry.com) |
| Condizioni per l'utilizzo dell'app | [https://www.athoc.com/pss/terms.html#](https://www.athoc.com/pss/terms.html#) |
| Funzionalità di base dell'app | L'integrazione di BlackBerry AtHoc con Teams consente di gestire facilmente gli eventi critici all'interno dell'organizzazione &#8211; tutto da un'interfaccia utente familiare in cui&#8217;già autenticati. Senza uscire da Teams, l'integrazione di BlackBerry AtHoc consente ai responsabili degli eventi di emergenza e degli eventi imprevisti di: &#8226; Pubblicare avvisi, con un clic, in qualsiasi dispositivo &#8226; gruppi di distribuzione predefiniti target in Teams &#8226; Collaborare all'interno di Teams per gestire gli eventi imprevisti in tempo reale |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.blackberry.com/us/en/products/blackberry-athoc](https://www.blackberry.com/us/en/products/blackberry-athoc) |
