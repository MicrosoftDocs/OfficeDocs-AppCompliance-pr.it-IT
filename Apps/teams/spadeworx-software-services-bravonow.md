---
title: Informazioni sull'applicazione per BravoNow di SpadeWorx Software Services
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per BravoNow, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/272032ad-0c2e-4928-910e-5d52b19f70d5" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000157" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da SpadeWorx Software Services a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | BravoNow |
| ID | WA200000157 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | SpadeWorx Software Services |
| Sito Web dell'azienda | [https://www.spadeworx.com](https://www.spadeworx.com) |
| Condizioni per l'utilizzo dell'app | [https://docs.pozitive.io/BRAVO_TermsOfService.pdf](https://docs.pozitive.io/BRAVO_TermsOfService.pdf) |
| Funzionalità di base dell'app | Bravo è una piattaforma di riconoscimento dei dipendenti peer-to-peer. |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://bravo.pozitive.io](https://bravo.pozitive.io) |
...
Queste informazioni sono state fornite da SpadeWorx Software Services su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | Indirizzo di posta elettronica degli utenti. | [272032ad-0c2e-4928-910e-5d52b19f70d5](../azure/272032ad-0c2e-4928-910e-5d52b19f70d5.md) |
