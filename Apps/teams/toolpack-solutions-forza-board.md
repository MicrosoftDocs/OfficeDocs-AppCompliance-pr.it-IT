---
title: Informazioni sull'applicazione per Forza Board by Toolpack Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Forza Board, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b4db3055-5e98-4935-862e-7ffd42761eaa" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004274" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Toolpack Solutions a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Forza Board |
| ID | WA200004274 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Soluzioni Toolpack |
| Sito Web dell'azienda | [https://www.toolpack365.com](https://www.toolpack365.com) |
| Condizioni per l'utilizzo dell'app | [https://www.toolpack365.com/kontakt-og-vilkaar](https://www.toolpack365.com/kontakt-og-vilkaar) |
| Funzionalità di base dell'app | Sfrutta il tuo potenziale con un indicatore KPI intelligente e una creazione di report per una collaborazione migliore. |
...
Queste informazioni sono state fornite da Toolpack Solutions su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | indirizzo di posta elettronica e nome |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | indirizzo di posta elettronica e nome |
...
| URL dell'informativa sulla privacy | https://www.toolpack365.com/cookie-og-privatlivspolitik |
