...
* <a href="https://teams.microsoft.com/l/app/10fcc57c-8d49-4f94-a516-a75de60bc969" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001128" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Jexet Technologies LLC a Microsoft:
...
| Nome società partner | Jexet Technologies LLC |
| Sito Web aziendale | [https://mspbots.ai](https://mspbots.ai) |
| Condizioni per l'uso dell'app | [https://mspbots.ai/termsofuse/](https://mspbots.ai/termsofuse/) |
| Funzionalità di base dell'app | Piattaforma di business intelligence, automazione per le attività ripetitive del provider di servizi gestiti IT tramite bot personalizzabili. |
...
Queste informazioni sono state fornite da Jexet Technologies LLC su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://mspbots.ai/home/data-security/ |
...
>|:------------------------|:--------------------|:------------------------------------|
>| ChannelMessage.Send | application | Invia messaggio al canale |
>| ChatMessage.Send | application | Inviare un messaggio alla chat |
>| profile | application | ottenere informazioni sull'utente dell'app per l'uso |
