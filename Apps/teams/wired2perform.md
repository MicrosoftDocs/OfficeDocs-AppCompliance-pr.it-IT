---
title: Informazioni sull'applicazione per Wired2Perform by Wired2Perform
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Wired2Perform, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b08f369e-4927-4c66-b997-e1086df7970d" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Wired2Perform |
| ID | WA200002935 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Wired2Perform |
| Sito Web dell'azienda | [https://wired2perform.com](https://wired2perform.com) |
| Condizioni per l'utilizzo dell'app | [https://wired2perform.com/terms-conditions](https://wired2perform.com/terms-conditions) |
| Funzionalità di base dell'app | Wired2Perform&#174;, un'azienda orientata allo scopo, combina la scienza comportamentale e l'analisi avanzata per sincronizzare le persone con le migliori opportunità disponibili e aiutare i leader dei talenti a crescere, ottimizzare e accedere a una forza lavoro più adattabile. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://wired2perform.com](https://wired2perform.com) |
...
Queste informazioni sono state fornite da Wired2Perform su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
