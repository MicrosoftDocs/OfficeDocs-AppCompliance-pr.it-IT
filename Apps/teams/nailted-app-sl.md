---
title: Informazioni sull'applicazione per nailted da NAILTED APP S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Nailted, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da NAILTED APP S.L. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Nailted |
| ID | WA200003375 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | APP NEILTED S.L. |
| Sito Web dell'azienda | [https://nailted.com](https://nailted.com) |
| Condizioni per l'utilizzo dell'app | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| Funzionalità di base dell'app | La piattaforma di coinvolgimento dei dipendenti per i moderni team hr di People &amp; . |
| Sede centrale dell'azienda | Spagna |
| Pagina delle informazioni sull'app | |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? | Paas |
| Quali provider di servizi cloud di hosting usano l'app? | Heroku |
...
Queste informazioni sono state fornite da NAILTED APP S.L. informazioni su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | tenantId e posta elettronica |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | tenantId e posta elettronica |
...
| URL dell'informativa sulla privacy | https://nailted.com/legal/privacy |
...
| Se l'app non usa una delle librerie precedenti, quale libreria o libreria di autenticazione usa? | viene usata la versione più recente di Microsoft Authentication Library |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Applicazione | Usato per accedere ai gruppi. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| TeamsAppInstallation.ReadWriteForUser | Applicazione | L'utente può selezionare gli utenti in cui installare l'app. Si usa quindi questa autorizzazione per inserire l'app | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| User.Read.All | Applicazione | Usato per leggere le informazioni degli utenti | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| email | Applicazione | Accedere alla posta elettronica dei dipendenti per sincronizzarli | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| offline_access | Applicazione | Questa autorizzazione viene usata per accedere all'API quando l'utente non è online per poter sincronizzare i dipendenti e installare l'applicazione | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
