...
| Sito Web aziendale | [https://www.factset.com](https://www.factset.com) |
| Condizioni per l'uso dell'app | [https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%...](https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%20of%20Use.pdf) |
| Funzionalità di base dell'app | Con FactSet per Microsoft Teams, riceverai riepiloghi di notizie curati da StreetAccount in modo da poter rimanere al top delle storie chiave che hanno un impatto sui mercati globali. È possibile eseguire query su FactSet&#8217;contenuti leader del settore per informazioni dettagliate sull'azienda e condividerle con colleghi e gruppi, consentendo una collaborazione senza problemi senza passare da un'applicazione all'altra. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | application | Nome e posta elettronica per la verifica e la registrazione, ID conversazione per l'invio proattivo dei messaggi | [95fb5da0-6ced-4247-9d62-294f8fcb75df](https://docs.microsoft.com/microsoft-365-app-certification/azure/95fb5da0-6ced-4247-9d62-294f8fcb75df) |
