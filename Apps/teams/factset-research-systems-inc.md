...
description: Tutte le informazioni di sicurezza e conformità disponibili per FactSet, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/95fb5da0-6ced-4247-9d62-294f8fcb75df" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | FactSet |
| ID | WA200002146 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | FactSet Research Systems Inc. |
| Sito Web dell'azienda | [https://www.factset.com](https://www.factset.com) |
| Condizioni per l'utilizzo dell'app | [https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%...](https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%20of%20Use.pdf) |
| Funzionalità di base dell'app | Con FactSet per Microsoft Teams, riceverai riepiloghi di notizie curati da StreetAccount in modo da poter rimanere in cima alle storie chiave che influiscono sui mercati globali. È possibile eseguire query su FactSet&#8217;contenuto leader del settore per ottenere informazioni aziendali dettagliate e condividerle con colleghi e gruppi, consentendo la collaborazione senza sforzo senza passare da un'applicazione all'altra. |
...
Queste informazioni sono state fornite da FactSet Research Systems Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Applicazione | Nome e indirizzo di posta elettronica per la verifica e la registrazione, ID conversazione per l'invio proattivo di messaggi | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
