---
title: Informazioni sull'applicazione per GoLinks by GoLinks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: Tutte le informazioni sulla sicurezza e conformità disponibili per GoLinks, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da GoLinks a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | GoLinks |
| ID | WA200003853 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | GoLinks |
| Sito Web aziendale | [https://www.golinks.io](https://www.golinks.io) |
| Condizioni per l'uso dell'app | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| Funzionalità di base dell'app | I goLink, noti come go links, golink, go/links o go-links, sono collegamenti brevi intuitivi e facili da ricordare, condivisi dai team. Trasforma URL lunghi e brutti in collegamenti go leggibili dall'utente che possono essere usati direttamente nei browser, nei messaggi di posta elettronica, nelle chat e nelle conversazioni. GoLinks consente alle aziende di accedere e condividere in modo efficace ed efficiente le informazioni e le risorse di lavoro su larga scala. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
Queste informazioni sono state fornite da GoLinks su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | L'ID tenant viene solo archiviato da Microsoft. |
...
| Data di certificazione SOC2 più recente |  2021-10-31 |
...
| URL dell'informativa sulla privacy | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | application | È necessario accedere ai messaggi nei canali pubblici per verificare se il messaggio contiene un go/link. | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
