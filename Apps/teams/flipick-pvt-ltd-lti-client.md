---
title: Informazioni sull'applicazione per client LTI di Flipick Pvt Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per il client LTI, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | LTI Client |
| ID | WA200003313 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Flipick Pvt Ltd |
| Sito Web dell'azienda | [https://flipick.com](https://flipick.com) |
| Condizioni per l'utilizzo dell'app | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| Funzionalità di base dell'app | L'app fornisce un accesso Single Sign-On (SSO) con un server LTI (Learning Tools Interoperability) per avviare corsi. È un consumer di strumenti LTI e supporta l'LTI di base (BLTI). |
...
Queste informazioni sono state fornite da Flipick Pvt Ltd sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
