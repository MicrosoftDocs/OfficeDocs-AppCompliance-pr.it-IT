...
description: Tutte le informazioni di sicurezza e conformità disponibili per LTI Client, i criteri di gestione dei dati, le informazioni sul catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://flipick.com](https://flipick.com) |
| Condizioni per l'uso dell'app | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| Funzionalità di base dell'app | L'app fornisce un single sign-on (SSO) con un server LTI (interoperabilità degli strumenti di Learning) per avviare i corsi. È un consumer di strumenti LTI e supporta Basic LTI (BLTI). |
