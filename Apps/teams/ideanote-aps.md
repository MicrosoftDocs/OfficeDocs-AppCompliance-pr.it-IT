---
title: Informazioni sull'applicazione per Ideanote di Ideanote ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Ideanote, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">Visualizzazione in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003876" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Ideanote ApS a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Ideanote |
| ID | WA200003876 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | Ideanote ApS |
| Sito Web aziendale | [https://ideanote.io](https://ideanote.io) |
| Condizioni per l'uso dell'app | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| Funzionalità di base dell'app | Raccogliere, sviluppare e gestire idee con l'innovazione basata su obiettivi. |
| Sede centrale dell'azienda | Danimarca |
| Pagina delle informazioni dell'app | [https://ideanote.io](https://ideanote.io) |
...
Queste informazioni sono state fornite da Ideanote ApS su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Informazioni sul token JWT ottenuto dall'utente. Nome utente, Posta elettronica utente. |
...
| URL dell'informativa sulla privacy | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | Abbiamo bisogno di informazioni sull'utente per accedere automaticamente alla persona al suo account Ideanote. | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |
