...
| Sito Web aziendale | [https://centrical.com](https://centrical.com) |
| Condizioni per l'uso dell'app | [https://centrical.com/terms](https://centrical.com/terms) |
| Funzionalità di base dell'app | La piattaforma centrica consente ai dipendenti di concentrarsi sul lavoro da eseguire e, soprattutto, su come farlo. Usa i dati del lavoro misurato per richiedere microlearning che genera competenza. Utilizza l'intelligenza artificiale per migliorare il coinvolgimento dei dipendenti, le prestazioni e la microlearning. La piattaforma Centrical è disponibile tramite un'applicazione Web, app per dispositivi mobili, Microsoft Teams app, app Salesforce e SuccessFactors. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
