---
title: Informazioni sull'applicazione per Monitask di FEST Technologies, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Monitask, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0b49493f-fc40-49e1-9e3b-6515588af2b5" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Monitask |
| ID | WA200002986 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | FEST Technologies, LLC |
| Sito Web dell'azienda | [https://www.monitask.com](https://www.monitask.com) |
| Condizioni per l'utilizzo dell'app | [https://www.monitask.com/en/home/termsofservice](https://www.monitask.com/en/home/termsofservice) |
| Funzionalità di base dell'app | Monitask è il toolkit di produttività aziendale remoto All-In-One |
...
Queste informazioni sono state fornite da FEST Technologies, LLC su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
