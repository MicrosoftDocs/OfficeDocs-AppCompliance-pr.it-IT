---
title: Informazioni sull'applicazione per la collaborazione HighSide di HighSide, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per HighSide Collaboration, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">Visualizzazione in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | HighSide Collaboration |
| ID | WA200003916 |
| Office 365 client supportati | Microsoft Teams |
| Nome società partner | HighSide, Inc |
| Sito Web aziendale | [https://highside.io](https://highside.io) |
| Condizioni per l'uso dell'app | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| Funzionalità di base dell'app | File di messaggistica crittografata &amp; E2E per Microsoft Teams. |
| Sede centrale dell'azienda | Stati Uniti of America |
| Pagina delle informazioni dell'app | [https://highside.io/secureteams](https://highside.io/secureteams) |
...
| Quali dati vengono archiviati nei database? | User Microsoft UUID, User Name, User Email Address |
