---
title: Informazioni sull'applicazione per l'assembly di CarrotHR Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Tutte le informazioni disponibili sulla sicurezza e sulla conformità per Assembly, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64879413"
---
# <a name="assembly"></a>Assembly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 21 maggio 2021</p>

* <a href="https://teams.microsoft.com/l/app/3e674b5f-ba5d-41cc-8b06-e065b4394aeb" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002271" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da CarrotHR Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Assembly |
| ID | WA200002271 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | CarrotHR Inc. |
| Sito Web dell'azienda | [https://www.joinassembly.com](https://www.joinassembly.com) |
| Condizioni per l'utilizzo dell'app | [https://joinassembly.com/terms-of-service](https://joinassembly.com/terms-of-service) |
| Funzionalità di base dell'app | Assembly è una piattaforma di coinvolgimento e riconoscimento dei dipendenti. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.joinassembly.com/about](https://www.joinassembly.com/about) |
...
Queste informazioni sono state fornite da CarrotHR Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC1 più recente | 2020-09-01 |
| L'app è conforme ai controlli dell'organizzazione del servizio (SOC 2)? | Sì |
| Data di certificazione SOC2 più recente | 2021-02-28 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | Delegato | Consenti all'utente di assegnare un'app a un canale appena creato dall'app | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Directory.Read.All | Applicazione | Mantenere sincronizzati i profili in modo che i membri siano correttamente ricercabili nell'assembly | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Group.Read.All | Delegato | Osserviamo i dati per essere certi che possano assegnare l'app al gruppo corretto | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Teams. ReadBasic.All | Applicazione | Possibilità di assegnare l'app alla scheda del team corretta | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| TeamsTab.Create | Applicazione | Questa operazione viene usata per consentire l'aggiunta corretta dell'app a un canale/team | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| email | Delegato | Messaggio di posta elettronica dell'utente in modo che sia possibile concedere loro l'accesso al proprio account specifico | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| profile | Delegato | Nome utente per popolare automaticamente Assembly e mantenere la sincronizzazione con le modifiche in Microsoft Teams | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
