...
description: Tutte le informazioni di sicurezza e conformità disponibili per 10xGoals, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64877043"
---
# <a name="10xgoals"></a>10xGoals

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 8 luglio 2021</p>

* <a href="https://teams.microsoft.com/l/app/950aa4fb-0583-4b13-9b5f-bbc92b9cc376" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | 10xGoals |
| ID | WA200003122 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Tecnologie xto10x |
| Sito Web dell'azienda | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| Condizioni per l'utilizzo dell'app | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| Funzionalità di base dell'app | 10xGoals è uno strumento per guidare le strategie all'esecuzione con focus, allineamento, collaborazione e visibilità a livello di team. Con 10xGoals &lt;&gt; Microsoft Teams integrazione, è possibile gestire l'intera esecuzione qui stesso. Per iniziare, gli utenti possono accettare/rifiutare/commentare gli obiettivi assegnati loro per gestire meglio il proprio tempo. Per usare questa app, gli utenti devono avere una sottoscrizione 10xGoals attiva. |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
...
Queste informazioni sono state fornite da xto10x Technologies su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Applicazione | La posta elettronica e l'ID di Azure degli utenti vengono recuperati in modo che l'app possa installare l'app in modo proattivo per tutti gli utenti dell'organizzazione.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | Applicazione | È necessario in modo che l'app possa recuperare teamsAppDefinition installato per l'amministratore e quindi installarsi in modo proattivo per tutti gli utenti dell'organizzazione.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
