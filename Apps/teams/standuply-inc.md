...
description: Tutte le informazioni di sicurezza e conformità disponibili per Standuply, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1250b735-e9df-4d5b-ae82-da96c55c64e4" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Standuply |
| ID | WA200003001 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Standuply Inc. |
| Sito Web dell'azienda | [https://standuply.com](https://standuply.com) |
| Condizioni per l'utilizzo dell'app | [https://standuply.com/terms](https://standuply.com/terms) |
| Funzionalità di base dell'app | Automatizza in modo autonomo i processi di gestione e fornisce un sistema di QA&amp; interno per aumentare la produttività del team. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://standuply.com](https://standuply.com) |
...
Queste informazioni sono state fornite da Standuply Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | P.3 di https://standuply.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| MailboxSettings.Read | Applicazione | Per inviare report su singoli utenti fuso orario | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
>| User.Read | Delegato | Per autorizzare gli utenti nel prodotto | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
