...
>| profile | delegated | N/D | Microsoft raccoglie l'UPN e l'ID AAD per l'autorizzazione. | [8c5c0060-2892-4355-b0db-661f206028a9](https://docs.microsoft.com/microsoft-365-app-certification/azure/8c5c0060-2892-4355-b0db-661f206028a9) |
...
>La telemetria del bot contiene l'UPN e l'ID AAD diagnostica fr.
...
Witivio usa MFA per tutti gli utenti, inclusi gli amministratori. Gli amministratori dispongono di un account utente (per la workstation) e di un account con privilegi per l'accesso ai ressource di Azure.
