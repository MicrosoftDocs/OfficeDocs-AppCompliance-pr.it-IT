---
title: Informazioni sull'applicazione per il bot zero-time di Replicon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per il bot a tempo zero, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65269946"
---
# <a name="zero-time-bot"></a>Bot a tempo zero

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 8 dicembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/4db812e1-4d29-44e4-b72e-9654c0c91ce4" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003717" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Replicon a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Bot a tempo zero |
| ID | WA200003717 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Replicon |
| Sito Web dell'azienda | [https://www.replicon.com](https://www.replicon.com) |
| Condizioni per l'utilizzo dell'app | [https://www.replicon.com/terms-and-conditions/](https://www.replicon.com/terms-and-conditions/) |
| Funzionalità di base dell'app | Zero Time Bot consente agli utenti di popolare direttamente le schede attività di Replicon chattando con il bot. |
...
Queste informazioni sono state fornite da Replicon sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Dati del profilo utente, Dati relativi all'ora |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | Applicazione | ottenere il messaggio di posta elettronica dell'utente e eseguirne il mapping all'utente nel sistema di Replicon per eseguire il push dei messaggi di chat nell'applicazione Replicon | [4db812e1-4d29-44e4-b72e-9654c0c91ce4](../azure/4db812e1-4d29-44e4-b72e-9654c0c91ce4.md) |
