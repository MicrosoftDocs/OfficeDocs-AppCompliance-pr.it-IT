---
title: Informazioni sull'applicazione per Webdashboard di In Summa
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/14/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Webdashboard, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64866865"
---
# <a name="webdashboard"></a>Webdashboard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 14 dicembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/e0b1ef6e-9433-44ef-97eb-f1f97ff2aa1a" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Webdashboard |
| ID | WA200002970 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | In Summa |
| Sito Web dell'azienda | [https://www.webdashboard.com](https://www.webdashboard.com) |
| Condizioni per l'utilizzo dell'app | [https://webdashboard.com/wp-content/uploads/2021/06/Nederla...](https://webdashboard.com/wp-content/uploads/2021/06/Nederland-ICT-Voorwaarden-2014-EN.pdf) |
| Funzionalità di base dell'app | Incorporare un report di Power BI, come scheda, usando single Sign-On tramite Webdashboard |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://webdashboard.com/feature/teams-app/](https://webdashboard.com/feature/teams-app/) |
...
Queste informazioni sono state fornite da In Summa su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | Applicazione | Single Sign-On per l'utente | [38b3f4fa-4229-4d51-9937-6e4515650c8c](../azure/38b3f4fa-4229-4d51-9937-6e4515650c8c.md) |
