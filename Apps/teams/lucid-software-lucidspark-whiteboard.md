---
title: Informazioni sull'applicazione per Lucidspark Whiteboard di Lucid Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Lucidspark Whiteboard, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64875393"
---
# <a name="lucidspark-whiteboard"></a>Lavagna Di Lucidspark

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 13 maggio 2021</p>

* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Lavagna Di Lucidspark |
| ID | WA200002583 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Lucid Software |
| Sito Web dell'azienda | [https://lucid.co](https://lucid.co) |
| Condizioni per l'utilizzo dell'app | [https://lucid.co/tos](https://lucid.co/tos) |
| Funzionalità di base dell'app | Lucidspark è una lavagna virtuale basata sul cloud in cui i team possono portare alla luce le loro idee migliori. Creare un brainstorming e collaborare in team in tempo reale, indipendentemente dal fatto che tu&#8217;di lavorare in remoto o di persona. Lucidspark aiuta le persone a organizzare note e scarabocchi e a trasformarle in concetti pronti per la presentazione. Quando&#8217;tempo per i passaggi successivi, i team possono sviluppare flussi di lavoro ed elaborare documenti per trasformare le idee in realtà. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://lucidchart.zendesk.com](https://lucidchart.zendesk.com) |
...
Queste informazioni sono state fornite da Lucid Software sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Delegato | Nome e indirizzo di posta elettronica. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| openid | Delegato | Nome e indirizzo di posta elettronica. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| profile | Delegato | Nome e indirizzo di posta elettronica. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
