...
description: Tutte le informazioni di sicurezza e conformità disponibili per ReTeam, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/92c90c0c-9a22-42ae-be52-c078eae02dea" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | ReTeam |
| ID | WA200003293 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | BeRemote LLC |
| Sito Web dell'azienda | [https://www.beremote.com](https://www.beremote.com) |
| Condizioni per l'utilizzo dell'app | [https://www.beremote.com/terms-of-use](https://www.beremote.com/terms-of-use) |
| Funzionalità di base dell'app | ReTeam fornisce strumenti per team professionali, allenatori e mentori per l'engagement e la coesione sociale |
...
Queste informazioni sono state fornite da BeRemote LLC su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
