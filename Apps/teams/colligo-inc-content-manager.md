...
description: Tutte le informazioni di sicurezza e conformità disponibili per Content Manager, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/36ad88c6-ffce-4c52-a5a5-3eae64ed65bf" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Responsabile della gestione del contenuto |
| ID | WA200003250 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Colligo Inc |
| Sito Web dell'azienda | [https://www.colligo.com](https://www.colligo.com) |
| Condizioni per l'utilizzo dell'app | [https://www.colligo.com/media/Colligo-Software-License-Agre...](https://www.colligo.com/media/Colligo-Software-License-Agreement-Schedule-A.pdf) |
| Funzionalità di base dell'app | Gestione contenuto consente di accedere ai file Microsoft 365 direttamente all'interno di Microsoft Teams |
...
Queste informazioni sono state fornite da Colligo Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
