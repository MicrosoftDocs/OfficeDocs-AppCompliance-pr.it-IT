...
description: Tutte le informazioni di sicurezza e conformità disponibili per Stylebot, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880533"
---
# <a name="stylebot"></a>Stylebot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 7 dicembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Stylebot |
| ID | WA200003177 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Stylebot Inc |
| Sito Web dell'azienda | [https://www.stylebot.app](https://www.stylebot.app) |
| Condizioni per l'utilizzo dell'app | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| Funzionalità di base dell'app | Stylebot migliora la scrittura mettendo a portata di mano un linguaggio moderno e un manuale di stile |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.stylebot.app/msteamshelp](https://www.stylebot.app/msteamshelp) |
...
Queste informazioni sono state fornite da Stylebot Inc su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
