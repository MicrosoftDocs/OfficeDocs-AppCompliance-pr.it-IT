---
title: Informazioni sull'applicazione per l'invio ritardato da parte di Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per l'invio ritardato, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66247938"
---
# <a name="delayed-send"></a>Invio ritardato

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 21 giugno 2022</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693a99f7fc3" target="_blank">Visualizzazione in Teams Store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004301" target="_blank">Visualizzazione in AppSource</a>
...
| Condizioni per l'utilizzo dell'app | [https://delayedsend.com/eula](https://delayedsend.com/eula) |
| Funzionalità di base dell'app | Pianificare l'invio dei messaggi in futuro a qualsiasi chat privata o di gruppo. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://delayedsend.com](https://delayedsend.com) |
...
| Quali dati vengono elaborati dall'app? | Elenco di chat di gruppo e personali in Teams, per aiutare l'utente a scegliere dove inviare un messaggio. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | Delegato | Mostra l'utente che è in una chat in modo che capisca dove sta inviando il messaggio | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| ChatMessage.Send | Delegato | Inviare un messaggio per conto dell'utente | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.Read | Delegato | Accedere all'utente e apprendere il nome dell'utente | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.ReadBasic.All | Delegato | Visualizzare l'elenco dei collaboratori dell'utente per consentire la selezione di una destinazione per il messaggio ritardato | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| offline_access | Delegato | Consenti all'app di fungere da utente al momento pianificare per il recapito dei messaggi | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
