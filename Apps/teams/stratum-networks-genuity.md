---
title: Informazioni sull'applicazione per la genuità di Stratum Networks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Genuity, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1d37e38f-7513-4239-8251-208a749bba7e" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004008" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Stratum Networks a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Genuity |
| ID | WA200004008 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Stratum Networks |
| Sito Web dell'azienda | [https://secure.gogenuity.com](https://secure.gogenuity.com) |
| Condizioni per l'utilizzo dell'app | [https://gogenuity.com/terms](https://gogenuity.com/terms) |
| Funzionalità di base dell'app | Gestire l'helpdesk genuity all'interno del Microsoft Teams |
...
Queste informazioni sono state fornite da Stratum Networks sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
