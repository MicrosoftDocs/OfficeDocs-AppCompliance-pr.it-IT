...
description: Tutte le informazioni di sicurezza e conformità disponibili per Promemoria, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/88546d4f-9973-4716-98e4-cd181c04bc2d" target="_blank">Visualizza in Teams store</a>
...
| Sito Web dell'azienda | [https://moonbearapps.com](https://moonbearapps.com) |
| Condizioni per l'utilizzo dell'app | [https://teamsreminder.app/#terms](https://teamsreminder.app/#terms) |
| Funzionalità di base dell'app | Ricorda a te stesso o ai membri del team riunioni importanti, cose da fare o persino compleanni. Imposta promemoria personali, promemoria di chat di gruppo o promemoria del canale. È anche possibile impostare promemoria ricorrenti (ad esempio una riunione del team ogni lunedì alle 9:00)! |
| Sede centrale dell'azienda | Hong Kong |
| Pagina delle informazioni sull'app | [https://teamsreminder.app](https://teamsreminder.app) |
...
Queste informazioni sono state fornite da 88 Ventures Limited su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | GUID utente e nomi utente quando si ricorda ad altri utenti |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegato | Usato quando un amministratore cerca gli utenti per assegnarli alle licenze. L'utilizzo di questa funzionalità è completamente facoltativo e non obbligatorio durante il normale uso dell'app. | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
>| People.Read.All | Delegato | Usato quando un utente vuole assegnare gli utenti a una licenza | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
