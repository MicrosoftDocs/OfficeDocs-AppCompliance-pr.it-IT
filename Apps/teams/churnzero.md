...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per ChurnZero, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | ChurnZero |
| ID | WA200002581 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | ChurnZero |
| Sito Web dell'azienda | [https://churnzero.net](https://churnzero.net) |
| Condizioni per l'utilizzo dell'app | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| Funzionalità di base dell'app | ChurnZero è una piattaforma customer success in tempo reale che consente alle aziende in abbonamento di combattere la varianza, espandere gli account correnti, aumentare l'adozione dei prodotti e ottimizzare l'esperienza del cliente. |
...
Questa informazione è stata fornita da ChurnZero sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-11-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegato | ID oggetto di Azure dell'utente che delega la correlazione con un utente ChurnZero, per identificare e autorizzare tale utente durante una sessione di bot futura. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
