...
| Sito Web aziendale | [https://churnzero.net](https://churnzero.net) |
| Condizioni per l'uso dell'app | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| Funzionalità di base dell'app | ChurnZero è una piattaforma di successo dei clienti in tempo reale che aiuta le aziende in abbonamento a combattere la varianza, espandere gli account correnti, aumentare l'adozione del prodotto e ottimizzare l'esperienza del cliente. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegated | ID oggetto Azure dell'utente delegante da correlare a un utente ChurnZero, per identificare e autorizzare tale utente durante una sessione bot futura. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
