---
title: Informazioni sull'applicazione per la gestione degli eventi di SharePoint| Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Gestione eventi, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64784255"
---
# <a name="event-management"></a>Gestione eventi

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 22 marzo 2022</p>

* <a href="https://teams.microsoft.com/l/app/2b8b9b59-d595-46b3-ba0a-602024bab0cc" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000714" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Gestione eventi |
| ID | WA200000714 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | \|SharePoint Sapiens |
| Sito Web dell'azienda | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
| Condizioni per l'utilizzo dell'app | [https://addins.sharepointsapiens.com/licensing/services-agr...](https://addins.sharepointsapiens.com/licensing/services-agreement.html) |
| Funzionalità di base dell'app | Il componente aggiuntivo Gestione eventi consente di organizzare vari tipi di eventi. Gli eventi possono essere pianificati in pochissimo tempo in pochi semplici passaggi. I partecipanti possono registrarsi online con un solo clic. Come organizzatore è anche possibile registrare utenti interni o esterni per conto o inviare inviti tramite posta elettronica. I partecipanti ricevono convocazioni di riunione e aggiornamenti tramite posta elettronica per assicurarsi di avere sempre le informazioni più recenti nel calendario Outlook. Il componente aggiuntivo tiene traccia di tutti i partecipanti in un'unica posizione. |
| Sede centrale dell'azienda | Austria |
| Pagina delle informazioni sull'app | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/documentation/teams/) |
