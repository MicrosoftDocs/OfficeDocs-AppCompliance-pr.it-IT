---
title: Informazioni sull'applicazione per Tonkean di Tonkean
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Tonkean, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65455057"
---
# <a name="tonkean"></a>Tonkean

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 16 maggio 2022</p>

* <a href="https://teams.microsoft.com/l/app/b7391d00-e8e4-4dc9-970e-ba3386144114" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381749" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Tonkean a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Tonkean |
| ID | WA104381749 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Tonkean |
| Sito Web dell'azienda | [https://tonkean.com](https://tonkean.com) |
| Condizioni per l'utilizzo dell'app | [https://tonkean.com/terms/](https://tonkean.com/terms/) |
| Funzionalità di base dell'app | Tonkean consente alle organizzazioni e ai team operativi di automatizzare rapidamente processi aziendali complessi. Tonkean fornisce i blocchi predefiniti per eseguire, monitorare e gestire qualsiasi processo aziendale integrato in Solution Studio completamente senza codice.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://tonkean.com](https://tonkean.com) |
...
Queste informazioni sono state fornite da Tonkean su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | No |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Nome, Posta elettronica, ID utente. Altri dati potrebbero essere archiviati su richiesta/scelta dell'utente. |
...
| URL dell'informativa sulla privacy | https://tonkean.com/privacy |
