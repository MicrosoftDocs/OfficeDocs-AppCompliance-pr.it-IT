---
title: Informazioni sull'applicazione per Expensya di Expensya
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Expensya, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/acbc0cba-5e0a-4bb5-a15c-21bce2863f01" target="_blank">Visualizza in Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003924" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Expensya a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Expensya |
| ID | WA200003924 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Expensya |
| Sito Web dell'azienda | [https://www.expensya.com](https://www.expensya.com) |
| Condizioni per l'utilizzo dell'app | [https://www.expensya.com/en/tou](https://www.expensya.com/en/tou) |
| Funzionalità di base dell'app | Expensya automatizza la spesa aziendale, end-to-end, dall'elaborazione della fattura alle carte aziendali |
...
Queste informazioni sono state fornite da Expensya sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | Profilo aziendale, profili utente (dipendenti) e elementi spesa aziendale |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Token di Microsoft Graph (durante l'integrazione con Teams!) |
...
| URL dell'informativa sulla privacy | https://www.expensya.com/en/legal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Applicazione | Sono necessari il nome completo e l'indirizzo di posta elettronica dell'utente | [6ce7c411-d7c9-4c4f-882e-164447c9b44a](../azure/6ce7c411-d7c9-4c4f-882e-164447c9b44a.md) |
