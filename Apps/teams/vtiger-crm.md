...
description: Tutte le informazioni di sicurezza e conformità disponibili per Vtiger CRM, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/08cb9b41-2ceb-4fe1-b85b-6eb6128aa138" target="_blank">Visualizza in Teams store</a>
...
|:----------------|:-------------|
| Nome dell'app | Vtiger CRM |
| ID | WA200003089 |
| client Office 365 supportati | Microsoft Teams |
| Nome della società partner | Vtiger |
| Sito Web dell'azienda | [https://www.vtiger.com](https://www.vtiger.com) |
| Condizioni per l'utilizzo dell'app | [https://www.vtiger.com/policy-legal-center/terms-of-service/](https://www.vtiger.com/policy-legal-center/terms-of-service/) |
| Funzionalità di base dell'app | Connessione Vtiger CRM per visualizzare e condividere trattative, casi, attività o contatti all'interno del team. |
| Sede centrale dell'azienda | India |
| Pagina delle informazioni sull'app | [https://help.vtiger.com/article/149601890-MS-Teams-and-Vtig...](https://help.vtiger.com/article/149601890-MS-Teams-and-Vtiger-CRM-Integration) |
...
Queste informazioni sono state fornite da Vtiger sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Elencare i tipi di criteri supportati | Restrizione in base all'indirizzo IP. Controllo di accesso ai dati tramite ruoli e profili. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Applicazione | L'indirizzo di posta elettronica viene ottenuto per la verifica rispetto a AuthToken. | [7a483472-4f1b-4c75-bff3-7a48dae227dc](../azure/7a483472-4f1b-4c75-bff3-7a48dae227dc.md) |
