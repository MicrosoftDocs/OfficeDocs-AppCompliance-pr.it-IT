---
title: Informazioni sull'applicazione per RocketDocs LaunchPad di RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per RocketDocs LaunchPad, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64880733"
---
# <a name="rocketdocs-launchpad"></a>RocketDocs LaunchPad

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 27 ottobre 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da RocketDocs a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | RocketDocs LaunchPad |
| ID | WA200003648 |
| client Office 365 supportati | Excel 2016 o versioni successive in Mac, Excel 2016 o versioni successive in Windows, Excel sul web, Word 2016 o versioni successive in Mac, Word sul web, Word 2016 o versioni successive in Windows |
| Nome della società partner | RocketDocs |
| Sito Web dell'azienda | [https://rocketdocs.com](https://rocketdocs.com) |
| Condizioni per l'utilizzo dell'app | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| Funzionalità di base dell'app | Consente agli utenti di individuare il contenuto nella piattaforma RocketDocs e inserirlo in un documento. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
Queste informazioni sono state fornite da RocketDocs sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
