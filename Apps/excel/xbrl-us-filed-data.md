...
| Funzionalità di base dell'app | XBRL US è il consorzio senza scopo di lucro che costruisce e supporta standard di reporting aziendali gratuiti, aperti e nonproprietari negli Stati Uniti XBRL US ha guidato lo sviluppo e l'implementazione di standard di dati per le agenzie governative- la Securities and Exchange Commission (SEC), la Federal Energy Regulatory Commission (FERC) e il Department of Energy. XBRL US monitora i dati e aiuta a creare standard di qualità dei dati utilizzati dalla SEC per aiutare le aziende pubbliche a creare rendiconti finanziari XBRL di buona qualità.  |
