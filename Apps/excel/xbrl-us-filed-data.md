...
description: Tutte le informazioni di sicurezza e conformità disponibili per I dati di archiviazione XBRL, i relativi criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://xbrl.us](https://xbrl.us) |
| Condizioni per l'uso dell'app | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| Funzionalità di base dell'app | XBRL US è il consorzio senza scopo di lucro che costruisce e supporta gli standard di reporting aziendali gratuiti, aperti e nonpropriotici negli Stati Uniti XBRL US ha guidato lo sviluppo e l'implementazione di standard di dati per le agenzie governative - la Securities and Exchange Commission (SEC), la Federal Energy Regulatory Commission (FERC) e il Department of Energy. XBRL US monitora i dati e aiuta a creare standard di qualità dei dati utilizzati dalla SEC per aiutare le aziende pubbliche a creare rendiconti finanziari XBRL di buona qualità.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni dell'app | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? |  |
| Quali provider di cloud di hosting usa l'app? | GitHub |
...
Queste informazioni sono state fornite da XBRL US su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
