---
title: Informazioni sull'applicazione per le firme di impressioni in base alle firme delle impressioni
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per le firme impressioni, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64871042"
---
# <a name="impression-signatures"></a>Firme di impressioni

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 31 agosto 2021</p>
...
Informazioni fornite da Impression Signatures a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Firme di impressioni |
| ID | WA200003216 |
...
| Nome della società partner | Firme di impressioni |
| Sito Web dell'azienda | [https://www.impression-signatures.com](https://www.impression-signatures.com) |
| Condizioni per l'utilizzo dell'app | [https://www.iubenda.com/terms-and-conditions/8039352](https://www.iubenda.com/terms-and-conditions/8039352) |
| Funzionalità di base dell'app | Impression Signatures fornisce eSignature conformi a ECT Act e secure document delivery. Gestione del flusso di lavoro della firma e restituzione di una catena di custodia sicura aggiunta al documento firmato.  |
...
Queste informazioni sono state fornite da Impression Signatures sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2021-06-09 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | Entrambi | Dati di autenticazione e dati della directory. | [be181d9c-9060-40a0-a692-b29f2e314d16](../azure/be181d9c-9060-40a0-a692-b29f2e314d16.md) |
