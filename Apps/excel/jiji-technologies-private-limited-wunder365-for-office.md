...
<span data-ttu-id="7f277-107">Informazioni fornite da JiJi Technologies Private Limited per Microsoft:</span><span class="sxs-lookup"><span data-stu-id="7f277-107">Information provided by JiJi Technologies Private Limited to Microsoft:</span></span>
...
><span data-ttu-id="7f277-158">Non vengono servizi Microsoft non vengono utilizzati.</span><span class="sxs-lookup"><span data-stu-id="7f277-158">Non-Microsoft services are not used.</span></span>
...
### <a name="identity-information"></a><span data-ttu-id="7f277-182">Informazioni sull'identità</span><span class="sxs-lookup"><span data-stu-id="7f277-182">Identity information</span></span>

<span data-ttu-id="7f277-183">Queste informazioni sono state fornite da JiJi Technologies Private Limited sul modo in cui questa app gestisce l'autenticazione, l'autorizzazione, le procedure consigliate per la registrazione delle applicazioni e altri criteri di identità.</span><span class="sxs-lookup"><span data-stu-id="7f277-183">This information has been provided by JiJi Technologies Private Limited about how this app handles authentication, authorization, application registration best practices, and other Identity criteria.</span></span>

| <span data-ttu-id="7f277-184">**Informazioni**</span><span class="sxs-lookup"><span data-stu-id="7f277-184">**Information**</span></span> | <span data-ttu-id="7f277-185">**Risposta**</span><span class="sxs-lookup"><span data-stu-id="7f277-185">**Response**</span></span> |
|:----------------|:-------------|
| <span data-ttu-id="7f277-186">Eseguire l'integrazione con Microsoft Identify Platform (Azure AD)?</span><span class="sxs-lookup"><span data-stu-id="7f277-186">Do you integrate with Microsoft Identify Platform (Azure AD)?</span></span>  | <span data-ttu-id="7f277-187">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-187">Yes</span></span> |
| <span data-ttu-id="7f277-188">Sono state esaminate e rispettate tutte le procedure consigliate applicabili descritte nell'elenco Microsoft Identity Platform di integrazione?</span><span class="sxs-lookup"><span data-stu-id="7f277-188">Have you reviewed and complied with all applicable best practices outlined in the Microsoft identity platform integration checklist?</span></span>  | <span data-ttu-id="7f277-189">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-189">Yes</span></span> |
| <span data-ttu-id="7f277-190">L'app usa MSAL (Microsoft Authentication Library) per l'autenticazione?</span><span class="sxs-lookup"><span data-stu-id="7f277-190">Does your app use MSAL (Microsoft Authentication Library) for authentication?</span></span> | <span data-ttu-id="7f277-191">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-191">Yes</span></span> |
| <span data-ttu-id="7f277-192">L'app supporta i criteri di accesso condizionale?</span><span class="sxs-lookup"><span data-stu-id="7f277-192">Does your app support Conditional Access policies?</span></span> | <span data-ttu-id="7f277-193">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-193">Yes</span></span> |
| <span data-ttu-id="7f277-194">Elencare i tipi di criteri supportati</span><span class="sxs-lookup"><span data-stu-id="7f277-194">List the types of policies supported</span></span> | <span data-ttu-id="7f277-195">Richiedere l'autenticazione a più fattori per gli utenti con ruoli amministrativi, Richiedere l'autenticazione a più fattori per le attività di gestione di Azure, Blocco degli accessi per gli utenti che tentano di utilizzare protocolli di autenticazione legacy, Richiesta di percorsi attendibili per la registrazione di Azure AD Multi-Factor Authentication, Blocco o concessione dell'accesso da posizioni specifiche, Blocco del comportamento di accesso rischioso</span><span class="sxs-lookup"><span data-stu-id="7f277-195">Requiring multi-factor authentication for users with administrative roles, Requiring multi-factor authentication for Azure management tasks, Blocking sign-ins for users attempting to use legacy authentication protocols, Requiring trusted locations for Azure AD Multi-Factor Authentication registration, Blocking or granting access from specific locations, Blocking risky sign-in behavior</span></span> |
| <span data-ttu-id="7f277-196">L'app richiede autorizzazioni con privilegi minimi per lo scenario?</span><span class="sxs-lookup"><span data-stu-id="7f277-196">Does your app request least privilege permissions for your scenario?</span></span> | <span data-ttu-id="7f277-197">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-197">Yes</span></span> |
| <span data-ttu-id="7f277-198">Le autorizzazioni registrate in modo statico dell'app riflettono in modo accurato le autorizzazioni richieste dall'app in modo dinamico e incrementale?</span><span class="sxs-lookup"><span data-stu-id="7f277-198">Does your app's statically registered permissions accurately reflect the permissions your app will request dynamically and incrementally?</span></span> | <span data-ttu-id="7f277-199">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-199">Yes</span></span> |
| <span data-ttu-id="7f277-200">L'app supporta la multi-tenancy?</span><span class="sxs-lookup"><span data-stu-id="7f277-200">Does your app support multi-tenancy?</span></span> | <span data-ttu-id="7f277-201">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-201">Yes</span></span> |
| <span data-ttu-id="7f277-202">L'app dispone di un client riservato?</span><span class="sxs-lookup"><span data-stu-id="7f277-202">Does your app have a confidential client?</span></span> | <span data-ttu-id="7f277-203">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-203">Yes</span></span> |
| <span data-ttu-id="7f277-204">Sei il proprietario di tutti gli URI (Unified Resource Identifier) di reindirizzamento registrati per la tua app?</span><span class="sxs-lookup"><span data-stu-id="7f277-204">Do you own all of the redirect Unified Resource Identifier (URI) registered for your app?</span></span> | <span data-ttu-id="7f277-205">Sì</span><span class="sxs-lookup"><span data-stu-id="7f277-205">Yes</span></span> |
| <span data-ttu-id="7f277-206">Per la tua app, cosa evita di usare?</span><span class="sxs-lookup"><span data-stu-id="7f277-206">For your app, what do you avoid using?</span></span> | <span data-ttu-id="7f277-207">- URI di reindirizzamento con caratteri jolly,</span><span class="sxs-lookup"><span data-stu-id="7f277-207">- Wildcard redirect URIs,</span></span>
<br />
