---
title: Informazioni sull'applicazione per ArcGIS per SharePoint di Esri, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/04/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per ArcGIS per SharePoint, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
|:----------------|:-------------|
| Nome dell'app | ArcGIS per SharePoint |
| ID | WA200003118 |
