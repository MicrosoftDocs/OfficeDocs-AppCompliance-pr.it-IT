---
title: Informazioni sull'applicazione per Zynyo Sign for SharePoint Online di Zynyo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Zynyo Sign for SharePoint Online, i criteri di gestione dei dati, le informazioni sul catalogo app di Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
ms.locfileid: "63553255"
---
# <a name="zynyo-sign-for-sharepoint-online"></a>Firma Zynyo per SharePoint Online

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 11, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003673" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Zynyo a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome app | Firma Zynyo per SharePoint Online |
| ID | WA200003673 |
| Office 365 client supportati | SharePoint 2016 o versione successiva |
| Nome società partner | Zynyo |
| Sito Web aziendale | [https://zynyo.com](https://zynyo.com) |
| Condizioni per l'uso dell'app | [https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf](https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf) |
| Funzionalità di base dell'app | Alle documenten eenvoudig en rechtsgeldig digitaal laten ondertekenen. |
| Sede centrale dell'azienda | Paesi Bassi (la) |
| Pagina delle informazioni dell'app | [https://zynyo.com/signing-service-diensten/sharepoint/](https://zynyo.com/signing-service-diensten/sharepoint/) |
...
Queste informazioni sono state fornite da Zynyo su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | Quando l'utente invia una richiesta di firma, il documento selezionato e i dati immessi vengono archiviati, possono includere dati del cliente come nome, indirizzo e-mail e numero di telefono. Questi dati vengono eliminati alla scadenza della richiesta di firma, per impostazione predefinita 30 giorni. |
...
| URL dell'informativa sulla privacy | https://zynyo.com/Zynyo-Privacyverklaring.pdf |
