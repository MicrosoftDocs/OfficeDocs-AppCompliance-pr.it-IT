...
| Sito Web aziendale | [https://hellosign.com](https://hellosign.com) |
...
| Quali dati vengono archiviati nei database? | id tenant, ID sito, e-mail, ID unità, ID elemento unità |
...
| Data di certificazione SOC2 più recente |  2020-10-01 |
...
| URL dell'informativa sulla privacy | https://www.hellosign.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | delegated | Per ottenere la posta elettronica dell'utente |
>| Sites.ReadWrite.All | application | Per caricare di nuovo i file firmati elettronicamente SharePoint |
>| Files.ReadWrite.All | application | Per caricare di nuovo i file firmati elettronicamente SharePoint |
