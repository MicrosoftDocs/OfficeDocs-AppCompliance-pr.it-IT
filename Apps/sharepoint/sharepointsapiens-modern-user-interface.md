---
title: Application Information for SharePoint|sapiens Modern User Interface by SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SharePoint|sapiens Modern User Interface, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
ms.locfileid: "64602603"
---
# <a name="sharepointsapiens-modern-user-interface"></a>SharePoint|sapiens Modern User Interface

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 30, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | SharePoint-sapiens Modern User Interface |
| ID | WA200003529 |
...
| Funzionalità di base dell'app | Questa app deve essere usata in combinazione con il nostro SharePoint|app sapiens Event Management (WA104380834) o SharePoint|app sapiens Employee Training Management (WA104380833).  Questa app offre un'interfaccia utente intuitiva che consente di creare e gestire eventi, argomenti, corsi e programmi di studio in SharePoint, registrare gli utenti o consentire loro di registrarsi e di tenere traccia di tutti i partecipanti, le assegnazioni e gli obiettivi. |
