---
title: Informazioni sull'applicazione per DocuSign per SharePoint Online di DocuSign, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/24/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per DocuSign per SharePoint Online, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65692428"
---
# <a name="docusign-for-sharepoint-online"></a>DocuSign per SharePoint Online
...
* <a href="https://appsource.microsoft.com/product/office/WA104218069" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | DocuSign per SharePoint Online |
| ID | WA104218069 |
...
| Funzionalità di base dell'app | Firmare o richiedere firme per i documenti in SharePoint. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.docusign.com/solutions/microsoft/sharepoint-onl...](https://www.docusign.com/solutions/microsoft/sharepoint-online) |
