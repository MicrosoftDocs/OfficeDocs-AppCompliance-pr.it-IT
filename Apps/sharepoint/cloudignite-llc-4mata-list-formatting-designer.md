---
title: Informazioni sull'applicazione per 4Mata - Progettazione formattazione elenco di CLOUDIGNITE LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per 4Mata - Progettazione formattazione elenco, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
---
# <a name="4mata---list-formatting-designer"></a>4Mata - Progettazione formattazione elenco
...
* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da CLOUDIGNITE LLC a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | 4Mata - Progettazione formattazione elenco |
| ID | WA200002892 |
| client Office 365 supportati | SharePoint 2016 o versione successiva |
| Nome della società partner | CLOUDIGNITE LLC |
| Sito Web dell'azienda | [https://4mata.com](https://4mata.com) |
| Condizioni per l'utilizzo dell'app | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| Funzionalità di base dell'app | 4Mata di CloudIgnite è un set di strumenti che consentono alle aziende di visualizzare i dati tramite la progettazione e la formattazione di elenchi e moduli SharePoint.  Con questa applicazione, gli utenti possono configurare in modo intuitivo moduli ed elenchi di SharePoint complessi e altamente personalizzati per report, fatture, pubblicazione dei dettagli del prodotto e raccolta di informazioni di contatto per integrarsi facilmente con i requisiti dei processi aziendali.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://4mata.com](https://4mata.com) |
...
Queste informazioni sono state fornite da CLOUDIGNITE LLC sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
