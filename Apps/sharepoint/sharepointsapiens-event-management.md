---
title: Application Information for SharePoint|sapiens Event Management by SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SharePoint|sapiens Event Management, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da SharePointSapiens a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | SharePoint-sapiens Event Management |
| ID | WA104380834 |
| Office 365 client supportati | SharePoint 2016 o versione successiva |
| Nome società partner | SharePointSapiens |
| Sito Web aziendale | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
...
| Funzionalità di base dell'app | Il componente aggiuntivo Gestione eventi consente di organizzare vari tipi di eventi. Gli eventi possono essere pianificati in pochi semplici passaggi. I partecipanti possono registrarsi online con un solo clic. Gli organizzatori possono anche registrare utenti interni o esterni per conto di o inviare inviti tramite posta elettronica. I partecipanti ricevono convocazioni di riunione e aggiornamenti tramite posta elettronica per assicurarsi di avere sempre le informazioni più recenti nel Outlook calendario. Il componente aggiuntivo tiene traccia di tutti i partecipanti in un'unica posizione. |
| Sede centrale dell'azienda | Austria |
| Pagina delle informazioni dell'app | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
...
Queste informazioni sono state fornite da SharePointSapiens sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | delegated | Leggere le informazioni di base sull'utente per abilitare Exchange prenotazione sala | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
