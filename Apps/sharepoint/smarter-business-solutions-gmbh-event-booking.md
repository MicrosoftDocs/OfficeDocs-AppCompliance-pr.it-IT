...
description: Tutte le informazioni di sicurezza e conformità disponibili per La prenotazione di eventi più intelligenti, i criteri di gestione dei dati, le informazioni del catalogo app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| Sito Web aziendale | [https://smarterbusiness.at](https://smarterbusiness.at) |
| Condizioni per l'uso dell'app | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| Funzionalità di base dell'app | Prenotazione eventi più intelligente consente agli utenti di Microsoft365 di registrarsi per eventi creati in precedenza. |
| Sede centrale dell'azienda | Austria |
| Pagina delle informazioni dell'app | [https://www.smarterbusiness.at/en/smarter-event-booking](https://www.smarterbusiness.at/en/smarter-event-booking) |
