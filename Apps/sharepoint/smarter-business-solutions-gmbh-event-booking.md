---
title: Informazioni sull'applicazione per la prenotazione di eventi più intelligenti di Smarter Business Solutions GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Smarter Event Booking, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64876533"
---
# <a name="smarter-event-booking"></a>Prenotazione di eventi più intelligente
...
|:----------------|:-------------|
| Nome dell'app | Prenotazione di eventi più intelligente |
| ID | WA200003125 |
| client Office 365 supportati | SharePoint 2016 o versione successiva |
| Nome della società partner | Smarter Business Solutions GmbH |
| Sito Web dell'azienda | [https://smarterbusiness.at](https://smarterbusiness.at) |
| Condizioni per l'utilizzo dell'app | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| Funzionalità di base dell'app | Smarter Event Booking consente agli utenti di Microsoft365 di iscriversi per gli eventi creati in precedenza. |
| Sede centrale dell'azienda | Austria |
| Pagina delle informazioni sull'app | [https://www.smarterbusiness.at/en/smarter-event-booking](https://www.smarterbusiness.at/en/smarter-event-booking) |
...
Queste informazioni sono state fornite da Smarter Business Solutions GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
