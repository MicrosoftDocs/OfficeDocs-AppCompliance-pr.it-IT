...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Agile Task Board per SharePoint Online, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64753901"
---
# <a name="agile-task-board-for-sharepoint-online"></a>Scheda attività Agile per SharePoint Online
...
|:----------------|:-------------|
| Nome dell'app | Scheda attività Agile per SharePoint Online |
| ID | WA200002087 |
