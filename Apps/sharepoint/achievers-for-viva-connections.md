---
title: Informazioni sull'applicazione per i responsabili del raggiungimento per Viva Connections da utenti che hanno raggiunto l'obiettivo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per i responsabili del raggiungimento di Viva Connections, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656143"
---
# <a name="achievers-for-viva-connections"></a>Obiettivi di Viva Connections
...
* <a href="https://appsource.microsoft.com/product/office/WA200004313" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Obiettivi di Viva Connections |
| ID | WA200004313 |
...
| Funzionalità di base dell'app | Schede di azione rapide per i membri che usano la piattaforma Achievers per firmare una scheda di celebrazione, visualizzare i riconoscimenti di auto-riconoscimento e i riconoscimenti di tendenza |
...
| Quali dati vengono archiviati nei database? | ID tenant, ID utente |
