---
title: Application Information for officeatwork | Uploader per Office per ufficiolavoro
ms.author: elmalova
author: elenamalova
ms.date: 01/07/2022
ms.topic: article
...
description: Tutte le informazioni sulla sicurezza e la conformità disponibili per officeatwork | Uploader per Office, i criteri di gestione dei dati, le Microsoft Cloud App Security del catalogo app e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
>| Files.ReadWrite.All | delegated | Abilita Preferiti, OneDrive funzionalità e caricamento di file |
...
>| Sites.Read.All | delegated | Leggere i file archiviati in SharePoint |
