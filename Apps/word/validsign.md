---
title: Informazioni sull'applicazione per ValidSign by ValidSign
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per ValidSign, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da ValidSign a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | ValidSign |
| ID | WA200001890 |
| client Office 365 supportati | Word 2016 o versioni successive in Mac, Word sul Web, Word 2013 o versioni successive in Windows |
| Nome della società partner | ValidSign |
| Sito Web dell'azienda | [https://www.validsign.eu](https://www.validsign.eu) |
| Condizioni per l'utilizzo dell'app | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| Funzionalità di base dell'app | Lavorare in modo più intelligente ed efficiente con il componente aggiuntivo ValidSign Word |
| Sede centrale dell'azienda | Paesi Bassi (i) |
| Pagina delle informazioni sull'app | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
Queste informazioni sono state fornite da ValidSign sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.validsign.eu/validsign-privacy-statement/ |
