...
description: Tutte le informazioni sulla sicurezza e la conformità disponibili per officeatwork | Procedura guidata per Office, i criteri di gestione dei dati, le Microsoft Cloud App Security del catalogo app e le informazioni sulla sicurezza/conformità nel Registro di sistema CSA STAR.
...
| ID | WA104380519 |
| Office 365 client supportati | Word 2016 o versione successiva su Mac, Word 2016 o versione successiva su Windows, Word iPad, Word sul web |
