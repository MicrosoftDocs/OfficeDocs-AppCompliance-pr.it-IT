...
description: Tutte le informazioni di sicurezza e conformità disponibili per CrossCheck, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
| Nome della società partner | kRevealLLC |
| Sito Web dell'azienda | [https://kreveal.com](https://kreveal.com) |
| Condizioni per l'utilizzo dell'app | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| Funzionalità di base dell'app | CrossCheck semplifica la revisione dei documenti e individua gli errori di redazione comuni. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
Queste informazioni sono state fornite da kRevealLLC sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | Applicazione | Non vengono raccolti o usati dati. | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
