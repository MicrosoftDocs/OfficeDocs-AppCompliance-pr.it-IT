---
title: "Informazioni sull'applicazione per FD Mxmn : importare dati aziendali da Maximon Ltd."
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: 'Tutte le informazioni sulla sicurezza e sulla conformità disponibili per FD Mxmn: importare i dati aziendali, i criteri di gestione dei dati, le informazioni del catalogo delle app di Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.'
...
ms.locfileid: "65943212"
---
# <a name="fd-mxmn---import-business-data"></a>FD Mxmn - Importare dati aziendali
...
* <a href="https://appsource.microsoft.com/product/office/WA200004151" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Maximon Ltd. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | FD Mxmn - Importare dati aziendali |
| ID | WA200004151 |
| Client di Office 365 supportati | Word 2016 o versione successiva in Mac, Word sul Web, Word 2013 o versioni successive in Windows |
| Nome della società partner | Maximon Ltd. |
| Sito Web dell'azienda | [https://www.maximon.ltd/fdmxmn/](https://www.maximon.ltd/fdmxmn/) |
| Condizioni per l'utilizzo dell'app | [https://www.maximon.ltd/legal_tou.php](https://www.maximon.ltd/legal_tou.php) |
| Funzionalità di base dell'app | Semplificare la redazione legale importando i dati aziendali direttamente dagli estratti di ACRA BizFile. |
...
Queste informazioni sono state fornite da Maximon Ltd. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.maximon.ltd/legal_privacy.php |
