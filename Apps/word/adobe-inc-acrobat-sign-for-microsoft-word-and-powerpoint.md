---
title: Informazioni sull'applicazione per Adobe Acrobat Sign for Microsoft Word e PowerPoint di Adobe Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
ms.locfileid: "64879133"
---
# <a name="adobe-acrobat-sign-for-microsoft-word-and-powerpoint"></a>Adobe Acrobat Firma per Microsoft Word e PowerPoint

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Ultimo aggiornamento da parte dello sviluppatore: 28 ottobre 2021</p>
...
|:----------------|:-------------|
| Nome dell'app | Adobe Acrobat Firma per Microsoft Word e PowerPoint |
| ID | WA104381155 |
| client Office 365 supportati | Word 2016 o versioni successive in Mac, Word sul web, Word 2013 Service Pack 1 o versioni successive Windows, PowerPoint 2016 o versioni successive in Mac, PowerPoint sul web, PowerPoint 2013 Service Pack 1 o versione successiva in Windows |
...
| Funzionalità di base dell'app | Mantenere veloci i flussi di lavoro di firma dei documenti quando si aggiunge Adobe Sign per Office. Ora, proprio nelle app Office come Word e PowerPoint, è possibile firmare documenti, inviarli per firme elettroniche e approvazioni legalmente vincolanti &#8212; tutti con la soluzione di firma elettronica preferita di Microsoft. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://helpx.adobe.com/sign/help/adobesign_microsoft_teams...](https://helpx.adobe.com/sign/help/adobesign_microsoft_teams.html) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.ReadWrite | Delegato | Per popolare il documento allegato, i messaggi di posta elettronica del mittente e del destinatario e il contenuto del messaggio dai messaggi di posta elettronica ad Adobe sign to send for signature.To populate the attached document, sender and receiver emails, and message content from emails to Adobe sign to send for signature. Ciò consente di risparmiare tempo all'utente per digitare nuovamente i campi in Adobe Sign. Dopo la firma di un contratto, viene creato automaticamente un nuovo messaggio di posta elettronica per consentire all'utente di inviare un messaggio di posta elettronica per informare i destinatari che la transazione è stata eseguita. | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| People.Read | Delegato | Per compilare automaticamente l'indirizzo di posta elettronica nell'esperienza Invia per la &quot;firma&quot; , digitando alcune lettere iniziali, non è necessario che gli utenti digitino tutti i messaggi di posta elettronica. | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| User.Read | Delegato | Per leggere il profilo dell'utente e associare il profilo (in pratica, la posta elettronica e userId) al database in modo che possano usare Adobe Sign. | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| offline_access | Delegato | Per aggiornare il token di accesso, quando quello corrente è scaduto. Ad esempio, quando l'utente è in una &quot;finestra invia per la firma&quot; e lo lascia inattivo per troppo tempo, è necessario aggiornare un nuovo token quando l'utente è attivo. | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| openid | Delegato | Email e UserId. Per accedere all'utente per assicurarsi il consenso per l'autorizzazione all'uso dell'app Adobe Sign.  | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
