---
title: Informazioni sull'applicazione per TaxKit Docs di Taxy.io GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per la documentazione taxkit, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Taxy.io GmbH a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | TaxKit Docs |
| ID | WA200002849 |
...
| Nome della società partner | Taxy.io GmbH |
| Sito Web dell'azienda | [https://www.taxy.io](https://www.taxy.io) |
| Condizioni per l'utilizzo dell'app | [https://go.microsoft.com](https://go.microsoft.com) |
| Funzionalità di base dell'app | TaxKit Docs aiuta i consulenti fiscali a trovare la documentazione legale pertinente per il documento e il caso su cui stanno lavorando. Questo li aiuta a consigliare i loro clienti in modo più efficace. |
...
Queste informazioni sono state fornite da Taxy.io GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
