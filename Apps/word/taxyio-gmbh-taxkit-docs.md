...
| Sito Web aziendale | [https://www.taxy.io](https://www.taxy.io) |
| Condizioni per l'uso dell'app | [https://go.microsoft.com](https://go.microsoft.com) |
| Funzionalità di base dell'app | TaxKit Docs aiuta i consulenti fiscali a trovare documentazione legale pertinente per il documento e il caso su cui stanno lavorando. Questo li aiuta a consigliare i propri client in modo più efficace. |
...
Queste informazioni sono state fornite da Taxy.io GmbH su come questa app raccoglie e archivia i dati dell'organizzazione e il controllo che l'organizzazione avrà sui dati raccolti dall'app.
