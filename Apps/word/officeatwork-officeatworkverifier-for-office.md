...
---
# <a name="officeatwork--verifier-for-office"></a>ufficial lavoro | Verificatore per Office
...
* <a href="https://appsource.microsoft.com/product/office/WA200000133" target="_blank">Visualizza in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | officeatwork - Verificatore per Office |
| ID | WA200000133 |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.Read | delegato | Non vengono memorizzati dati. | OneDrive: per poter leggere i file dell'utente che ha effettuato l'accesso | 8CF0FBC9-28F7-4BFB-94DB-237B049FCBF7 |
>| Files.Read.All | delegato | Non vengono memorizzati dati. | Teams: per leggere tutti i file a cui l'utente che ha effettuato l'accesso ha accesso. | 8CF0FBC9-28F7-4BFB-94DB-237B049FCBF7 |
>| Sites.Read.All | delegato | Non vengono memorizzati dati. | SharePoint Online: per abilitare la lettura dei dati SharePoint Online, l'utente che ha effettuato l'accesso ha accesso. | 8CF0FBC9-28F7-4BFB-94DB-237B049FCBF7 |
>| User.Read | delegato | Non vengono memorizzati dati. | Accesso: per consentire all'app officeatwork di leggere le proprietà di base dell'utente. | 8CF0FBC9-28F7-4BFB-94DB-237B049FCBF7 |
>| offline_access | delegato | Non vengono memorizzati dati. | Accesso: per abilitare l'accesso automatico tramite token di aggiornamento, come senza, gli utenti dovrebbero accedere manualmente ogni volta che avviano l'app officeatwork. Questo ambito è necessario solo per le applicazioni host non abilitate per SSO. | 8CF0FBC9-28F7-4BFB-94DB-237B049FCBF7 |
>| openid | delegato | Non vengono memorizzati dati. | Sing-In: per consentire agli utenti di accedere all'app officeatwork con il proprio account organizzativo e/o Microsoft. | 8CF0FBC9-28F7-4BFB-94DB-237B049FCBF7 |
>| profilo | delegato | Non vengono memorizzati dati. | Sing-In: per mostrare l'utente che ha effettuato l'accesso nell'app officeatwork. Ciò consente di assicurare/confermare all'utente l'account utilizzato per accedere all'app officeatwork. | 8CF0FBC9-28F7-4BFB-94DB-237B049FCBF7 |
...
<iframe height='1020' title='Microsoft Cloud App Security informazione' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35755" target="_blank">Visualizzare in una nuova scheda</a>
