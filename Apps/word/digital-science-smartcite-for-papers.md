---
title: Informazioni sulle applicazioni per SmartCite for Papers di Digital Science
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per SmartCite for Papers, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 29 maggio 2021</p>
...
|:----------------|:-------------|
| Nome dell'app | SmartCite for Papers |
| ID | WA104380917 |
| client Office 365 supportati | Word 2016 o versioni successive in Mac, Word 2016 o versioni successive Windows, Word sul web |
| Nome della società partner | Scienza digitale |
| Sito Web dell'azienda | [https://papersapp.com](https://papersapp.com) |
| Condizioni per l'utilizzo dell'app | [https://www.papersapp.com/terms](https://www.papersapp.com/terms) |
| Funzionalità di base dell'app | Cite references and generate bibliographies automatically from your ReadCube Papers library! |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.papersapp.com/smartcite-for-word/](https://www.papersapp.com/smartcite-for-word/) |
...
Queste informazioni sono state fornite da Digital Science su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
