...
description: Tutte le informazioni di sicurezza e conformità disponibili per RetMig &amp; Kommaforslag, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
|:----------------|:-------------|
| Nome dell'app | RetMig &amp; Kommaforslag |
| ID | WA104382003 |
| client Office 365 supportati | Word 2016 o versioni successive in Mac, Word 2016 o versioni successive Windows, Word sul web |
| Nome della società partner | GrammarSoft ApS |
| Sito Web dell'azienda | [https://retmig.dk](https://retmig.dk) |
| Condizioni per l'utilizzo dell'app | [https://retmig.dk/terms](https://retmig.dk/terms) |
| Funzionalità di base dell'app | RetMig er en avanceret stave- og grammatikkontrol for dansk, mens Kommaforslag retter kommafejl. |
| Sede centrale dell'azienda | Danimarca |
| Pagina delle informazioni sull'app | [https://retmig.dk](https://retmig.dk) |
...
Queste informazioni sono state fornite da GrammarSoft ApS su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
