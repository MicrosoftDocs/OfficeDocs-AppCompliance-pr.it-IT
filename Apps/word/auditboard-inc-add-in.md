---
title: Informazioni sull'applicazione per il componente aggiuntivo AuditBoard di Auditboard, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
| Funzionalità di base dell'app | Consente ai sottoscrittori auditboard di incorporare i dati del sito ab durante la modifica di Ab Narratives.Enables AuditBoard subscribers to embed links data &amp; to the AB site while editing AB Narratives.  |
...
Queste informazioni sono state fornite da Auditboard, Inc. Su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
