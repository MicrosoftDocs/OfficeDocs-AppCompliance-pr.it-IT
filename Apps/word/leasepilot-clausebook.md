---
title: Informazioni sull'applicazione per Clausebook di LeasePilot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Clausebook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da LeasePilot a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Clausebook |
| ID | WA200004044 |
| client Office 365 supportati | Word 2016 o versioni successive in Mac, Word sul Web, Word 2016 o versioni successive in Windows |
| Nome della società partner | LeasePilot |
| Sito Web dell'azienda | [https://clausebook.com](https://clausebook.com) |
| Condizioni per l'utilizzo dell'app | [https://clausebook.com/terms](https://clausebook.com/terms) |
| Funzionalità di base dell'app | Clausebook è il compagno di redazione dei documenti. Consente ai team di acquisire, organizzare, creare e condividere moduli e librerie di clausole per la rapida redazione e l'istituzionalizzazione delle procedure dell'organizzazione. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | |
| Qual è l'ambiente di hosting o il modello di servizio usato per eseguire l'app? | Paas |
| Quali provider di servizi cloud di hosting usano l'app? | Altro, Vercel |
...
Queste informazioni sono state fornite da LeasePilot sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2020-07-31 |
