---
title: Informazioni sull'applicazione per Mendeley Cite di ELSEVIER LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Mendeley Cite, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
|:----------------|:-------------|
| Nome dell'app | Mendeley Cite |
| ID | WA104382081 |
| client Office 365 supportati | Word su iPad, Word 2016 o versioni successive in Windows, Word 2016 o versioni successive su Mac, Word sul Web |
| Nome della società partner | ELSEVIER LIMITED |
| Sito Web dell'azienda | [https://www.mendeley.com/search/](https://www.mendeley.com/search/) |
| Condizioni per l'utilizzo dell'app | [https://www.mendeley.com/terms/](https://www.mendeley.com/terms/) |
| Funzionalità di base dell'app | Cite come scrivete. Generare citazioni e bibliografie e modificare lo stile di citazione. |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.mendeley.com/guides/mendeley-cite/](https://www.mendeley.com/guides/mendeley-cite/) |
...
Queste informazioni sono state fornite da ELSEVIER LIMITED su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://privacy.elsevier.com |
