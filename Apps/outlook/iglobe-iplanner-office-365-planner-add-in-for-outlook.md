---
title: Informazioni sull'applicazione per il componente aggiuntivo iPlanner Office 365 Planner per Outlook di iGlobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/28/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per il componente aggiuntivo iPlanner Office 365 Planner per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
| Condizioni per l'utilizzo dell'app | [https://iglobecrm.com/content/end-user-license-agreement-ig...](https://iglobecrm.com/content/end-user-license-agreement-iglobe-iplanner-add-ins) |
| Funzionalità di base dell'app | Ottieni le attività di Planner da Office 365 Planner &amp; Teams sulla punta della mano in Outlook su qualsiasi dispositivo. La gestione e la creazione di attività non sono mai state così semplici. Ottenere le attività di Planner da Office 365 Planner &amp; Teams sulla punta della mano, in Outlook per Windows, MAC, IOS o posta Web. |
| Sede centrale dell'azienda | Danimarca |
| Pagina delle informazioni sull'app | [https://planner.iglobe.dk](https://planner.iglobe.dk) |
