---
title: Informazioni sull'applicazione per CodeTwo per Outlook di CodeTwo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per CodeTwo per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003022" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | CodeTwo per Outlook |
| ID | WA200003022 |
...
| Funzionalità di base dell'app | Firme di posta elettronica automatiche, banner di marketing di dichiarazioni di non responsabilità &amp; legali nei messaggi. |
