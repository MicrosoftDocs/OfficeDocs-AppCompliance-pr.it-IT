---
title: Selezione contenuto per Outlook informazioni sull'applicazione
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Tutte le informazioni disponibili sulla sicurezza e sulla conformità per officeatwork | Selezione contenuto per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "64784015"
---
# <a name="content-chooser-for-outlook-application-information"></a>Selezione contenuto per Outlook informazioni sull'applicazione
...
|:----------------|:-------------|
| Nome dell'app | officeatwork - Scelta contenuto per Outlook |
| ID | WA104380690 |
