---
title: Informazioni sull'applicazione per Dynamo di Dynamo Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Dynamo, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65312290"
---
# <a name="dynamo"></a>Dynamo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 9 maggio 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Dynamo Software a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Dynamo |
| ID | WA200004007 |
...
| Nome della società partner | Dynamo Software |
| Sito Web dell'azienda | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| Condizioni per l'utilizzo dell'app | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| Funzionalità di base dell'app | Il componente aggiuntivo Office dynamo&#8217;per Outlook è un programma di supporto che consente agli utenti dynamo esistenti di usare Dynamo tramite applicazioni desktop Outlook per Windows e Outlook sul Web (Office 365 e Outlook.com). È possibile inviare bozze di stampa unione, aggiungere appuntamenti e attività insieme ai relativi allegati a Dynamo e creare nuovi elementi di tipo Contatto, Società, Trattativa e Fondo senza aprire Dynamo.  |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
...
Queste informazioni sono state fornite da Dynamo Software sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| URL dell'informativa sulla privacy | https://www.dynamosoftware.com/privacy-policy/ |
