---
title: Informazioni sulle applicazioni per Quantum Workplace di Quantum Workplace
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Quantum Workplace, i relativi criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104381747" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Quantum Workplace a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Quantum Workplace |
| ID | WA104381747 |
...
| Nome della società partner | Quantum Workplace |
| Sito Web dell'azienda | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
| Condizioni per l'utilizzo dell'app | [https://www.quantumworkplace.com/terms-of-use](https://www.quantumworkplace.com/terms-of-use) |
| Funzionalità di base dell'app | Aiutare i dipendenti ad avere successo con gli avvisi e le notifiche di Quantum Workplace. |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://www.quantumworkplace.com/product/employee-engagemen...](https://www.quantumworkplace.com/product/employee-engagement-software) |
...
Queste informazioni sono state fornite da Quantum Workplace sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Data di certificazione SOC2 più recente | 2021-06-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | Applicazione | Viene usato ChatId. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
>| User.Read.All | Applicazione | User.Id (archiviato) - Usato per correlare gli utenti inviati all'endpoint bot; User.UserPrincipalName (Non archiviato) - Attualmente inutilizzato; User.Mail (non archiviato): usato per associare gli utenti del sistema all'ID AzureAD archiviato. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
