---
title: Informazioni sull'applicazione per Pexip One per Outlook di PexipAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Pexip One per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
|:----------------|:-------------|
| Nome dell'app | Pexip One per Outlook |
| ID | WA200003137 |
...
| Nome della società partner | PexipAS |
| Sito Web dell'azienda | [https://www.pexip.com](https://www.pexip.com) |
| Condizioni per l'utilizzo dell'app | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| Funzionalità di base dell'app | Pexip One consente agli utenti di creare facilmente riunioni sicure usando i flussi di lavoro esistenti per la disposizione delle riunioni. Pexip one offre funzionalità di condivisione dello schermo, voce e chat video. |
...
Queste informazioni sono state fornite da PexipAS sul modo in cui questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegato | I dati degli eventi per gli utenti vengono usati per pianificare riunioni sulla piattaforma e tenere traccia delle modifiche apportate ai metadati delle riunioni | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
