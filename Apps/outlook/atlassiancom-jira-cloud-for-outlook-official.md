...
description: Tutte le informazioni di sicurezza e conformità disponibili per Jira Cloud per Outlook (ufficiale), i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
| Funzionalità di base dell'app | Pianificare, tenere traccia, rilasciare il software. Gestire il supporto, il servizio clienti e i progetti. |
...
Queste informazioni sono state fornite da Atlassian.com su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| L'app o l'infrastruttura sottostante elabora i dati relativi a un cliente Microsoft o al dispositivo? | Sì |
| Quali dati vengono elaborati dall'app? | I dati di posta elettronica utente vengono elaborati come parte della funzione delle applicazioni per la visualizzazione dei collegamenti Jira. |
