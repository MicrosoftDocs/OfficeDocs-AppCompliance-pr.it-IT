...
description: Tutte le informazioni di sicurezza e conformità disponibili per Adobe Sign Add-In per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni sulla sicurezza/conformità nel registro CSA STAR.
...
<p>Ultimo aggiornamento da parte dello sviluppatore: 15 ottobre 2021</p>
...
|:----------------|:-------------|
| Nome dell'app | Adobe Sign Add-In per Outlook |
| ID | WA104381158 |
