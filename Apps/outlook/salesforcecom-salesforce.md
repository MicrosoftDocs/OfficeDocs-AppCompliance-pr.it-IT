...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Salesforce, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
| Sito Web dell'azienda | [https://www.salesforce.com](https://www.salesforce.com) |
| Condizioni per l'utilizzo dell'app | [https://www.salesforce.com/content/dam/web/en_us/www/docume...](https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/software-order-form-supplements/Salesforce_Outlook_TOU_Order_Form_Addendum.pdf) |
| Funzionalità di base dell'app | Consente di sperimentare Salesforce direttamente in Outlook. L'integrazione è basata al 100% sul cloud senza software per eseguire il push, l'installazione o la gestione. Visualizza tutti i contatti, i lead, gli account, le opportunità e i casi associati a messaggi di posta elettronica e appuntamenti senza passare da Salesforce a Outlook. I dati di Salesforce vengono visualizzati direttamente in Outlook. Creare nuovi record Salesforce, inclusi i record oggetto personalizzato, direttamente in Outlook. Aggiungere messaggi di posta elettronica e appuntamenti ai record Salesforce con un solo clic, anche durante la composizione |
...
Queste informazioni sono state fornite da salesforce.com su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
