---
title: Informazioni sull'applicazione per Appspace per Outlook da Appspace, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/25/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per Appspace per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "65692418"
---
# <a name="appspace-for-outlook"></a>Appspace per Outlook
...
* <a href="https://appsource.microsoft.com/product/office/WA200004102" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Appspace per Outlook |
| ID | WA200004102 |
...
| Quali dati vengono elaborati dall'app? | Username |
| L'app supporta TLS 1.1 o versione successiva? | Sì |
| L'app o l'infrastruttura sottostante archivia i dati dei clienti Microsoft? | Sì |
| Quali dati vengono archiviati nei database? | Username |
...
| URL dell'informativa sulla privacy | https://www.appspace.com/legal/privacy-policy/ |
