...
| Funzionalità di base dell'app | Aggiungere firme visibili in Outlook e OWA generati sul lato server da CI-Sign, nonché un'anteprima se le firme vengono aggiunte sul lato server da CI-Disclaimer per soddisfare i requisiti di identità aziendali e i requisiti legalmente richiesti.  |
| Sede centrale dell'azienda | Germania |
| Pagina delle informazioni dell'app | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
