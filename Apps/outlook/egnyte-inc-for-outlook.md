---
title: Informazioni sull'applicazione per Egnyte per Outlook di Egnyte, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Egnyte per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66656291"
---
# <a name="egnyte-for-outlook"></a>Egnyte per Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Ultimo aggiornamento da parte dello sviluppatore: 8 marzo 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004177" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Egnyte, Inc. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Egnyte per Outlook |
| ID | WA200004177 |
| client Office 365 supportati | Outlook 2013 o versione successiva in Windows, Outlook 2016 o versioni successive in Mac, Outlook sul web |
| Nome della società partner | Egnyte, Inc. |
| Sito Web dell'azienda | [https://www.egnyte.com](https://www.egnyte.com) |
| Condizioni per l'utilizzo dell'app | [https://www.egnyte.com/terms-and-conditions/01-2020](https://www.egnyte.com/terms-and-conditions/01-2020) |
| Funzionalità di base dell'app | Condividere facilmente i file da Egnyte ai messaggi di posta elettronica in Outlook o salvare messaggi di posta elettronica e allegati da Outlook direttamente in una cartella Egnyte senza uscire dalla posta in arrivo |
| Sede centrale dell'azienda | Stati Uniti d'America |
| Pagina delle informazioni sull'app | [https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125](https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125) |
...
Queste informazioni sono state fornite da Egnyte, Inc. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
...
| Quali dati vengono archiviati nei database? | indirizzo di posta elettronica, ID tenant, token, ID messaggio e allegato e relativo contenuto |
...
| URL dell'informativa sulla privacy | https://www.egnyte.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.Read.Shared | Delegato | Obbligatorio per leggere i dettagli di posta elettronica a cui l'utente ha accesso | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| User.Read | Delegato | Necessario per convalidare l'utente a scopo di autorizzazione | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| email | Delegato | Obbligatorio per il token di accesso di convalida | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| offline_access | Delegato | Obbligatorio per richiedere in modo esplicito un token di aggiornamento quando si usa OAuth 2.0 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| openid | Delegato | Obbligatorio per leggere le informazioni di base degli utenti | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| profile | Delegato | Necessario per leggere le informazioni di base sull'utente | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
