---
title: Informazioni sull'applicazione per Email Reactor di Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Tutte le informazioni di sicurezza e conformità disponibili per Email Reactor, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104379506" target="_blank">Visualizzazione in AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informazioni generali

Informazioni fornite da Flow Simulation Ltd. a Microsoft:

| **Informazioni** | **Risposta** |
|:----------------|:-------------|
| Nome dell'app | Email Reactor |
| ID | WA104379506 |
...
| Nome della società partner | Flow Simulation Ltd. |
| Sito Web dell'azienda | [https://www.flosim.com](https://www.flosim.com) |
| Condizioni per l'utilizzo dell'app | [https://www.flosim.com/reactor/EULA.html](https://www.flosim.com/reactor/EULA.html) |
| Funzionalità di base dell'app | Strumento di redazione della risposta alla posta elettronica che consente di risparmiare tempo |
| Sede centrale dell'azienda | Regno Unito di Gran Bretagna e Irlanda del Nord (i) |
| Pagina delle informazioni sull'app | [https://www.flosim.com/reactor/Email_Reactor.html](https://www.flosim.com/reactor/Email_Reactor.html) |
...
Queste informazioni sono state fornite da Flow Simulation Ltd. su come questa app raccoglie e archivia i dati dell'organizzazione e sul controllo che l'organizzazione avrà sui dati raccolti dall'app.
