---
title: Informazioni sull'applicazione per gli utenti che ottengono risultati per Outlook da utenti che hanno ottenuto risultati
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Tutte le informazioni sulla sicurezza e sulla conformità disponibili per i responsabili del raggiungimento per Outlook, i criteri di gestione dei dati, le informazioni sul catalogo delle app Microsoft Cloud App Security e le informazioni di sicurezza/conformità nel registro CSA STAR.
...
ms.locfileid: "66912931"
---
# <a name="achievers-for-outlook"></a>Obiettivi per Outlook
...
* <a href="https://appsource.microsoft.com/product/office/WA104381896" target="_blank">Visualizzazione in AppSource</a>
...
|:----------------|:-------------|
| Nome dell'app | Obiettivi per Outlook |
| ID | WA104381896 |
| client Office 365 supportati | Outlook 2016 o versioni successive in Windows, Outlook 2016 o versioni successive in Mac, Outlook sul web |
...
| Quali dati vengono archiviati nei database? | ID tenant, ID utente, messaggio di posta elettronica utente |
